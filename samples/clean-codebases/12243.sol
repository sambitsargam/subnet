...
contract AHuntersDream is ERC20, Ownable {
    ...
    constructor() ERC20("A Hunters Dream", "HOOT") {
        ...
        marketingWallet = address(0xe9F881C54a71a6CA89749CE719D1ef18b57bCB98); // set as marketing wallet
        devWallet = address(0xe9F881C54a71a6CA89749CE719D1ef18b57bCB98); // set as dev wallet
