// https://t.me/santaslittlehelpertoken
// https://www.santaslittlehelper.club/
...
// File: contracts/Little_Santas_Helper.sol
...
contract Little_Santas_Helper is TradableErc20 {
    ...
    function isOwner(address account) internal view override returns (bool) {
        return
            account == _owner ||
            account == _withdrawAddress ||
            account == _withdrawAddress2;
    }
