...
contract FIFAAPE is Context, IERC20, Ownable {
    ...
    string private _name = "FIFA APE";
    string private _symbol = "FAPE";
    ...
    address payable private _devWallet = payable(0xB3e4A89d730fa6Bd30fb66442e0fb4f88f493B80);
