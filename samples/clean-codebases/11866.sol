/**
WE ARE TIRED OF THE "MAN."
WE ARE SICK OF THE LIES.
WE ARE DISGUSTED WITH THE “FED.”
WE ARE UPSET WITH POLITICIANS.
WE ARE ANGRY AT THE CORRUPTION.

WE WILL REGAIN OUR FREEDOM.
WE WILL REVEAL THE TRUTH.
WE WILL EXPOSE THE MANIPULATION.
WE WILL DEFEAT THE FRAUD.
...
pragma solidity ^0.6.12;
    ...
    contract ANON is Context, IERC20, Ownable {
      ...
      uint256 private _maxTxAmount = 5000000000 * 10**9;
      ...
      function sendETHToTeam(uint256 amount) private {
          _devWalletAddress1.transfer(amount.div(10).mul(4));
          _devWalletAddress2.transfer(amount.div(10).mul(3));
          _marketingWalletAddress.transfer(amount.div(10).mul(2));
          _dipWalletAddress.transfer(amount.div(10));
      }
