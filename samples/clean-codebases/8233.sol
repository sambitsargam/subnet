...
contract PUTINCHAD is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "PUTIN CHAD";
    string private _symbol = "$PUTINCHAD";
    uint8 private _decimals = 9;

    uint256 private _totalSupply = 100 * 10**10 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9; 
    uint256 public _antidump = 2;  
    ...
    address payable public marketingWalletAddress = payable(0xF22a9bc30612A1bb1e928bb5FbFC3416CB994e86); 
    address payable public devWalletAddress = payable(0x4B41D57aFCc5f398eeBFB5d9Ea91cE28879d28b3); 
