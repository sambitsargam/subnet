...
The Bucks Bunny Coin is the brainchild of a team that grew up watching a slew of now classic cartoon shows that were products of passionate creativity, inspired ingenuity and meticulous love.  
It was a glorious period when every frame was hand-drawn with zealous care and every scene was bursting with wondrous charm.

Twitter - https://twitter.com/BucksBunnyERC
Website - https://bucksbunnyerc.com/
Telegram - https://t.me/BucksBunnyERC
...
contract BucksBunny is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Bucks Bunny", "BUCKS BUNNY") {
        ...
        uint256 _buyMarketingFee = 5; // marketing wallet
        uint256 _buyLiquidityFee = 3;
        uint256 _buyDevFee = 4; // buyback wallet, development, giveaways, 
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        devWallet = address(owner()); // wallet for buybacks, team and mods
