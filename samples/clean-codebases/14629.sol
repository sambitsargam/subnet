...
/*
 ...
 Empire Capital Token takes our platform into the DeFi 3.0 future and affords users 
 the opportunity to earn yield on their crypto assets through staking & farming just
 by holding a single asset. There is a wealth of opportunity across all these chains 
 to earn high ROI through yield farming.
...
contract ECC is Ownable, IERC20, Controller {
    ...
    function manualECCDividends(uint256 newDividends) external onlyOwner {
        //Transfer tokens to div tracker before updating dividends
    ...
    //To clone this contract requires ECC bridging infrastructure, please contact ECC team @ https://t.me/ecc_capital
}
