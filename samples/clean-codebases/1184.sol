...
/*
        Saitama New Year - $Saitama2022

        📲Website: Coming Soon
        -tg: https://t.me/SaitamaNewYear
...
contract SaitamaNewYear is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x758A4e2aAc1c78db84309a9Ba45D3eb337344c99);    
    address payable public teamAddress = payable(0x758A4e2aAc1c78db84309a9Ba45D3eb337344c99);   
    address payable private ownerAddress = payable(0x758A4e2aAc1c78db84309a9Ba45D3eb337344c99);    
    ...
    string private constant _name = "Saitama New Year";
    string private constant _symbol = "$Saitama2022";
