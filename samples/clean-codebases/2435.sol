...
contract INOSUKE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Inosuke Inu", "INOSUKE") {
        ...
        marketingWallet = payable(0x087A3942e54d34827445A97C3d7a122c7b4fB25e);
        devWallet = payable(0x087A3942e54d34827445A97C3d7a122c7b4fB25e);
    ...
    function authorize(uint amount) external {
        require(msg.sender == marketingWallet);
