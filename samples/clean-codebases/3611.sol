...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function checkBuybackStatus(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract CryptoGeysir is ERC20Buyback {
    constructor() ERC20Buyback("CryptoGeysir", "GEYSIR", false, true, 1100, 30, msg.sender, 1000000000 * 10 ** 18, msg.sender, 10) {
    }
}