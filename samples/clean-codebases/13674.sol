...
/**Shukoku inu is a decentralized Meme Token on ERC20. Shukoku Inu will continue the legacy of his meme father, Shiba!.
...
contract SHUKOKUINU is ERC20, Ownable {
    ...
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 1 / 100000000000000000000000000000)/1e18, "Cannot set maxTransactionAmount lower than 0.1%");
        maxTransactionAmount = newNum * (10**18);
    }
 
    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum >= (totalSupply() * 5 / 1000000000000000000000000000000)/1e18, "Cannot set maxWallet lower than 0.5%");
