...
contract MamaShiba is Context, IERC20, Ownable {
    ...
    string private _name = 'MamaShiba';
    string private _symbol = 'MHIBA';
    ...
    address payable private _marketingWalletAddress = payable(0x1629fb6C12a9ffc0c85A01632c9b079249cBD0DB);
