...
contract Einstein is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x30526481079f567aa9820F146732b4A2a4eE70F1));
    ...
    string private _name = "Einstein";
    string private _symbol = "E=MC^2";
    ...
    uint256 private numTokensSellToAddToLiquidity = 1500 * 10**6 * 10**9;
    uint256 public _maxWalletSize = 3000 * 10**6 * 10**9;
