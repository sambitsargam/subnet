...
contract AMOGUS is ERC20, Ownable {
    ...
    constructor() ERC20("", "AMOGUS") {
        ...
        maxWallet = 4_000_000_000 * 1e18; // 4% from total supply maxWallet
        ...
        marketingWallet = address(0x6DD0A538931e29215926c9b3cECfFA73934d39dF); // set as marketing wallet
        devWallet = address(0x6DD0A538931e29215926c9b3cECfFA73934d39dF); // set as dev wallet
