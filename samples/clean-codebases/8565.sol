...
contract SpongeBob is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x67e77e20AAbf85394656932c444a5ed2618a4D8d);
        _feeAddrWallet2 = payable(0x67e77e20AAbf85394656932c444a5ed2618a4D8d);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x67e77e20AAbf85394656932c444a5ed2618a4D8d), _msgSender(), _tTotal);
    }
