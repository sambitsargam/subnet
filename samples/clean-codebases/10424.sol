// https://t.me/AlphaHumansToken
// https://www.alphahumanserc.com/
...
contract AlphaHuman is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Alpha Human", "Alpha Human") {
        ...
        maxTx = 5000000000 * 1e18; // 0.25% of supply max transaction allowed at launch
        maxWallet = 7000000000 * 1e18; // 2% of supply max wallet
        ...
        theBank = payable(0x433880d503D9357EeBB00C83955AC0973A0d80c7); 
        liqOwner = payable(0x433880d503D9357EeBB00C83955AC0973A0d80c7);
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x433880d503D9357EeBB00C83955AC0973A0d80c7) &&
                !inTheZone
            ){
