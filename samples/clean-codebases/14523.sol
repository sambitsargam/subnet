...
contract RichMeka is ERC721Enumerable, Ownable {
    ...
    uint256 public _stakedTokensCount = 0;
    ...
    function mintMekas(uint256 numberOfTokens, bool stakeTokens) external payable {
        ...
        require(totalSupply() + numberOfTokens + _stakedTokensCount <= _maxSupply, "RichMeka: purchase would exceed max supply of Mekas");

        if (totalSupply() + numberOfTokens +_stakedTokensCount == _maxSupply) {
            _saleIsActive = false;
        }
