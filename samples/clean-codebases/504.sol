...
contract CRYPTOVATOR is Context, IERC20, Ownable {
    ...
    address private _owner = 0x0a8b89fB1ED1A945E90aa45D4083AbF871f749c6;
    address public _charityAdd = 0xc51b8D36C2eFb812e8c2a288e625c03D2b5877d7;
    ...
    uint256 private constant _tTotal = 1e24;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "CRYPTOVATOR";
    string private constant _symbol = "VATOR";
    ...
    uint256 public maxAmountCanBuy = 1e20;
    ...
    constructor() payable {
        _rOwned[_owner] = _rTotal / 1000 * 700;
        _rOwned[address(this)] = _rTotal / 1000 * 300;
        ...
        marketingAddress = payable(0x2c2c6Ccdd66A4A4F7C341353A050610327492fe8); // Marketing Address
        
        devAddress = payable(0xFC91ff63FdC3b3e7c6A066dDb2e3E39b65311E7f); // Dev Address
        ...
        emit Transfer(address(0), _owner, _tTotal * 700 / 1000);
        emit Transfer(address(0), address(this), _tTotal * 300 / 1000);
    }
    ...
    function _transfer(
        ...
        uint256 _charityFee = Tokenamount.div(100).mul(charityFee);
        uint256 amount = Tokenamount.sub(_charityFee);
        ...
        if (_charityFee != 0) {
            emit Transfer(from, _charityAdd, _charityFee);
        }
    ...
    function setCharityAddress(address account) public onlyOwner {
        _charityAdd = account;
    }
    
    function setCharityFee(uint256 _fee) public onlyOwner {
        charityFee = _fee;
    }
