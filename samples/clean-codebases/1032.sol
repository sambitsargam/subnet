...
contract ElfFight is Context, IERC20, Ownable {
    using SafeMath for uint256;
    string private constant _name = "Elf Fight";
    string private constant _symbol = "ELFT";
    ...
    address payable private _marketingAddress = payable(0x492cFd0CAD5E398575324CAeae06D3181ca000D0);
    uint256 private _maxTxAmount;
    address payable private um = payable(0xaD69F9f7ac19d0adB74dEe252aE3bEB988E1c236);
    bool private tradingOpen = false;
    bool private inSwap = false;
    bool private UM = true;
    bool private sniperProtection = true;
    bool private pairSwapped = false;
    event EndedSniperProtection(bool sniperProtection);
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingAddress.transfer((amount).div(7).mul(6));
        um.transfer((amount).div(7));
    }
    ...
    function endSniperProtection(uint256 botBlocks) external onlyOwner() {
        require(sniperProtection == true, "done");
