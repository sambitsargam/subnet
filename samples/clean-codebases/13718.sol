/**
ELON TWEET PLAY
"https://twitter.com/elonmusk/status/1507144087689912320"
join telegram LFG
https://t.me/TANGERINU_ETH
21,000,000
buy 6%
sell 10%
max buy 2%
...
library Address{
 ...
 contract TWEET is Context, IERC20, Ownable {
    ...
    uint256 public coolDownTime = 42 seconds;
    ...
    uint256 public maxBuyLimit = _tTotal * 2 / 100; 
    uint256 public maxSellLimit = _tTotal * 1 / 100; 
    uint256 public maxWalletLimit = _tTotal * 4 / 100; 
    ...
    address public marketingWallet = 0xb55e71D71f68A42C55206c613DA99430a8e21899;
    address public devWallet = 0xb55e71D71f68A42C55206c613DA99430a8e21899;

    string private constant _name = "Most people think the fruit was named after the color(fools!)";
    string private constant _symbol = "TANGERINU";
    ...
    Taxes public taxes = Taxes(0, 4, 2, 0);
    Taxes public sellTaxes = Taxes(2, 6, 2, 0);
    ...
    function setTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev) public onlyOwner {
        ...
        require(buytotaltaxes <= 8, "Must keep taxes at 8% or less");
    ...
    function setSellTaxes(uint256 _rfi, uint256 _marketing, uint256 _liquidity, uint256 _dev) public onlyOwner {
        ...
        require(selltotaltaxes <= 19, "Must keep taxes at 19% or less");
