...
contract wolvesindisguise is Ownable, ERC721A, ReentrancyGuard {
    using Strings for uint256;
  ...
  uint256 private constant TotalCollectionSize_ = 200; // total number of nfts
  ...
  constructor() ERC721A("WolvesInDisguise","WolvesInDisguise", MaxMintPerBatch_, TotalCollectionSize_) {
    _uriBeforeRevel = "https://gateway.pinata.cloud/ipfs/QmW6o6qatzvmgc9xYh82xL1Nz4fs7n9fGZvp5UArfp6XkX/";
    _baseTokenURI="https://gateway.pinata.cloud/ipfs/QmPc7S31r7CFUPbuQ8mXkxgArJcfKsFUngWJHz9HRRgKuY/";
  }
  ...
  function giveaway(address a, uint q)public onlyOwner{
    ...
    require(numberMinted(a) + q <= MAX_PER_Address  , "Max can hold 10 NFTs" );
    _safeMint(a, q);
  }
