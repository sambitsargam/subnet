...
// ApeCoinDAO: a conglomerate for democratizing exposure to APE Governance
// t.me/theapecoindao
...
contract ApeCoinDao is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ApeCoin DAO", "APECOINDAO") {
    ...
    function GoBananas() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function CoolDownDisable() external onlyOwner returns (bool){
    ...
    function badmonke (address account, bool isBlacklisted) public onlyOwner {
    ...
    function updateApeCoinWallet(address newMarketingWallet) external onlyOwner {
    ...
    function Multisend(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
