...
contract LPTokenWrapper {
    ...
    // uni-v2 DRT ETH pair
    IERC20 public uniswapEthDrtToken = IERC20(0x90c8bE3901D5Bbc4f88aB70203c8C514921E1150);
    ...
    function stake(uint256 amount) public {
        ...
        uniswapEthDrtToken.safeTransferFrom(msg.sender, address(this), amount);
    }

    function withdraw(uint256 amount) public {
        _totalSupply = _totalSupply.sub(amount);
        _balances[msg.sender] = _balances[msg.sender].sub(amount);
        uniswapEthDrtToken.safeTransfer(msg.sender, amount);
    }
}

contract Unipool is LPTokenWrapper, IRewardDistributionRecipient {
    // DRT Smart contract
    IERC20 public drt = IERC20(0x9AF4f26941677C706cfEcf6D3379FF01bB85D5Ab);
    uint256 public constant DURATION = 35 days;
    ...
    function getReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            drt.safeTransfer(msg.sender, reward);
        ...
        updateReward(address(0))
    {
        ...
        drt.safeTransferFrom(msg.sender, address(this), _amount);
