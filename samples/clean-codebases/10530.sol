/*
Welcome to $CHUTZPAH🍸 ( Chutzpah Coin )
   
    This is a 100% community driven token. There is no official website yet!
   If someone wants to create more groups, that’s what we are all about!
   This is the only group/channel so far that’s recording the information as we released this coin. 
   If you want to view all the information about this coin, join: https://t.me/CHUTZPAH_ARMY
   
   We will lock liquidity LPs through team.finance for at least 30 days, if the response is good, we will extend the time.
   To make sure it's 100% safe for all, we'll renounce the developer ownership to the burn addresses and transfer the remaining $CHUTZPAH to the community.

   It's a community token so every holder should promote it or create a group for it. If you want to pump your investment, you need to put in a little bit of effort with your friends.
...
Fair Launch! 🔋
    ...
    5.) Liquidity locked at team.finance for over 1 year. 🔒
    6.) Contract ownership renounced on Launch! 👩‍💻
    7.) 1 Trillion Total Supply. 💸
    8.) 50% to burn the address! 🔥
    9.) Auto-farming to All Holders! 👩‍🌾
    10.) Tax: 8% => Burn: 4% | LP: 4% 🎁
    ...
    It's the best part of the $CHUTZPAH idea, increasing the liquidity pool automatically.

    I’m gonna lock all of my 10 ETH coins in the pool for more than a year.
    Can you make this token 100X or even 1000X?
    Hope you guys are holding when that happens!
*/
