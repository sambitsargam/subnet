...
contract ShibHokk is ERC20, Ownable {
    ...
    constructor() ERC20("ShibHokk DAO", "SHOKK") {
        ...
        marketingWallet = address(0x5A0733c65598aA539d04370300dbdc0B019A0Dd6); // set as marketing wallet
        devWallet = address(0x89Ba7c222e33e84eEAc198BE57F08e0Cdf3bc8B4); // set as dev wallet
