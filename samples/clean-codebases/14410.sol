...
contract YugiMutouInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "YugiMutouInu";
    string private _symbol = "YMI";
    ...
    uint256 public _liquidityFee = 9; // means 9% add liquidity on each buy and sell
    uint256 public _burnFee = 0; // means 3% it means burn 3%
    
    
    address liquidityWallet=0x2D4377D2D31B7Ae9E075e8cE6Cba1dAa9F96BC42;
