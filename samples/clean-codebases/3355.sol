...
/*
    ...
    website: www.mooning.dog
    TG: https://t.me/dogmooneth

    tokenomics:
    - total supply Y: 1 Trillion 
    - initial liq: 10 ETH
    taxes:
    - buys: 10% total - 4% lp / 4% marketing / 2% buyback
    - sells: 12% total - 4% lp / 6% marketing / 2% buyback
    *25% tax for the first 24 hours*
    
    - 1 month initial lock, no renounce. manual burns customized CA
    -  burn x% on every milestone
