...
contract BlootWeen is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "BlootWeen #', toString(tokenId), '", "description": "BlootWeen is 100% worthless.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("BlootWeen", "BLOOTWEEN") Ownable() {}
}
