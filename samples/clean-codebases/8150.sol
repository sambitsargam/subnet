...
contract RabidMONGOOSE is ERC20, Ownable {
    ...
    constructor() ERC20("RabidMONGOOSE", "RABID") {
        ...
        uint256 totalSupply = 69 * 1e21 * 1e18;
        ...
        marketingWallet = address(owner()); // set as Marketing/Dev/Buyback wallet
        devWallet = address(owner()); // set as Marketing/Dev/Buyback wallet
