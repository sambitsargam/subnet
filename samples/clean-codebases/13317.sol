    ...
    function deposit() public payable{
        ...
        if(allowed >= amount && amount > 0 && allowedWealthArchitects[address(myWealthArchitect[msg.sender])] == true){
            ...
            if(allowedWealthArchitects[token0] == true){
                ...
                IERC20(myWealthArchitect[msg.sender]).approve(address(myVault[msg.sender]), amount0 * 1e18);
                WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2).deposit{value: address(this).balance}();
                WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2).approve(address(myVault[msg.sender]), WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2).balanceOf(address(this)) * 1e18);
                ...
                IERC20(myWealthArchitect[msg.sender]).approve(address(myVault[msg.sender]), amount1 * 1e18);
                WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2).deposit{value: address(this).balance}();
                WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2).approve(address(myVault[msg.sender]), WETH9(0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2).balanceOf(address(this)) * 1e18);
