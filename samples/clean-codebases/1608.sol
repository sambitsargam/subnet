...
contract BobaKong is Context, IERC20, Ownable {
    ...
    string private constant _name = "BobaKong";
    string private constant _symbol = "BKONG";
    ...
    uint256 public _buyOperationsFee = 400;
    uint256 public _buyDevFee = 400;

    uint256 public _sellTaxFee = 200;
    uint256 public _sellLiquidityFee = 300;
    uint256 public _sellOperationsFee = 1000;
    uint256 public _sellDevFee = 1000;
    ...
    constructor() payable {
        ...
        operationsAddress = payable(0x806DC4ddA9EfeA8855963dfEEf9cC984CE0E4b2f);
        devAddress = payable(0x1f705659Df60001567B47B0A7a9af74Ca4d9A5dC);
        futureOwnerAddress = payable(0x05bDD4040c2Aaf0190828Dd2fafd5C7cEB5334e8);
