...
contract KibaInu is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x9FfddD19b043B4677f9be653b0d99d3663a3e4Fe); // Marketing Address
        
        devAddress = payable(0x4a5eB284c6699063Ceb2Fc4e22C0861FC98b543b); // Dev Address
