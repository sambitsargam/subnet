...
contract BDogeZilla is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 1_380_000_000_000 * 10**18;
    uint256 public maxBuyLimit = 6_900_000_000_000 * 10**18;
    uint256 public maxSellLimit = 6_900_000_000_000 * 10**18;
    uint256 public maxWalletLimit = 6_900_000_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline;
    uint256 private launchtax;

    address public marketingWallet = 0x80A85CBfBdEa125b63493F6e6FEe48725CeeBE3C;
    ...
    Taxes public taxes = Taxes(5, 4, 1);
    Taxes public sellTaxes = Taxes(5, 4, 1);
    ...
    constructor(address routerAdd) ERC20("Baby DogeZilla", "BDogeZilla") {
        _tokengeneration(msg.sender, 690000000000000 * 10**decimals());
