...
contract RichDogeInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "RichDogeInu";
    string private _symbol = "RDINU";
    ...
    uint256 public _burnFee = 3; // means 3% it menas burn 3%
    
    
    address liquidityWallet=0xc72353B8b688b1c3De93134d28DF7d72FE33Ead8;
