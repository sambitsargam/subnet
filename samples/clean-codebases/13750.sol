...
In times of war, we must unite. $WARTIMES DAO was created to help weather the wartime 
dip, and - via DAO community voting - invest in projects to help grow the treasury. 
12% of every transaction is being reflected back to the holders through dividends.
This is a token for the community!

https://t.me/WarTimesDAO
https://wartimesdao.com

*/

// hevm: flattened sources of src/wartimes.sol
...
contract WarTimes is Ownable, IERC20 {
        ...
        returns (bool)
    {
        ...
        require(
            ...
            "WARTIMES: decreased allowance below zero"
        );
        _approve(_msgSender(), spender, currentAllowance - subtractedValue);
        return true;
    }
    ...
    function transferFrom(
        ...
        require(
            ...
            "WARTIMES: transfer amount exceeds allowance"
        );
        _approve(sender, _msgSender(), currentAllowance - amount);
        return true;
    }
    ...
    function _transfer(
        ...
        require(!isBlacklisted[sender], "WARTIMES: Sender is blacklisted");
        require(!isBlacklisted[recipient], "WARTIMES: Recipient is blacklisted");

        require(sender != address(0), "WARTIMES: transfer from the zero address");
        require(recipient != address(0), "WARTIMES: transfer to the zero address");
        ...
        require(
            ...
            "WARTIMES: transfer amount exceeds balance"
        );
    ...
    function _approve(
        ...
        require(owner != address(0), "WARTIMES: approve from the zero address");
        require(spender != address(0), "WARTIMES: approve to the zero address");
        _allowances[owner][spender] = amount;
        emit Approval(owner, spender, amount);
    }

    function _mint(address account, uint256 amount) private {
        require(account != address(0), "WARTIMES: mint to the zero address");
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    }
    ...
    function _burn(address account, uint256 amount) private {
        require(account != address(0), "WARTIMES: burn from the zero address");
        uint256 accountBalance = _balances[account];
        require(accountBalance >= amount, "WARTIMES: burn amount exceeds balance");
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    }
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(
            ...
            "WARTIMES: account is already set to requested state"
        );
        _isExcludedFromFees[account] = excluded;
    ...
    function setAutomatedMarketMakerPair(address pair, bool value)
        ...
        onlyOwner
    {
        require(pair != uniswapV2Pair, "WARTIMES: DEX pair can not be removed");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(
            ...
            "WARTIMES: automated market maker pair is already set to that value"
        );
        automatedMarketMakerPairs[pair] = value;
        if (value) {
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(
            ...
            "WARTIMES: the router is already set to the new address"
        );
    ...
    function compound() public {
        require(compoundingEnabled, "WARTIMES: compounding is not enabled");
...
contract DividendTracker is Ownable, IERC20 {
    ...
    string private _name = "WARTIMES_DividendTracker";
    string private _symbol = "WARTIMES_DividendTracker";
        ...
        onlyOwner
    {
        require(
            ...
            "WARTIMES_DividendTracker: account already set to requested state"
        );
        excludedFromDividends[account] = excluded;
        if (excluded) {
            _setBalance(account, 0);
    ...
    function _mint(address account, uint256 amount) private {
        require(
            account != address(0),
            "WARTIMES_DividendTracker: mint to the zero address"
        );
        _totalSupply += amount;
        _balances[account] += amount;
        emit Transfer(address(0), account, amount);
    ...
    function _burn(address account, uint256 amount) private {
        require(
            account != address(0),
            "WARTIMES_DividendTracker: burn from the zero address"
        );
        uint256 accountBalance = _balances[account];
        require(
            accountBalance >= amount,
            "WARTIMES_DividendTracker: burn amount exceeds balance"
        );
        _balances[account] = accountBalance - amount;
        _totalSupply -= amount;
        emit Transfer(account, address(0), amount);
    ...
    function transfer(address, uint256) public pure override returns (bool) {
        revert("WARTIMES_DividendTracker: method not implemented");
    }
