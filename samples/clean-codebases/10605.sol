...
Take us back to the time before scammers
To the time before Rug Pulls
To the time before Honeypots
To the time when tokens were for the people
To the time of simple tokens with low taxes

Contract will be Renounced post launch after limits lifted
LP Tokens will be Locked pre launch and extended post launch

Make a statement
Send it

There are not any official socials, but in true anon style look for clues on the blockchain
...
contract NoMoreRugs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("NoMoreRugs", "NoMoreRugs") {
