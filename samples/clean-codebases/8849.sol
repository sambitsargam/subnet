// 🚀JOIN NOW  : https://t.me/supermoonninja 
...
contract SUPERMOONNINJA is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "SUPER MOON NINJA";
    string private _symbol = "$MOONNINJA";
    uint8 private _decimals = 9;

    uint256 private _totalSupply = 100 * 10**7 * 10**9;
    uint256 public maxbuy = 2 * 10**7 * 10**9;              // 2% max buy at the launch
    uint256 public maxwallet = 3 * 10**7 * 10**9;           // 3% max wallet at the launch
    uint256 private minimumTokensBeforeSwap = 10000 * 10**9; 

    uint256 public autoliquidity = 2;
    uint256 public marketingtax = 6;
    uint256 public giveaway = 4;   
    ...
    address payable public marketingwallet = payable(0x884B2D22C2674Bb8963D0914eE2eE15170eEe2d1); 
    address payable public giveawaywallet = payable(0x1506B25fbF26Fc45eA0C5d123F28bEded6b22B2B); 
