...
contract UkraineSupportToken is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public  deadAddress = address(0x75C6d45acEEA26eC4E516A52C54D6eE78ea00ed3);
    ...
    constructor() ERC20("UkraineSupportToken", "UKRN") {
        ...
        maxWallet = totalSupply * 9 / 1000; // 1% maxWallet
