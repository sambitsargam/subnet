...
contract ElectricCoin is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Electric Coin", "EC") {
    	...
    	dev1Wallet = payable(0x8570529B7D3DEd56779bd53d8bb750F8492e0CF7);  // set as dev1 wallet
        dev2Wallet = payable(0x78dDB8611C926e63C3e3A9bC1467961007B20e6f);  // set as dev2 wallet

        marketingWallet = payable(0x7Fc5995f2Dab59052342C0B647f61Fec087C3202); //marketing wallet
