/* 
Telegram - https://t.me/roflerc20

laughing! It is time for a real meme project that's here for community building, fun, happiness!

Meme coins haven't been fulfilling the real purpose of meme culture. Even the brightest mind ELON MUSK is a meme lover. That's why we are launching ROFL. ROFL is here to create some moments of happiness in our life to make us laugh on the floor, have fun, and to enjoy life. ROFL is a DAO, where the ROFL treasury will be used by the community for the betterment of the project. Together we will build a ROFL DAO metaverse.
...
contract ROFL is Context, IERC20, Ownable {
    ...
    address private _owner = 0x25bC1f231Da4536e15Ad977B718862BA5D123188;
    ...
    string private constant _name = "ROFL";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 25 / 1000; // 2.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 25 / 1000; // 2.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x60AEf1edB618f81513a2b6AbF78A5540DBDFBc33); // Marketing Address
        
        devAddress = payable(0x9418331d1D61391ceB44e66244005Cb228e49e65); // Dev Address
        ...
        onlyOwner
    {
        ...
        require(_buyTaxFee + _buyLiquidityFee + _buyMarketingFee <= 25, "Must keep buy taxes below 25%");
