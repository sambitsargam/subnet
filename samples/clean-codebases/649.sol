...
contract FuckPutin is ERC721, Ownable {
    ...
    uint256 public constant supplyLimit = 1012;
    uint256 public constant mintPrice = 0.012 ether;
    ...
    address[] private _royaltyAddresses = [
        0xb06E40750e28e064EfC88b7dbff6a5f4d2d614b9, // Wallet for funds to send to https://www.savethechildren.org.uk/how-you-can-help/emergencies/ukraine-appeal
        0x1a31BDe92bA71C4A79495B19D70e4736dD48B2e2,
        0x748FcB4cA3A700899B986d57368e0e9B31380efD,
        0x6C309aa4B7920c756593996357613C295719859d,
        0x2791BDDd24b95C393fAa4600C9231D1936768fAe,
        0x33fCF5813A9077c66cADC647C22519453494a4a7 
    ];

    constructor(string memory name, string memory symbol) ERC721(name, symbol) {
        _royaltyShares[_royaltyAddresses[0]] = 70; // Charity Donation
        _royaltyShares[_royaltyAddresses[1]] = 5;
        _royaltyShares[_royaltyAddresses[2]] = 5;
        _royaltyShares[_royaltyAddresses[3]] = 8;
        _royaltyShares[_royaltyAddresses[4]] = 7;
        _royaltyShares[_royaltyAddresses[5]] = 5; 
    }
