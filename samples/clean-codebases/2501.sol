...
contract Meditoken is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x6c79496140848FaCa2721139bD7C7A4eBD9B2e4C); // Marketing Wallet
    address payable public charityWallet = payable (0x6c3116da9054aE64E89284aaC5248415E2f55ee4); // charity Wallet
    ...
    uint256 private _tTotal = 10 ** 18 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "Medi Token";
    string private _symbol = "Medi";
