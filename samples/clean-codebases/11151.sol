/** 
 ...
 Falcaw-9 $FALCAW also known as, Falcon-Caw 9, is the first community token that will fully support $CAW
 movement to the moon while being onboard our rocket, Falcaw-9 (SpaceX's Falcon-9). We are here to build a solid and strong community
 that have the same goal as us.

 Website: https://www.falcaw.com
 Socials: To be revealed at 500k MC 
 About us: https://medium.com/@falcawtoken/story-of-falcaw-6517f1635721

 Buy Tax: 7%, 5% Marketing and 2% $CAW buyback 
 Sell Tax: 7%, 5% Marketing and 2% $CAW buyback
 Max Buy: 1%
 Max Wallet: 2%

 At every hourly interval, we will be emptying our $CAW buyback wallet to purchase $CAW and burn it.
...
contract FALCAW is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("FALCAW-9", "FALCAW") {
    ...
    ; uint256 totalSupply = 100 * 1e12 * 1e18;
        ...
        marketingWallet = 0xb110f865F969cA206525eB067b2153033b132e10; // set as marketing wallet
        devWallet = 0x73c00A5dC55444fEa95e936ae1C0a9df4A39835d; // set as dev wallet
    ...
    function Drop(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
