...
contract VikTama is Context, IERC20, Ownable {
    ...
    string private _symbol = "Vik";
    uint8 private _decimals = 9;
    
    uint256 public _taxFee = 20;
    uint256 private _previousTaxFee = _taxFee;

    uint256 public _devFee = 80;
    uint256 private _devTax = 40;
    uint256 private _marketingTax = 40;
    uint256 private _previousDevFee = _devFee;
    
    uint256 public _liquidityFee = 20;
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 public launchSellFee = 120;
    uint256 private _previousLaunchSellFee = launchSellFee;

    uint256 public maxTxAmount = _tTotal.mul(10).div(1000); // 2%
    address payable private _devWallet = payable(0xdfc42a78EaEeDf734c00cf15Fc7296b8f3264AE0);
    address payable private _marketingWallet = payable(0xF87f76eE39aD5869C31634EBC0cc87B5cDb9298F);
