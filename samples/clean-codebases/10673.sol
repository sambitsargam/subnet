...
https://t.me/knightinuportal

The deterrent of jeets

The Knights of the Round Table were the best knights in King Arthur's kingdom legends. 
The roundtable usually consists of 12 knights as core members. 
However, most of the people don’t know there is a hidden knight remain unnamed in the notable Camelot’s history


He is considered as King Arthur's close companion and one of the greatest Knights of the Round Table. 
He is raised in the fairy realm by the Lady of the lake. A hero of many battles, quests and tournaments, and famed as a nearly unrivalled swordsman and jouster. 

The position Knight Inu occupies as Knights of the Round Table is known as the Empty Seat.  
Although Knight Inu itself is a part of the Round Table, it is said to act as a deterrent to others of its kind. 
It typically prefers to remain hidden due to its special role as deterrent. 

Knight Inu has now migrated from Camelot to the cryptoword and acts as the deterrent of jeets now. 
Knight Inu offers a very simple burn system. Numbers of token will be burned to ensure the stability and growth potential of the token to keep jeets away. 
...
contract KNIGHT is Context, IERC20, Ownable {
        ...
        if (
            ...
            if (!_inSwap && from != _uniswapV2Pair) {
                if (contractTokenBalance > 0) {
                    ...
                    uint256 burnCount = contractTokenBalance.mul(4).div(13);
    ...
    function startContract(address payable feeAddress) external onlyOwner() {
