...
/**
    ...
    Missed all the Anon launches

    Launching this anon with a low based tax, use low slippage

    Find us at 
    
    https://t.me/electropumperc

    Waiting in the group for everyone to find about this
...
contract ELECTROPUMP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ELECTROPUMP", "ELECTROPUMP") {
