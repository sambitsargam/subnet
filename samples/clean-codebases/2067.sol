...
/**
    ...
    The Social Experiment was a success and the response overwhelming

    Those who know, knows is our goto

    Trenditter is the social Media Platform supporting the Free Speech Movement started by Elon Musk

    The Launch of the governance Token is totally Anonymous 

    If you find us, solve a small riddle below


    THE RIDDLE -
    ------------------------------------------------------------------------------------------
    'trenditter' was reserved as Telegram Username, so find us at 'trenditter' with a 't' less
    ------------------------------------------------------------------------------------------
...
contract TRENDITTEREXP is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("TRENDITTER", "TRENDITTER") {
