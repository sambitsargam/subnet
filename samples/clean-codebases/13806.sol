...
MetaMates will be the 1st dating community in the virtual reality world. 
Meet other people, interact, hangout, virtual dates, plus much more!

Telgram: https://t.me/metamates_token

Twitter: https://twitter.com/MetaMates_token
...
contract MATES is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "MetaMates";
    string private _symbol = "MATES";
    ...
    uint256 public _sellMarketingFee = 99;
    ...
    address payable public marketingWallet = payable(0x065842875e0C5AA9b7e7CEF92aab881524F58d45);
    ...
    uint256 public numTokensSellToAddToLiquidity = 10000000 * 10**9; //0.1%
    uint256 public _maxTxAmount = 10000000000 * 10**9;
    uint256 public maxBuyTransactionAmount = 10000000000 * 10**9;  //100%
    uint256 public maxWalletToken = 10000000000 * 10**9; //100%
