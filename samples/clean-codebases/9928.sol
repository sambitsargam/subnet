...
contract JOYtoys is ERC721, Ownable {
    ...
    JOYContract private joyWorld = JOYContract(0x6c7B6cc55d4098400aC787C8793205D3E86C37C9);
    ...
    function getMetadata(uint256 tokenId) public view returns (string memory toyName, string memory power, uint256 editionSize, uint256 editionNumber, bool vendingMachine, string memory feature, uint256 price, string memory collaborators) {
