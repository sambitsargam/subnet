...
contract WillSlaps is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Will Slaps", "WSLAP") {
        ...
        uint256 totalSupply = 10 * 10**9 * 1e18; // 10 Billion Tokens
 
        maxTransactionAmount = totalSupply * 500 / 1000; // 5% maxTransactionAmountTxn
