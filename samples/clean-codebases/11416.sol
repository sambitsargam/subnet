...
contract RICEToken is ERC20, ERC20Detailed, ERC20Capped, ERC20Burnable, Ownable {
    ...
    uint256 private initialSupply = 530000000 * 10 ** uint256(_d);
    ...
    constructor() public ERC20Detailed("RICE", "RICE", _d) ERC20Capped(totalTokens) {
        ...
        PrivateSalesMap[0]=1626714000; // 2021-07-20T00:00:00Z
        ...
        transfer(UserAcquisition, 130000000 * 10 ** uint256(decimals()));
