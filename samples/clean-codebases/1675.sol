...
/**
    ...
    |        your dao.
    |
    |    Telegram: https://t.me/ShiBBQPortal
/**
...
contract ShiBBQ is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ShiBBQ", "SBBQ") {
        ...
        maxTransactionAmount = totalSupply * 99 / 10000; // .5% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x5bb403131751683f13216C5C31D8624a57819553); // set as marketing wallet
    ...
    function setShibQModifier(address account, bool onOrOff) external onlyOwner {
