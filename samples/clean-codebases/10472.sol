...
contract Alignments is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Alignment #', toString(tokenId), '", "description": "Alignments for adventurers. Are you good, evil or something else", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
    ...
    constructor() ERC721("Alignments (for Adventurers)", "Alignments") Ownable() {}
}
