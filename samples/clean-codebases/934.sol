...
contract MemeLord is Context, IERC20, Ownable, Pausable {
    ...
    string private _name ="MemeLord";
    string private _symbol = "$MLORD";
    ...
    address payable public marketingWallet = payable(0x87FdB4e7e9cB7f72ce2974988e3706896128dAe2);
    ...
    uint256 public _maxTxAmount = 14000000000 * 10**9;
    uint256 public maxBuyTransactionAmount = 14000000000 * 10**9;  
