...
contract Raven is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Raven", "Raven") {
        ...
        maxTransactionAmount = totalSupply * 3 / 1000; // 1% maxTransactionAmountTxn
        maxWallet = totalSupply * 3 / 1000; // 2% maxWallet
