...
contract OZONE is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 21000000000000000000000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    address public marketingWallet;
	address public devWallet;

    string private _name = "O ZONE";
    string private _symbol = "OZONE";
    ...
    uint256 public numTokensSellToAddToLiquidity = 210000000000000000000 * 10**9;
    ...
    function upliftTxAmount() external onlyOwner() {
        _maxTxAmount = 21000000000000000000000 * 10**9;
    }
    
    function setSwapThresholdAmount(uint256 SwapThresholdAmount) external onlyOwner() {
        require(SwapThresholdAmount > 21000000, "Swap Threshold Amount cannot be less than 21 Million");
