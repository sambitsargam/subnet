...
contract Ownable is Context {
     ...
     */
    constructor()  {
        _owner =0xa3fb90dae1DE5415daBE5B37f473E726CA18Abff;
...
contract Metaforce is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Metaforce";
    ...
    uint256 public _burnFee=200; //2% burn on each transection
    
    
    address marketingAddress=0x5A5501773738de9efC65C71Bd0Be75f06f2D4EDe;
