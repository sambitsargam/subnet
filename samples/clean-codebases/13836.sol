/**
    Telegram : https://t.me/ShinigamiPortal
    Website : https://shinigamiERC.com
    Twitter : https://Twitter.com/shinigamiERC
 */
...
contract Shinigami is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shinigami", "SHINIGAMI") {
        ...
        uint256 sellLiquidityFee = 6;
        uint256 sellDevFee = 0;
        
        uint256 totalSupply = 1e12 * 1e9;  // 1 Trillion
        
        maxTransactionAmount = totalSupply * 100 / 10000;  // 1% maxTransactionAmountTxn -> 10 Billion
        maxWallet = totalSupply * 1000 / 10000;            // 10% maxWallet -> 100 Billion
