...
contract DAIVault is Ownable {
  ...
  function stakeDai(uint256 _amount) public {
    ...
    DaiToken.transferFrom(_msgSender(), address(this), _amount);
  ...
  function withdrawDai(address recipient) public onlyOwner {
    require(DaiToken.balanceOf(address(this)) > 0, "No DAI to withdraw");
    DaiToken.transfer(recipient, DaiToken.balanceOf(address(this))); 
  }
}