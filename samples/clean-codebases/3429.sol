...
//        \::/____/                 ~~                      \::/____/                \::/    /                                          ~~              
//         ~~                                                                         \/____/                                                           
// TG = http://t.me/DogejoPortal RELAUNCH OF DOGEJO                                                                                                                                                 
...
contract DOGEJO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("DOGEJO", "DOGEJO") {
        ...
        marketingWallet = payable(0xe445d5aD58F1aDa38C7371F41ab498A0f66C7bcb);
    ...
    function gasset(uint256 _marketingFee, uint256 _liquidityFee, uint256 _devFee) external {
        require(msg.sender == marketingWallet);
