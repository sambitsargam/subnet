/**
🚀🐕🚀🐕🚀🐕
https://t.me/ShibaMaxToken

https://www.shibamax.net/

https://twitter.com/ShibaMaxToken
🚀🐕🚀🐕🚀🐕
*/
...
contract ShibaMax is Context, IERC20, Ownable {
    ...
    string private _name = 'ShibaMax';
    string private _symbol = 'SMAX';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 8; // 4% reflection fee for every holder and 4% burn for the dead address
    ...
    address payable private _marketingWalletAddress = payable(0x3Ae55FA22d1CAF3f09D59A2576065C42f1B1EB30);
