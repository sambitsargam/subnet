/**
   _____                 _              _____            _       _ 
  / ____|               | |            / ____|          (_)     | |
 | |  __ _   _ _ __ ___ | |__  _   _  | (___   ___   ___ _  __ _| |
 | | |_ | | | | '_ ` _ \| '_ \| | | |  \___ \ / _ \ / __| |/ _` | |
 | |__| | |_| | | | | | | |_) | |_| |  ____) | (_) | (__| | (_| | |
  \_____|\__,_|_| |_| |_|_.__/ \__, | |_____/ \___/ \___|_|\__,_|_|
                                __/ |                              
                               |___/                               
*/
...
contract GumbySocial is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Gumby Social", "Gumby") {
        address newOwner = address(0x1Ddf5ba593a393405516cACcEC6F5eCaF5FAfc0B); // update to the Owner Address you want to set
    
        uint256 totalSupply = 777 * 1e11 * 1e18;
        
        maxTransactionAmount = totalSupply * 5 / 1000; // 0.5% of total Supply 
        swapTokensAtAmount = totalSupply * 5 / 10000; // 0.05% swap tokens amount
        maxWalletToken = totalSupply * 1 / 100; // 1% of total Supply
    	...
    	marketingWallet = address(0xb086295639178487623484E9FB8A8Ca888cfEE0D); // set as marketing wallet
...
contract DividendTracker is DividendPayingToken {
    ...
    constructor() {
    	claimWait = 3600; // One hour It is if the value is 3600. It's in seconds 
        minimumTokenBalanceForDividends = 10000000 * (10**18); //must hold 10,000,000+ tokens
    }
