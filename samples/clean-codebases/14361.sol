// File: contracts/katlaUSDStorage.sol

// SPDX-License-Identifier: MIT

pragma solidity ^0.6.0;

contract katlaUSDStorage {
    /** WARNING: NEVER RE-ORDER KatlaUSDIABLES! 
    ...
    string public constant name = "KatlaUSD";
    string public constant symbol = "KatlaUSD";
...
contract LibraryLock is katlaUSDStorage {
...
contract katlaUSD is katlaUSDStorage, Context, IERC20, Proxiable, LibraryLock {	
