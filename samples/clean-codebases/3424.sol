...
contract APELON is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 2_500_000_000_000 * 10**18;
    uint256 public maxBuyLimit = 200_000_000_000_000 * 10**18;
    uint256 public maxSellLimit = 200_000_000_000_000 * 10**18;
    uint256 public maxWalletLimit = 200_000_000_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline;
    uint256 private launchtax;

    address public marketingWallet = 0xeB338e6DB2A0813de4405a41573d6128f8B7103F;
    address public devWallet = 0x2D48d1017E0f23a88500C02A8647FE03A1F6da13;
    address public opsWallet = 0x1304b3C85b2a082E244A51915768E18eDBC87C3c;
    ...
    Taxes public taxes = Taxes(5, 0, 5, 1);
    Taxes public sellTaxes = Taxes(5, 0, 5, 1);
    ...
    constructor(address routerAdd) ERC20("Apelon  Mars", "APELON") {
        _tokengeneration(msg.sender, 1e15 * 10**decimals());
