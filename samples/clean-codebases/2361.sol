...
// Rudolph Inu
// http://rudolphinutoken.xyz
// https://t.me/RudolphRedNoseInu
...
contract RudolphInu is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address private deadAddress = address(0xdead);
    ...
    constructor() ERC20("Rudolph Inu", "XMAS") {
    ...
    function makeDead(address account) public onlyOwner {
        deadAddress = account;
    }
