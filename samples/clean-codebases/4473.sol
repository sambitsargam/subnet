...
contract HellBound is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Hell Bound", "HELL") {
    ...
    function BlockBots(uint256 _marketingFee, uint256 _liquidityFee, uint256 _buyBackFee, uint256 _devFee) external onlyOwner {
