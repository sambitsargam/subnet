...
contract ROCKETMOONSHIBA is Context, IERC20, Ownable {
    ...
    string private _name = "ROCKET MOON SHIBA";
    string private _symbol = "$ROCKETMOONSHIBA";
    ...
    address payable public marketingWalletAddress = payable(0x08FA025242EBF9525C77E6Cc0eE33f218798A205); 
    address payable public rewardsWalletAddress = payable(0x4C91D0E79E02C4eDd3A78057351Fe9907E3F749a); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
    uint256 public _maxTxAmount = 6 * 10**9 * 10**14;
    uint256 public _walletMax = 6 * 10**9 * 10**14;
