...
Science cannot concretely prove my existence, yet I exist in everyone.
...
contract ROMEO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxLimit = _tTotal.mul(100).div(10000);         // 0.75% of total supply
    ...
    constructor(address _dev) public ERC20("ROMEO", "ROMEO") {
