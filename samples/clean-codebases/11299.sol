...
contract SUP is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 69000000000000 * 10**9;
    ...
    function setBurningAddress(address walletAddress) public onlyOwner {
    ...
    function setMigrationWallet(address walletAddress) public onlyOwner {
