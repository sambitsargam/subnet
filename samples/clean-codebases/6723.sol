...
A degen christmas day miracle!  Every 30 minutes Santa will be refunding 100% of random 3 buys!

Christmas should be $ONSANTA this year!
...
🎅 Features
    ...
    🎁 10% Liquidity
    🎁 1% Dev
     (*100% of Tax will be used to refund buyers!)

SAFU Christmas Play
   🎄 Known Dev Team
   🎄 Liquidity Locked
   🎄 Safeguards built into SC
...
contract ChristmasOnSanta is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Christmas On Santa", "ONSANTA") {
