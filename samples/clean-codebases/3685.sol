...
/**
MechaVerse will be a treasury backed wealth creation protocol with the newest DeFI technology, NaaS.

Nodes are currently providing the highest ROI in the space. Holders can expect to benefit buying and holding nodes through our specialized mechanisms.

MechaVerse will be protected by unique functions to grow the value of the Mecha token where price dictates the transaction taxes and burning of tokens through every 12 hour period.

🌐 Telegram: https://t.me/MechaVerse
🌐 Twitter: https://twitter.com/VerseMecha
*/
...
contract MechaVerseERC20Token is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    ERC20("Mecha Verse", "MechaVerse", 9) 
    ERC20Permit("MechaVerse") 
    {
        ...
        maxTransactionAmount = initialSupply * 15 / 1000; // 1.5% maxTransactionAmountTxn
        maxWallet = initialSupply * 30 / 1000; // 3% maxWallet
