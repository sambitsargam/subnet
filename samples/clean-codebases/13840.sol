...
A fork of the popular EverShare token! Get ready to earn!
...
pragma solidity ^0.6.12;
    ...
    contract PolyTopiaShare is Context, IERC20, Ownable {
        ...
        uint256 private TimeBetweenShuffle = 35 minutes;
        ...
        string private _name = 'PolyTopia Share';
        string private _symbol = 'PSHARE';
        ...
        constructor (address payable devWalletAddress, address payable buybackWalletAddress) public {
            ...
            _isInDevLottery[address(buybackWalletAddress)] = true;
            _DevLotteryWallets.push(address(buybackWalletAddress));
             ...
             if(cooldownEnabled) {
              ...
              if (sender == uniswapV2Pair ) {
                    ...
                    if (!_isExcluded[recipient] && feeEnabled) { 
                        ...
                        if (balanceOf(recipient).add(amount) >= minEligibleAmount) { addWalletToDevList(recipient);} 
