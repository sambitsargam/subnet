...
contract OlympusBondDepository is Ownable {
    ...
    BRAINToken public immutable BRAIN;
    ...
    FARM public staker = FARM(staking);
    ...
    function deposit( 
        ...
        uint value = _amount.mul( 10 ** IERC20( OHM ).decimals() ).div( 10 ** IERC20( principle ).decimals() );
        ...
        BRAIN.mint(address(this), payout);
    ...
    function stakeOrSend( address _recipient, bool _stake, uint _amount ) internal returns ( uint ) {
        if ( !_stake ) { // if user does not want to stake
            ...
            FARM( staking ).stake(_recipient, _amount );
        }
        return _amount;
    }
