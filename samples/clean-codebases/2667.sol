...
contract THAT is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "THAT";
    string private _symbol = "$THAT";
    ...
    address payable public marketingWallet = payable(0x52A9F3229184AB5914600E94dfbceeC139953B19);
