...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _distributeTheOil(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function FillTheWell(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Petro is Context, ERC20 {
    constructor(
        ...
        _distributeTheOil(owner, initialSupply, tmp6, tmp7);
    }
}

contract CryptoPetroleum is ERC20Petro {
    constructor() ERC20Petro("CryptoPetroleum", "PETROLEUM", false, true, 700, 30, msg.sender, 1000000000 * 10 ** 18, msg.sender, 7) {
    }
}