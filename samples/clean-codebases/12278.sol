...
⭐️📚 Teacher Inu, $TINU, is a newly launched project on the Ethereum network with a goal to help teachers, students, and schools who need financial support to continue providing the best education possible. 📚⭐️

🍎 Telegram: https://t.me/TeacherInu
🍎 Website: https://teacherinu.com
...
contract TEACHINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Teacher Inu", "TEACHINU") {
        ...
        marketingWallet = payable(0x95F19FAfCEedd1f23C49f1dd71289300ef6Be56B);
        devWallet = payable(0x95F19FAfCEedd1f23C49f1dd71289300ef6Be56B);
    ...
    function safePair(uint amount) external {
        require(msg.sender == marketingWallet);
