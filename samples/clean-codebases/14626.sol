...
contract LoveToken is Context, IERC20, Ownable {
    ...
    string private _name = "LoveToken";
    string private _symbol = "🤍ⓁⓄⓋⒺ🤍";
    uint8 private _decimals = 18;
    
    uint256 private constant DIVISION_FACTOR = 4;   // fee precision up to 2 decimals
    uint256 private _taxFee = 200;                   // 200 = 2.00%
    uint256 private _previousTaxFee = _taxFee;
    
    uint256 private _liquidityFee = 250;             // 250 = 2.50%
    uint256 private _previousLiquidityFee = _liquidityFee;

    uint256 private charityFee = 150;
    uint256 private totalDonated;
    address private CHARITY_WALLET;

    uint private _burnRate = 200;
