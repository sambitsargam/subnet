...
contract EthereumUltra is Context, IERC20, Ownable {
    ...
    string private _name = 'EthereumUltra';
    string private _symbol = 'EULTRA';
    uint8 private _decimals = 9;

    uint256 private _taxFee = 5; // 5% reflection fee for every holder
    ...
    address payable private _marketingWalletAddress = payable(0x5eEf183ADe3A55370962ba004eb7e64EC17d3E15);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 10000000000 * 10**9;
