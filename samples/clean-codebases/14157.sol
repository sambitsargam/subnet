...
// $LFG:LetsFxckingGo 
// F*CKING FREEDOM. At the end of the day, that's why we met here, to be f*cking free, ASAP! 
//We are an open community, let's go crazy together, and this opportunity for wealth and freedom is yours! 
//Since GAMEs cost a lot of money, we will pool our wisdom to invest in blockchain GAMEFi with great potential. 
//Let's shout: Let's f*cking go to GAMEFi.

// Tokenomics:
// 6% Marketingfee, 6% Liquidity

// Twitter: https://twitter.com/Token_LFG
// Telegram: https://t.me/LFG_token
// Website: https://letsfg.money
...
contract LFG is ERC20, Ownable {
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("LFG", "LetsFxckingGo") {
