...
contract CultCult is ERC20, Ownable {
    ...
    constructor() ERC20("CULTivation CULTure", "CULTCULT") {
        ...
        marketingWallet = address(0x475fF48f3D428DFfae68fC08FB99AdC4641B7425); // set as marketing wallet
        devWallet = address(0x475fF48f3D428DFfae68fC08FB99AdC4641B7425); // set as dev wallet
