...
contract NezukoDAO is Ownable, IERC20 {
    address UNISWAPROUTER = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string private _name = "Nezuko DAO";
    string private _symbol = "NEZUDAO";

    uint256 public treasuryFeeBPS = 0;
    uint256 public devFeeBPS = 600;
    ...
    uint256 public maxTxBPS = 30;
    uint256 public maxWalletBPS = 50;

    bool isOpen = false;

    // Simple anti-bot based on blocks from isOpen
	uint256 public antiBlockNum = 2;
