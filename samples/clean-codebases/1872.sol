...
/**
Low tax Eth coin launching today in celebration of BAYC’s biggest mint ever.

Giving away plots of land to the community

Website:https://www.otherdeedbayc.xy
Telegram:https://t.me/OthersideBAYC
*/
...
contract Otherside is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Otherside", "Otherside") { 
        ...
        maxTransactionAmount = totalSupply * 15 / 1000; // 0.5% maxTransactionAmountTxn
        maxWallet = totalSupply * 45 / 1000; // 1.5% maxWallet
