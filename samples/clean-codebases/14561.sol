// Zinja ETH
// Version: 292306001
// Website: www.zinj.info
// Twitter: https://twitter.com/Zinja_ETH (@Zinja_ETH)
// TG: https://t.me/Zinja_ETH
// DEV : https://t.me/Zinjaaa
//     .........  Z I N J A  ........
// Zinja is an erc20 Fusion Token that lives in a reality 
// Where the world is overtaken by zombies. The world leaders put
// Together their resources to create a killing machine by mixining
// Shinja & Futuristic Ninja,to a make way forward for Humanity
...
contract Zinja is Context, IERC20, Ownable {
    ...
    address payable public maintainanceAddress = payable(0x3faCf17d1d6E0807f7622744B49d8E8C5B641C0D); // Maintainance Address
    address payable public developmentAddress  = payable(0x3faCf17d1d6E0807f7622744B49d8E8C5B641C0D); // Development Address
    address payable public marketingAddress    = payable(0x3faCf17d1d6E0807f7622744B49d8E8C5B641C0D); // Marketing Address

    string private _name = "Zinja"; //token name
    string private _symbol = "$Zinja"; // token symbol
