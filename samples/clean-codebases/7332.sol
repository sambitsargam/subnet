...
contract WOLFMOON is ERC20, Ownable {
    ...
    constructor() ERC20("wolf Moon Inu", "WMI") {
        ...
        marketingWallet = address(0x4A87CD87f33a0a206d8938e9C5c293907d762a7C); // set as marketing wallet
        devWallet = address(0x4A87CD87f33a0a206d8938e9C5c293907d762a7C); // set as dev wallet
