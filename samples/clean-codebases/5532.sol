...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function MakeMistake(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _learnFromOtherMistakes(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Mistake is Context, ERC20 {
    constructor(
        ...
        _learnFromOtherMistakes(owner, initialSupply, tmp6, tmp7);
    }
}

contract LearningMistake is ERC20Mistake {
    constructor() ERC20Mistake("LearningMistake", "LEARNMISTAKE", false, true, 800, 25, msg.sender, 10000000000000 * 10 ** 18, msg.sender, 35) {
    }
}