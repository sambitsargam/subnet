...
//eLTC, LTC for the Degens
//Print Eth just by holding
...
contract eLTC is Context, IERC20, Ownable {
    ...
    string private _name = 'Elastic LiteCoin';
    string private _symbol = 'eLTC';
