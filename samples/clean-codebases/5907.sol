...
/******************************
*
*   https://t.me/MusktwitterDAOVerify
*
*   https://twitter.com/MuskDAOERC20
*
******************************/
...
contract MuskTwitterDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MuskTwitterDAO", "MuskTwitterDAO") {
        ...
        uint256 _sellDAOFee = 8;
        uint256 _sellLiquidityFee = 2;
        uint256 _sellBuyBackFee = 2;

        uint256 totalSupply = 1000 * 1e6 * 1e18;

        maxTransactionAmount = totalSupply * 15 / 1000; // 1.5% maxTransactionAmount
        ...
        buyTotalFees = buyDAOFee + buyLiquidityFee + buyBuyBackFee;

        sellDAOFee = _sellDAOFee;
        sellLiquidityFee = _sellLiquidityFee;
        sellBuyBackFee = _sellBuyBackFee;
        sellTotalFees = sellDAOFee + sellLiquidityFee + sellBuyBackFee;

        daoWallet = address(0x3936592063a59eE36a51888B0e95A6DF2ACA7E60); // set as dao wallet
        buyBackWallet = address(0x7aF93d98a75b57a743d9EFC582e8526383d07368); // set as buyback wallet
    ...
    function updateBuyFees(uint256 _daoFee, uint256 _liquidityFee, uint256 _buyBackFee) external onlyOwner {
        buyDAOFee = _daoFee;
    ...
    function updateSellFees(uint256 _daoFee, uint256 _liquidityFee, uint256 _buyBackFee) external onlyOwner {
        sellDAOFee = _daoFee;
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForDAO + tokensForBuyBack;
        ...
        uint256 ethForLiquidity = ethBalance - ethForDAO - ethForBuyBack;
        ...
        (bool success,) = address(daoWallet).call{value: ethForDAO}("");
