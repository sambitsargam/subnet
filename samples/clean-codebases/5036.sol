...
https://t.me/CheeseKong

http://www.cheesekong.info
...
contract CheeseKong is Context, IERC20, Ownable {
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x57eCecD961ce3895719422413b1F43B37A55f366);
        _feeAddrWallet2 = payable(0x57eCecD961ce3895719422413b1F43B37A55f366);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x57eCecD961ce3895719422413b1F43B37A55f366), _msgSender(), _tTotal);
    }
