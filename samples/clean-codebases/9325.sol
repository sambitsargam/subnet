...
contract Moskovko is ERC721Enumerable {
    using Base64 for string;
    uint256 constant TOKEN_ID = 1;
    string json = '{"name":"Andrew","description":"This is Andrew Moskovko and he is a trader! He also admires blockchain technology...","image":"https://cloudflare-ipfs.com/ipfs/QmRbVu2V8NnpPFJnaq9V2zHEgDhLp6VCtoDWxauuHDMJ3s","attributes":[{"trait_type":"Birthdray","value":"15.12.1992"},{"trait_type":"Mood","value":"Bitcoin at 100,000"}]}';

    constructor() ERC721("Moskovko NFT", "MOSK") {
    ...
    function setUri(string memory data) public {
