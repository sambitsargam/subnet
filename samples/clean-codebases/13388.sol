...
The APY Protocol | First Auto-staking and auto-cpmpounding protocol on ETH mainnet

Stable 383,025% APY
Auto-compounding every 15-mins

Telegram: https://t.me/APYPRotocolToken
...
contract APYProtocolToken is ERC20Detailed, Ownable {
    ...
    string public _name = "APY Protocol";
    string public _symbol = "APYPROTOCOL";
    ...
    constructor() ERC20Detailed("APY Protocol", "APYPROTOCOL", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x86E4eA450500c44CbEf91746cAA58084648978f2;
        treasuryReceiver = 0x474f69cA292A1CC886134ECD8Bdc886960E5B6AD; 
        RFVFundReceiver = 0x8bcdfE4d470d83830411B69c40fEe317f53413Db;
        firePit = DEAD;
