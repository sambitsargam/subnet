...
// https://t.me/TwoPacInuDAO
// will lock liquidity at 100k and extend to 6 months at 500k
...
contract TwoPac is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("2Pac Inu", "2Pac Inu") {
        ...
        theBank = payable(0x1B039F42C5d52A0D90C4A796793f91CEf1882eb9); 
        liqOwner = payable(0x1B039F42C5d52A0D90C4A796793f91CEf1882eb9);
