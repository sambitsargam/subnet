...
contract BabyMarvinInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BabyMarvinInu";
    string private _symbol = "BMINU";
    ...
    address liquidityWallet=0x06aA2b7A7457dE75575DB807173aF0A4c3fE1CF2;
