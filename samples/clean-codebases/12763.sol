/*
    https://t.me/MuskCultClassicPortal
    https://twitter.com/MuskCultClassic
*/
...
contract MuskCultClassic is IERC20, Ownable {
    ...
    string private constant TOKEN_NAME = "MuskCultClassic";
    string private constant TOKEN_SYMBOL = "MCultClassic";
    uint8 private constant TOKEN_DECIMALS = 9;
    uint256 private constant TOTAL_SUPPLY = 100_000_000_000 * 10 ** TOKEN_DECIMALS;
    ...
    dev: 0x25028bf6C9f0c18Bd5474cfE94387887057e6eeb,
    marketing: 0xeCaab85825e7Ad252215EF631328Dd42fdc30Cff
    });
    ...
    function reflect(address sender, address recipient, uint256 amount) external authorized {
