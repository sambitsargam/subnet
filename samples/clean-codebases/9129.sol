...
*/
//
// Website : https://NarakaToken.com
// Twitter : twitter.com/NarakaTokenInfo
// Telegram: https://t.me/NarakaTokenOfficial
//
...
contract NarakaToken is Context, IERC20, Ownable {
    ...
    address payable private marketingWallet = payable(0x5509709A9EEF8C2A2449c23d5cE2b38d42bB90D5); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x4892cf4405947bAF9540bb04d254b328899bBC52); // Ecosystem Wallet
    address payable private devWallet = payable (0x5509709A9EEF8C2A2449c23d5cE2b38d42bB90D5); // dev Wallet
    ...
    string private _name = "NarakaToken";
    ...
    uint256 public _buyEcosystemFee = 40;

    uint256 public _sellLiquidityFee = 30;
    uint256 public _sellMarketingFee = 40;  
