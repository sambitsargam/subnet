...
contract STABLEGAINS is ERC20, Ownable {
    ...
    uint256 public buyDivisorFees = 3;
    ...
    uint256 public sellMarketingFeeWindow1 = 6;
    uint256 public sellMarketingFeeWindow2 = 5;
    uint256 public sellMarketingFeeWindow3 = 3;
    uint256 public sellMarketingFeeWindow4 = 2;
    ...
    constructor() ERC20("Stable Gains", "STABLE") {
        ...
        uint256 totalSupply = 90000000000 ether;
        
        maxTransactionAmount = totalSupply * 99 / 1000; //.99% 
   ...
   function updateMarketingFeeForSellWindows(
    ...
    function getSellFeesAccount(address addr) 
        ...
        uint256 CurrentMarketingFee) 
    {
        uint256 feesWithoutLiquidityAndMarketing = sellDevFee;
