...
contract StrategyCommonChefLP is StratManager, FeeManager, GasThrottler {
    ...
    event ChargedFees(uint256 callFees, uint256 liquidCFees, uint256 strategistFees);
    ...
    function chargeFees(address callFeeRecipient) internal {
        ...
        emit ChargedFees(callFeeAmount, liquidCFeeAmount, strategistFeeAmount);
    }
...
contract StratManager is Ownable, Pausable {
     ...
     * @param _liquidCFeeRecipient address where to send Beefy's fees.
     */
    constructor(
        address _keeper,
        address _strategist,
     ...
     * @param _liquidCFeeRecipient new beefy fee recipient address.
     */
