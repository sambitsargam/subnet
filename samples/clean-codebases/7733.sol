...
/**
  ...
  Max Wallet: 3%
  Max transaction: 1%
  Buys: 10% Sells 20% for first 24 hours, then 11% 
*/
...
contract YukiBonk is Context, IERC20, Ownable {
    ...
    string private constant _name = "Yuki Bonk";
    string private constant _symbol = "YUBO";
    ...
    uint256 public _sellMarketingFee = 18; // these taxes will be set so match the buy taxes after 24 hours 
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x77986b76f299db5a6c569B8AaFAD5fC50Ef15e44); // Marketing Address
        
        devAddress = payable(0x1ACBf91Abc1282eaCb8C11E546095e3935485B19); // Dev Address
