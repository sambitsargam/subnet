...
contract Robinshib is Context, IERC20, Ownable {
    ...
    string private _name = "Robinshib";
    string private _symbol = "RSHI";
    ...
    address payable public marketingWallet = payable(0xc37C58FEc615a2653e9e59838C1F0eA7fBa0450d); // marketing wallet address
