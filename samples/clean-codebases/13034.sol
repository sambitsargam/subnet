...
contract Kongurai is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kongurai";
    string private constant _symbol = "KONGURAI";
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 40;
        ...
        marketingAddress = payable(0xE7c96Ee584e1Ca343323559153844eaAB04f2e50); // Marketing Address
 
        devAddress = payable(0x508852cD4Ab58aEC8B3B4Ab9C8a0dbe49f759B02); // Dev Address
        ...
        emit Transfer(address(0), _msgSender(), _tTotal * 40 / 1000);
