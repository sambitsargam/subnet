...
contract Exodus is ERC20, Ownable {
    ...
    constructor() ERC20("Exodus", "Exodus") {
        ...
        theBank = payable(0xA0B62eC9c6b4137908AbFccc4058e7CC80A1DAB1); 
        liqOwner = payable(0xA0B62eC9c6b4137908AbFccc4058e7CC80A1DAB1);
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0xA0B62eC9c6b4137908AbFccc4058e7CC80A1DAB1) &&
                !inTheZone
            ){
