...
contract TWITTAINU is Context, IERC20, Ownable {
    ...
    string private _name = "TWITTA INU";

    string private _symbol = "TWITTA";
    ...
    uint256 public autoaddliquidity = 1;

    uint256 public marketingtax = 3;

    uint256 public devtax = 3;     

    address payable public mkwallet = payable(0xDF92829B853576cD61e0a4aBF0f0f8337def238B); 

    address payable public devwallet = payable(0xDF92829B853576cD61e0a4aBF0f0f8337def238B); 

    address public immutable zeroaddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public limitbuy = 30000000 * 10**9; 

    uint256 public limitwallet = 30000000 * 10**9; 

    uint256 private minimumtoswap = 1000 * 10**9;   
