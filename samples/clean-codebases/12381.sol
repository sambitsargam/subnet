...
Ganja Token Socials:
Telegram: https://t.me/ganjatoken_official
Twitter: https://twitter.com/ganja_token
Website: www.ganjatoken.co
Whitepaper: https://drive.google.com/file/d/1xFXd08lA8fq2WcFZZoTmGjPIo1q2-BSK/view?usp=sharing

** Using FTPEthReflect to give 3.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x085cc288545cFc43352004D703ca5aAFA6e5d892), 1080);
		setTaxAlloc(payable(0x18C18c4bF8Ac39363fe9bF21E3C89BAa6B5193E0), 1080);
		setTaxAlloc(payable(0x79C64C2801b278162E0F3dB8Aa6E8216a4c94fE7), 1080);
		setTaxAlloc(payable(0xbd88517B8d03F9794023cae4AF1599433a0CC4Ca), 720);
		setTaxAlloc(payable(0x82276a7eE8D09f14fD54f818B742625AfAb52563), 40);
        m_DidDeploy = true;
    }
...
contract GanjaToken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 420000000000 * 10**9;
    string private m_Name = "Ganja Token";
    string private m_Symbol = "GANJA";
    ...
    function addLiquidity() external onlyOwner() {
        ...
        FTPLiqLock(m_LiqLockSvcAddress).lockTokens(m_UniswapV2Pair, block.timestamp.add(36500 days), msg.sender);
		EthReflect.init(address(this), 3000, m_UniswapV2Pair, _uniswapV2Router.WETH(), _ethBalance, TOTAL_SUPPLY);
        m_Liquidity = true;
    }
