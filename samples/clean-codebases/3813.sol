...
contract Dead is ERC20, Ownable {
    ...
    constructor() ERC20("0x000Dead", "Dead") {
        ...
        sellTotalFees = sellOperationsFee + sellLiquidityFee + sellDevelopmentFee;
        
        operationsWallet = address(0xda7692695A67691bf182f7210F3b8997C64b78A9);
        developmentWallet = address(0xB94A2fcA841d05Cb71C791279aB619e7F4630e95);
    ...
    function updateBuyFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _developmentFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _operationsFee, uint256 _liquidityFee, uint256 _developmentFee) external onlyOwner {
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForOperations + tokensForDevelopment;
        bool success;
        ...
        uint256 ethForLiquidity = ethBalance - ethForOperations - ethForDevelopment;
