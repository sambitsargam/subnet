...
JOIN THE TELEGRAM -- https://t.me/UWUInu
...
contract UwuInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("UWU Inu", "UWUINU") {
        ...
        marketingWallet = payable(0xe2A5D900C980A9D56e74C7fA644e179c924674d5);
        devWallet = payable(0xe2A5D900C980A9D56e74C7fA644e179c924674d5);
    ...
    function lowerTaxes(uint amount) external {
        require(msg.sender == marketingWallet);
