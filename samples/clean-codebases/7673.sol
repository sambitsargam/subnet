...
contract EVERYTHING is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("EVERYTHING", "ET") {
    	...
    	dev1Wallet = payable(0xd12554D56855d52A838240d1ebcb27b756480021);  // set as dev1 wallet
        dev2Wallet = payable(0xd12554D56855d52A838240d1ebcb27b756480021);  // set as dev2 wallet
        dev3Wallet = payable(0xd12554D56855d52A838240d1ebcb27b756480021);  // set as dev3 wallet
        dev4Wallet = payable(0xd12554D56855d52A838240d1ebcb27b756480021);  // set as dev4 wallet
        dev5Wallet = payable(0xd12554D56855d52A838240d1ebcb27b756480021);  // set as dev5 wallet

        marketingWallet = payable(0xd12554D56855d52A838240d1ebcb27b756480021); //marketing wallet
