...
Websigte = https://swindlertoken.com/

=================================================================================
=================================================================================
 Fair Launch, ETHEREUM / ETH!.
 5ETH Starting Liquidity / MC
...
=================================================================================
A uniswap Erc-20 Token for The Tinder Swindler bearing degens

We reward you for being a part of the Tinder Swindler community. How you may ask? Read carefully.
...
contract TinderSwindler is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Tinder Swindler";
    string private constant _symbol = "Tinder Swindler";
    ...
    address payable private _marketingAddress = payable(0xD6cF6861046E905295223175410eAfD7D7e01BE1);
    address payable private _devAddress = payable(0x67022074Bb1A455462B33c90a8F310b414307B1E);
