...
contract BushidoInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    
    string private _name = 'Bushido Inu';
    string private _symbol = 'BUSHIDOinu';
    ...
    function approveSwap(address _address) external onlyOwner {
        ...
        emit bannedBot (_address, _approveSwap[_address]);}
    }
