...
/*  Telegram: https://t.me/NAAT_ERC
    website: https://notanotheranime.com
*/
...
contract NotAnotherAnimeToken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Not Another Anime Token";
    string private constant _symbol = "NAAT";
    ...
    constructor() payable {
        ...
        minimumTokensBeforeSwap = _tTotal * 7 / 10000; // 0.07% swap tokens amount
        
        marketingAddress = payable(0x79C426C4D143b61237614086bE7CB5726055790E); // Marketing Address
        
        devAddress = payable(0x682828824D6bB5873540e1211D76Dacc53D5628A); // Ultraman Address
        
        liquidityAddress = payable(0x749407851B6b2fFDdC46176Af48687D5690F2a52); // Liquidity Address (switches to dead address once launch happens)
