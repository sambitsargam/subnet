...
/** 
QUEST TOKEN for Omniworld.Quest
*/
...
contract QUEST is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 50 * 10**21 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    address payable public _marketingAddress =
        payable(address(0x49404E7516B6d4770ED03f48b4b167F9e1eC8903));
    ...
    string private _name = "QUEST";
    string private _symbol = "QUEST";
    ...
    uint256 public _maxTxAmount = 25 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 1 * 10**18 * 10**9;
    uint256 public _maxWalletSize = 50 * 10**19 * 10**9;
