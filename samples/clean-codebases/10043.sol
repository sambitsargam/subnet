...
Token for our favorite legal-loli-esper!
https://t.me/TatsuMakiRoll
...
contract TatsumakiRoll is Context, IERC20, Ownable {
    ...
    string private _name = "Tatsumaki-Roll";
    string private _symbol = "TatsumakiRoll";
    
    uint256 public _reflectFee = 1;
    uint256 private _previousReflectFee = _reflectFee;
    uint256 private maxReflectFee = 49;
    
    uint256 public _liquidityFee = 5;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private maxLiquidityFee = 49;

    uint256 public _marketingFee = 3;
    uint256 private _previousMarketingFee = _marketingFee;
    uint256 private maxMarketingFee = 49;
    ...
    address payable private _marketingWallet = payable(0xe0b08befe2092e4c89956dE3A9c959d20A18a92A);
