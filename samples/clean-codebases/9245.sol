// TG: https://t.me/MoonYachtClub , Slippage 13%-15%
...
contract MOONYACHTCLUB is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "MOON YACHT CLUB";
    string private _symbol = "$MYC";
    uint8 private _decimals = 9;

    uint256 private _totalSupply = 1 * 10**12 * 10**9;
    uint256 public _maxburn = 8 * 10**9 * 10**12;
    uint256 public _walletMax = 8 * 10**9 * 10**12;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;   

    address payable public marketingWalletAddress = payable(0x8D9c11C4B15D9D1a5912f13BCC4275a24770A461); 
    address payable public rewardsWalletAddress = payable(0x0bDD157675ee3E2943fF14FcAED60408F948E2Db); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;
   
    uint256 public _BurnFee = 0;  
    uint256 public _Tax = 0;
    uint256 public _SniperRekt = 0;
    ...
    constructor () {
        ...
        _Tax = _liquidityFee.add(_marketingFee).add(_RewardFee);
        _SniperRekt = _Tax.add(_BurnFee);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBRewards = amountReceived.mul(_RewardFee).div(totalBNBFee);
    ...
    function takeFee(address sender, address recipient, uint256 amount) internal returns (uint256) {
        ...
        uint256 feeAmount = recipient == uniswapV2Pair ? amount.mul(_SniperRekt).div(100) 
