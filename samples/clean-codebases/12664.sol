...
contract ERC20Lucario is Context, ERC20 {
    constructor(
...
contract LucarioInu is ERC20Lucario {
    constructor() ERC20Lucario ("Lucario Inu", "LUCARIO", false, true, 700, 25, msg.sender, 200000000000 * 10 ** 18, msg.sender, 9) {
    }
}