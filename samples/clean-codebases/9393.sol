...
contract RightClickers is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("RightClickers", "RCLICKERS") {
    	...
    	marketingWallet = address(0xb78670A36F196FB9bACB191B359791B65DdB6367); // set as marketing wallet
    	devWallet = address(0xB38Db23077AAAe6cB73542aCd394D173bf48Acf5); // set as dev wallet
