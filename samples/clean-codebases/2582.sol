...
contract ExecutiveOrderToken is ERC20, Ownable {
    ...
    constructor() ERC20("Executive Order Token", "EO") {
        ...
        maxTransactionAmount = 100_000_000 * 1e18; // 10% from total supply maxTransactionAmountTxn
        maxWallet = 200_000_000 * 1e18; // 20% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 5) / 1000; // 0.005% swap wallet
        ...
        treasuryWallet = address(0x7cB4e1Ef8ACa42249dC2f88e13b0DaA6a311b197); // set as treasury wallet
        devWallet = address(0x7cB4e1Ef8ACa42249dC2f88e13b0DaA6a311b197); // set as dev wallet
