...
/*
 ...
 💫Welcome to $SAILOR💫
 💫SailorMoon is the story of the magical action-adventures of a teenage girl who
 learns of her destiny as the legendary warrior Sailor Moon and must band together
 with the other Sailor Scouts to defend the Earth and Galaxy.✅

$SAILOR aims to be the biggest anime token in the Ethereum chain with multiple utilities such as: 

1️⃣SailorPad (hosting new anime projects) 
2️⃣SailorSwap ( dedicated swap only for anime tokens) 
3️⃣SailorNFTs (powerful NFTs airdropped to holders stake them to earn ETH and more SAILOR)

https://t.me/SailorMoonPortal
...
contract SailorMoon is ERC20, Ownable {
    ...
    constructor() ERC20("SailorMoon", "SAILOR") {
        ...
        marketingWallet = address(0x6240E0122e09c39e192341C57FFeC9CB690dad25); // set as marketing wallet
        devWallet = address(0x6240E0122e09c39e192341C57FFeC9CB690dad25); // set as dev wallet
