...
contract FixedAPYStaking is Ownable, ReentrancyGuard {
    ...
    constructor(
        ...
        stakingToken = IERC20(0x4D21c6Bc6C899FEB2d3DC05B76B52aABF3217F1b);
        rewardToken = IERC20(0x4D21c6Bc6C899FEB2d3DC05B76B52aABF3217F1b);
    ...
    function updateLockDuration(uint256 newLockDurationInSeconds) external onlyOwner {
        require(newLockDurationInSeconds <= 30 days, "Lock must be lower than 30 days");
        lockDuration = newLockDurationInSeconds;
    }
