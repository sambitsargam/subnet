...
// File contracts/HereBeforeToken.sol
...
contract HereBeforeToken is ERC721Enumerable, Ownable {
    ...
    address artist = 0x59765c7Ba32fD26F05f7e0Da5C9e3E9C2461c211;
    address dev = 0xEDaB0bbf4726ebE7EA1a58B6a1A18658a189BCb9;

    mapping(uint256 => uint256) updatedValues;

    constructor() ERC721("Here Before 100K", "HB100K") {
    }
