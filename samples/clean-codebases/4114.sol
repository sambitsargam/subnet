...
/**
Welcome to the Uprising. The Uprising.
...
We are living it now. This is the time where we make our stand. 

War. Famine. Death. 

But we can stop it. We can take the power back. 

Decentralization is the key. We are all equals. We are all one. 

We are not special. We are your friends, your family. 

Your coworkers and your colleagues.

We are you.

And we hold the power. 

The Uprising is the first step to do so. 

The Uprising is community focused. The creators and the community are one and the same.

The contract is safe. The contract is renounced. The liquidity is locked. 

There is no risk of rug pulls. 

There is just the uprising. 10% of all transactions will be used for step two.
...
contract Uprising is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Uprising", "Uprising") {
	...
	earlySellDevFee = _earlySellDevFee;
        ...
        /*
            ...
            and CANNOT be called ever again. Uprising is a safe token.
        */
