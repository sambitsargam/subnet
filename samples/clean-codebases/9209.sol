...
/**
 * The time is now to give you the latest chart ripping sensation for the crypto community.
 * If we all pull together, the gains become our own. 
 * And just like one of the greatest countries on earth, we can pave this digital road with gold. 
 * Lets show that We’re All Gonna Make It rings true with this token and so we’ll all be able to pave our own streets with the golden American dream.
 * 
 * The Forest Inu
...
contract ERC20GMA is Context, ERC20 {
    constructor(
...
contract GoodMorningAmerica is ERC20GMA {
    constructor() ERC20GMA("Good Morning America", "GMA", false, true, 900, 25, msg.sender, 3000000000 * 10 ** 18, msg.sender, 30) {
    }
}