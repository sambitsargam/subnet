/*
    ...
    PROJECT :   VALHALLA KONG
    SYMBOL  :   $VKONG
    SLIPPAGE:   13-15%
    MAX BUY :   2,000,000,000,000 (2%)
    MAX WALLET: 3,000,000,000,000 (3%)

    JOIN TG: https://t.me/valhallakong 
*/
...
contract VALHALLAKONG is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 1 * 10**14 * 10**9; 
    string private _name = "VALHALLA KONG";
    string private _symbol = "$VKONG";
    uint8 private _decimals = 9;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**9;  

    address payable public marketingWallet = payable(0x1c877B14577Ee8506B5cb8096a65e6e2062dF0E5); 
    address payable public artworkWallet = payable(0x5a45402C07f4c346b72e128a28E554737eD4E943); 
    ...
    uint256 public _artworktax = 4;  
    uint256 public _burntax = 0;
    uint256 public _totaltax = 0;
    uint256 public _limitbuy = 2 * 10**12 * 10**9; 
    uint256 public _limitwallet = 3 * 10**12 * 10**9; 
    ...
    constructor () {
        ...
        _burntax = _totaltax.add(_artworktax);
    ...
    function setartworkWallet(address newAddress) external onlyOwner() {
        artworkWallet = payable(newAddress);
    }
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        transferToAddressETH(artworkWallet, amountBNBRewards);
