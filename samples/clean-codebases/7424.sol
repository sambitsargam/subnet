...
$$ |  $$ |$$ |  $$ |$$ |  $$ |$$   ____|$$ |  $$ |$$ |  $$ |$$ |  $$ |$$ |  $$ |
$$$$$$$  |\$$$$$$  |\$$$$$$$ |\$$$$$$$\ \$$$$$$$ |$$ |  $$ |\$$$$$$  |$$$$$$$  |
\_______/  \______/  \____$$ | \_______| \____$$ |\__|  \__| \______/ \_______/ 
                    $$\   $$ |          $$\   $$ |                              
                    \$$$$$$  |          \$$$$$$  |                              
                     \______/            \______/                                                                                                                                                                                       
...
contract DogeHub is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public rewardAddress = payable(0x71FDD8d51359004f89Ba1F0fA61BA0db856c9eB3); // Reward Address
    address payable public developmentAddress = payable(0x71FDD8d51359004f89Ba1F0fA61BA0db856c9eB3); // Development Address
    ...
    string private _name = "DogeyHub";
    string private _symbol = "DOGHUB";
    ...
    uint256 public rewardDivisor = 5;
    uint256 public developmentDivisor = 5;
    ...
    function _transfer(
        ...
        require(!_isBot[to] || !_isBot[from], "DogeyHub: To/from address is ignored");
