...
contract KAGUTSUCHI is Context, IERC20, Ownable {
    ...
    string private _name = "KAGUTSUCHI";
    string private _symbol = "KAGU";
    ...
    address payable public marketingWallet = payable(0x894C158800a40573d276255Aca77cD5E88C04a7e);
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public _devFee = 0;
    address payable public devWallet = payable(0x894C158800a40573d276255Aca77cD5E88C04a7e);
