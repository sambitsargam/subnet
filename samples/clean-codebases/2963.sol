...
contract MooneyToonz is Context, IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = treshold * 2 / 1000; //10 for 1% 11 for 2.5%
    uint256 public _maxWalletSize = treshold * 1 / 100; //1%
    
    uint256 public numTokensSellToAddToLiquidity = treshold * 1 / 1000; //.1% //1%
