...
/*
 ...
 Telegram
 https://t.me/RallyTokenn
 
 Website
 http://www.rallytoken.biz/
...
pragma solidity ^0.6.12;
    ...
    contract Rally is Context, IERC20, Ownable {
        ...
        string private constant _name = 'Rally';
        string private constant _symbol = 'RLY';
...
The team will help fund the initial costs and marketing; however, we charge 5% transactions that are going directly into marketing of the coins. Whilst the team will be making the final decision on where it goes, we are directly committed to working with the community on the future marketing steps. We will predominantly be communicating with our community through Telegram, however as we get more moderators we can look to expand. Our main focuses for marketing from inception are Telegram & Twitter. Telegram can help attract the initial joiners, although Twitter exposure is unparalleled for a successful rally of such tokens. 
Disclaimer
Our marketing will be solely based in Europe, and we do not plan to promote the US region. Roadmap’s timelines and future objectives are all subjective to the initial success of the token. 
*/