...
Pump Token Socials:
Telegram: https://t.me/PumpToken2Pump
Twitter: https://twitter.com/Pumptoken2Pump
Website: http://pumptoken.quest
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xa10D31D586FFFBb28184d501691aa40B33153292), 5000);
        m_DidDeploy = true;
    }
...
contract PumpToken is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000 * 10**9;
    string private m_Name = "Pump Token";
    string private m_Symbol = "PUMP";
