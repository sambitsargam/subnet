...
contract DutchAuction is ERC1155Holder, ReentrancyGuard {
    ...
    constructor(
        ...
        // require(_tokenIds.length == 30, "err:tokenIds");
        ...
        currentTokenIndex = 0;
        tokenIds = [48140505124491600008018462510081168373768676474431063544200989248772491968513];
        // for (uint256 index = 0; index < _tokenIds.length; index++) {
            // tokenIds[index] = _tokenIds[index];
        // }
