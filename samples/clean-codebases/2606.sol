...
// TG: https://t.me/boredkatz , SLIPPAGE 14-16%
...
contract BOREDKATZ is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BORED KATZ";
    string private _symbol = "$BOREDKATZ";
    ...
    address payable public marketingWallet = payable(0xa2Db6B90C63d2455841E9C0775408D1BdD57D653); 
    address payable public rewardsWallet = payable(0x1434076F90d4E5202306eED2fb3385380D47Ae3F); 
    ...
    uint256 public _mbuy = 4 * 10**10 * 10**9; 
    ...
    function _transfer(address sender, address recipient, uint256 amount) private returns (bool) {
        ...
        else
        {
            if(sender != owner() && recipient != owner()) {
                require(amount <= _mbuy, "Transfer amount exceeds the maxTxAmount.");
            }
