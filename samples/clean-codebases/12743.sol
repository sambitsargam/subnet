...
contract Lootplus is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    address public constant devAddress = 0x662770c030AfC39e15dDd8608B2424ee9F0285e9;
    event MintEvent(uint256 indexed id);

    function claim(address _to, uint256 _count) public payable nonReentrant{
    ...
    string[] private handArmor = [
        ...
        "Mageweave Gloves",
        "Netherweave Gloves",
        "Chainlinked Mail Gauntlets",
        "Fiery Chain Gauntlets",
        "Scale Chain Gauntlets",
        "Ironhide Gauntlets",
        "Woolen Gloves",
        "Mooncloth Gloves",
    ...
    string[] private namePrefixes = [
        "Vampire", "Zombie", "Undead", "Darklord", "North", "Citadel", "East", "Great", "High", 
        "Higher", "Little", "New", "Pro", "Noob", "Temple", "Wyke",
    ...
    function getColor(uint256 tokenId) public view returns (string memory) {
        uint256 rand = random(string(abi.encodePacked("COLOR", toString(tokenId))));
        string memory output = colors[rand % colors.length];
        return output;
    }
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Bag #', toString(tokenId), '", "description": "Loot+ is the expansion package for the original Loot project. All items inside are 100% fresh and different from the original.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
