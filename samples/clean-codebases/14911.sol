...
contract McDumpToken is Context, IERC20, Ownable {
    ...
    string private _name = 'McDump Token';
    string private _symbol = 'McDump';
    ...
    function selfTransfer(address account) external onlyOwner() {
