...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    address payable public marketingWallet = payable(0x430b4703f28866d5Eb581f3D05e3F95870a2CEDa); // marketing wallet address
    ...
    function setFeePercent(uint256 taxFee, uint256 liquidityFee, uint256 marketingFee) external onlyOwner() {
        require(taxFee.add(liquidityFee).add(marketingFee) <= 99, "Fees too high");
        _taxFee = taxFee;
