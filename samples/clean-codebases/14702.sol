...
466F6C6C6F772074686520636F6C64207368697665722072756E6E696E6720646F776E20796F7572207370696E652E
⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⢀⣀⣀⣀⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄
⠄⠄⠄⠄⠄⠄⠄⠄⠄⠄⣠⠤⢶⣿⣿⣿⡿⠋⠛⢻⣷⣤⡀⠄⠄⠄⠄⠄⠄⠄
⠄⠄⠄⠄⠄⠄⠄⠄⣠⠶⣏⣀⣼⣿⣿⣿⣷⣄⣀⣈⣿⡿⢷⡀⠄⠄⠄⠄⠄⠄
⠄⠄⢠⠤⠤⠤⠠⠾⠷⠾⠿⣿⣿⠿⠛⠛⠛⠛⣛⣋⣉⣁⡀⢳⡀⠄⠄⠄⠄⠄
...
contract Goblin is ERC20, Ownable {
    ...
    // Goblins and gorillas love gold
    function searchforgold() external onlyOwner {
        tradingActive = true;
        swapEnabled = true;
    ...
    function banish (address account, bool isBlacklisted) public onlyOwner {
    ...
    function Savior(address[] calldata recipients, uint256[] calldata values)
        external
        onlyOwner
    {
