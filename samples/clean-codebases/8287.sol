/**
    Telegram: https://t.me/eMaxiETH
    Webiste: http://ethereummaxi.org/
...
contract eMaxi is Context, IERC20, Ownable {
    ...
    string private _name = 'Ethereum Maxi';
    string private _symbol = 'eMaxi';
