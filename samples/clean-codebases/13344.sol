...
contract COOperation is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("COOperation", "$COO") {
        ...
        maxTransactionAmount = totalSupply * 19 / 1000; // 1.9% maxTransactionAmountTxn
    ...
    function addblacklistbots (address account, bool isBlacklisted) public onlyOwner {
