...
// Telegram: https://t.me/sussybakainu
// Website: WIP

// Total Supply: 1T
// No Limit, No Cooldown
// 14~16% Slippage
// 20% Tax Fee
// - 10% Redistribution
// - 3% Development
...
contract SBI is Context, IERC20, Ownable {
    ...
    string private constant _name = "Sussy Baka Inu";
    ...
    function sendETHToFee(uint256 amount) private {
        _teamAddress.transfer(amount.div(10).mul(3));
        _marketingAddress.transfer(amount.div(10).mul(2));
        _buybackAddress.transfer(amount.div(10).mul(5));
    }
