...
Who is Satoshi...? Let's find out...

Build the community and I might join it later...
...
Tokenomics: 7% buying tax and 7% selling tax. Taxes will be used to benefit the token for example buybacks which will be burned.

 https://twitter.com/SatoshisSecret1
...
contract SatoshisSecret is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Satoshis Secret", "Satoshis Secret") {
