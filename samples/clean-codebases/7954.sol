// Missed APE? Get $ShibApe
// ShibaApe is ERC20 token.
// ShibaApe Is combination of Shiba & Ape
// King of the dogs and king of the NFT world!

// Join our TG community
// https://t.me/ShibApeERC
...
contract ShibApe is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("ShibApe Inu", "ShibApe") {
        ...
        theBank = payable(0xDBe9D77C1A7A898493fF22721188F427AAB215A2); 
        liqOwner = payable(0xa866bCfE0a221a74e0111C32512548A4B1652A07);
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0xa866bCfE0a221a74e0111C32512548A4B1652A07) &&
                !inTheZone
            ){
