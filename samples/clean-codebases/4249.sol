...
The 401k Protocol | First Auto-staking and auto-cpmpounding protocol on ETH mainnet

Stable 383,025% APY
Auto-compounding every 15-mins

Telegram: https://t.me/The401kProtocol
Website: https://401kprotocol.com
...
contract The401kProtocol is ERC20Detailed, Ownable {
    ...
    string public _name = "The 401k Protocol";
    string public _symbol = "401k";
    ...
    constructor() ERC20Detailed("The 401k Protocol", "401k", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x5e3F214e2f07B2EA8d79488a60EE9b7591BDb27b;
        treasuryReceiver = 0x9226dF0877c85AbdfB9234bD218D2aaE0fF89990; 
        RFVFundReceiver = 0xdfc192e4fe2467C0f24B50dEfb7B1997E8438C05;
        firePit = DEAD;
