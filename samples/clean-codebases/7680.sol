...
/*
TG: https://t.me/bullishxdoge Website: https://www.bullishxdoge.com/
*/
...
contract BullishXdoge is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "BullishXDoge";
    string private _symbol = "BDR";
    ...
    uint256 public _liquidityFee = 15; // means 15% adds to liquidity on each buy and sell
    uint256 public _burnFee = 0; // 0% burn fee however burn wallet receives redistribution 


    address liquidityWallet=0x2b5e716bF5948c3B114CCEA8108cdC2617eD0F06;
    ...
    uint256 public maxWalletAmount = 50_000_000_000*(10**decimals()) ; // 5%
