...
contract Musknator is Context, IERC20, Ownable {
    ...
    string private _name = "Musknator";
    string private _symbol = "Musknator";
    ...
    address payable public marketingWallet = payable(0xCFf41bE63CAAB2aFE59Fb948782835B1a709AcdD);

    uint256 public _treasuryFee = 3;
    uint256 private _previousTreasuryFee = _treasuryFee;
    address payable public treasuryWallet = payable(0x14992F89051FB92067C325cfA17Fed6A13e34e03);
