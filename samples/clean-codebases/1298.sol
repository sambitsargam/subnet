...
contract Chicken is ERC20, Ownable {
    ...
    constructor() ERC20("Chicken", "KFC") {
        ...
        maxTransactionAmount = 1_000_000_000 * 1e18; //no limits no masters
        maxWallet = 1_000_000_000 * 1e18; // no limits no masters
        swapTokensAtAmount = (totalSupply * 3) / 10000; // no limits no masters

        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0xF161A3735d3153451dD62880bF70aBAFc68ADb2d); // set as marketing wallet
        devWallet = address(0xF161A3735d3153451dD62880bF70aBAFc68ADb2d); // set as dev wallet
