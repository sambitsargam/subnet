/*
pBOND ( https://porcupine.bond/ ) is the easiest way into crypto!

In today’s world, people are failing to realize how difficult it is for the average person to actually play the crypto game. Our solution - Make it caveman simple, so easy your parents can do it!

We do this through extremely comprehensive video guides that are scripted and easily translatable to any language, making it easy for anyone in the world to break free from their government or financial liabilities!

So grab some tokens, hop on board and let’s get the rest of the world aboard the crypto bandwagon!

TOKENOMICS:

No Pre-Sale = Fair Launch
Anti-bot contract
Anti-whale Max buy/sell limit
Liquidity locked at team.finance for at least 30 days.
Contract ownership renounced on Launch!
1 Trillion Total Supply.
50% to burn the address!
Auto-farming to All Holders!
8% Tax - Burn: 4% | LP: 4% ( Automatic LP funding )
...
contract pBOND is BEP20 {
     ...
     */
    constructor() public BEP20("https://porcupine.bond/", "pBOND") {
