...
Welcome to $PAPADOGE
   ...
   If you want to view all the information about this coin, please check https://t.me/PAPADOGECHANNEL
   
   I'll lock liquidity LPs through team.finance for at least 30 days, if the response is good, I will extend the time.
   I'll renounce the ownership to burn addresses to transfer $PAPADOGE to the community, make sure it's 100% safe.
   ...
   Great features:
    ...
    it's the best part of the $PAPADOGE idea, increasing the liquidity pool automatically.
...
contract PAPADOGE is BEP20 {
     ...
     */
    constructor() public BEP20("https://t.me/PAPADOGECHANNEL", "PAPADOGE") {
