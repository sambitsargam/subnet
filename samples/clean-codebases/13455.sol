/**
    ...
    tusk.finance (TUSK): Help save the elephants
    TUSK is a deflationary meme token which donates to the Argentinian Patagonia (https://giveth.io/project/help-the-patagonia/)
    For every transaction, 1% goes to burn address, 1% goes to holders, and 0.42% goes to the Patagonia foundation to recover from devastating fires
    https://tusk.finance
    https://t.me/tusk_finance
    Forked from froge.finance, say hi to our charity friends
*/
...
contract TUSK is Context, IERC20, Ownable {
    ...
    address private constant _cBoost = 0xc7D8F5f7bEfF6F69d97AFC3cE01196272E47E9B0;
    ...
    string private _name = 'tusk.finance';
    string private _symbol = 'TUSK';
    ...
    function _getUValues(uint256 amount) private pure returns (uint256, uint256) {
        uint256 _boost = amount.mul(42).div(10000);
