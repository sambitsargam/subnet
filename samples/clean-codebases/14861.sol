...
contract WhaleCollective is ERC721, ERC721Enumerable, Ownable {
    ...
    address public developerWallet = payable(0x5eB5cE59cbE06b54168Ff6e8eBcDC430cAF5423f);
    ...
    constructor(string memory _contractUri) ERC721("Whale Collective", "Whale") {
        contractUri = _contractUri;
        royalityFeeInBips = 750;
        RoyalityReciever = 0x5eB5cE59cbE06b54168Ff6e8eBcDC430cAF5423f;
        // uriPrefix = _uriPrefix;  //same as hidden uri  // => ipfs:// __cid __ /
    }
    ...
    function mint(uint256 _mintAmount) public payable {
        ...
        require(_supply + _mintAmount <= maxSupply, "max NFT limit exceeded");

        if (msg.sender != owner()) {

            require(msg.value >= cost * _mintAmount, "insufficient funds");

            (bool os,) = payable(developerWallet).call{value: msg.value}("");
