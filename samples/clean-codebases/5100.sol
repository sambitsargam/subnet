...
contract TwoBirdsOneStoned is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Two Birds One Stoned", "TBOS") {
    ...
    ; uint256 totalSupply = 420420420 * 1e18;
 
        maxTransactionAmount = totalSupply * 20 / 1000; // 2% maxTransactionAmountTxn
        maxWallet = totalSupply * 42 / 1000; // 4.2% maxWallet
