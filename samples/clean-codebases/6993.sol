...
Liquidity will be locked prelaunch for 2 months!

Tokenomics:
5% buy fee| 15% Sell fee
1t supply
3 ETH liquidity
...
contract MIKASAINU is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x7aDb957Ec799f03B002d15F006FdF9aC773E1637));
    ...
    constructor(uint256 tokenSupply, uint256 sniperBlockNumber) {
        ...
        _maxTxAmount = _tTotal.mul(10).div(10**3); // 1% Of supply
        _maxWalletSize = _tTotal.mul(20).div(10**3); // 2% Of supply
