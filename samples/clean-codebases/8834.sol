...
//Welcome to the $ShibMission shib commision will bring even greater growth, because Shib is legendary.

//Loyalty, commitment, respect, freedom and communion. All united unanimously to offer the best possible experience.
...
contract SMSN is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xbA2C490270E2019042fe0c3fab82124457F07338);
    ...
    constructor() ERC20("ShibMission", "SMSN") {
