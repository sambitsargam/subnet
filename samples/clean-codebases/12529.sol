/*
Kaws Inu | $KAWS (ERC-20)
At Kaws Inu we push the boundaries between art and the meme token movement. 

Website: www.kawsinu.com
Twitter: https://twitter.com/kawsinu
English: https://t.me/kawsinu
China: https://t.me/kawsinu_china
...
contract KAWSINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kaws Inu", "KAWS") {
    	...
    	dev1Wallet = payable(0x66ab0e7b105B78938C689f60DDfcdEfDe7ea5433);  // set as dev1 wallet
        dev2Wallet = payable(0x66ab0e7b105B78938C689f60DDfcdEfDe7ea5433);  // set as dev2 wallet
        dev3Wallet = payable(0x66ab0e7b105B78938C689f60DDfcdEfDe7ea5433);  // set as dev3 wallet
        dev4Wallet = payable(0x66ab0e7b105B78938C689f60DDfcdEfDe7ea5433);  // set as dev4 wallet
        dev5Wallet = payable(0x66ab0e7b105B78938C689f60DDfcdEfDe7ea5433);  // set as dev5 wallet

        marketingWallet = payable(0x66ab0e7b105B78938C689f60DDfcdEfDe7ea5433); //marketing wallet
