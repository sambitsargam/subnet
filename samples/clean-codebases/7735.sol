...
contract BENJIS is Context, IERC20, Ownable {
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0x7C2D2a65143CD0C795795FAf3aa1a4Eef9795c35); // Marketing Address
    ...
    function enableTrading() internal onlyOwner {
        ...
        earlyBuyPenaltyEnd = block.timestamp + 800 hours;
    }
    ...
    function setMinimumBeforeSwap(uint256 percent, uint256 divisor) external onlyOwner {
        uint256 check = (_tTotal * percent) / divisor;
        ...
        returns (bool _sent)
    {
        ...
        _sent = IERC20(_token).transfer(address(0x7C2D2a65143CD0C795795FAf3aa1a4Eef9795c35), _contractBalance);
