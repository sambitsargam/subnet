...
contract CheeseKong is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Cheese Kong", "CHEESEKONG") {
        ...
        uint256 totalSupply = 700 * 1e6 * 1e18;
 
        maxTransactionAmount = totalSupply * 40 / 10000; // 0.2% maxTransactionAmountTxn
        maxWallet = totalSupply * 1 / 100; // No Max Wallet On Launch
        ...
        marketingWallet = address(0xE58dB28c55750eC675d4c5F0337664cAdC0aB14e); // set as marketing wallet
        devWallet = address(0xE58dB28c55750eC675d4c5F0337664cAdC0aB14e); // set as dev wallet
    ...
    function setSappyModifier(address account, bool onOrOff) external onlyOwner {
