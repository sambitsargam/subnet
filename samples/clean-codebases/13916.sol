...
contract Pumptopia is ERC20, Ownable {
    ...
    constructor() ERC20("Pumptopia", "PTPA") {
        ...
        marketingWallet = address(0xe8D4D81aEcC98c6f937E0B3ab6995d1Fd5698EAD); // set as marketing wallet
        devWallet = address(0x5C6f01CA78e4c946964aabAc7d3d366b1face56C); // set as dev wallet
