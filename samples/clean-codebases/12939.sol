...
contract SIMPSONLAUNCHER is Context, IERC20, Ownable {
    ...
    address payable public marketingWallet = payable(0x665b8e49602fCe77eEd4C4229D930F21Be5Ba4A9); 
    address payable public rewardsWallet = payable(0x411D45e3Bf4290C9c7B63f7aaB2Ab76c9C58b2E6); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    string private _name = "SIMPSON LAUNCHER";
    string private _symbol = "$SIMPSON";
    uint256 private _totalSupply = 100 * 10**12 * 10**9; 
    ...
    uint256 public maxamount = 4 * 10**12 * 10**9; 
    uint256 public maxwallet = 5 * 12**10 * 10**9; 
