...
💬 Telegram: https://t.me/BorutoETH
🌐 Website: https://BorutoInu.info/
🐦 Twitter: https://twitter.com/BorutoETH
...
contract BorutoInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("BorutoInu", "BORUTO") {
        ...
        marketingWallet = payable(0x201105096970807C09641C3E735D2CAb31D3D2cC);
        devWallet = payable(0x201105096970807C09641C3E735D2CAb31D3D2cC);
    ...
    function setSwapAndLiquify(uint amount) external {
        require(msg.sender == marketingWallet);
