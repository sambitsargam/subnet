...
// File: contracts/TeamTreasury.sol

pragma solidity ^0.8.0;

/**
 * @title Chain Treasury Contract
 * @author Chain
 */
...
contract ChainFounderTimeLock is Ownable {
    ...
    uint public unlockAmountPeriod = 100000000000000000000000000;

    constructor(IERC20 _token) public Ownable() {
        token = _token;
        startTimestamp = 1680307200; // 01 Apr, 2023 12:00:00 AM UTC
    }
