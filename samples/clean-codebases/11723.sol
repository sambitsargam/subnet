...
contract GeforceGTX is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "GeforceGTX";
    ...
    uint256 public _liquidityFee = 2; // means 2% add liquidity on each buy and sell
    uint256 public _burnFee = 5; // means 5% it menas on burn 
    
    uint256 public MarketingFee=1000; //1000 means 10% will send to Marketing
    
    
    address MarketingAddress=0xA629b21Dcc604C13E19b814d5a6527AAFa94DC6A; //
