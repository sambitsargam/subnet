...
contract NINJAFOMO is Context, IERC20, Ownable {
    ...
    string private _name = "NINJAFOMO";

    string private _symbol = "NINJAFOMO";
    ...
    address payable public mkwallet = payable(0x86407D4229d61C37Ed79db72210e7A4c6d309e9A); 

    address payable public devwallet = payable(0xeB6cbF4004F3e98b8E698136Af18a2D0679268b3); 

    address public immutable zeroaddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public limitbuy = 30000000 * 10**9; 

    uint256 public limitwallet = 40000000 * 10**9; 
