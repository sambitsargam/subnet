...
contract BIGBIRD is ERC20, Ownable {
    ...
    constructor() ERC20("BIGBIRD", "BIGBIRD") {
        ...
        marketingWallet = address(0x21dc46B03dd70Ff62F6dDcBA2b5652792e00d016); // set as marketing wallet
        devWallet = address(0x21dc46B03dd70Ff62F6dDcBA2b5652792e00d016); // set as dev wallet
