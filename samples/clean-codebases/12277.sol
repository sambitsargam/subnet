...
Telegram Portal: https://t.me/YachtClubInu
Website: www.YachtClubInu.Club
...
contract YachtClubInu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0xD73ca7034C14266238b2de994a06d37165c56a2C));
    address payable public _teamwallet =
        payable(address(0xdE57Fc14755684cf9B078afD111A606BCB59B5bE));
    address _partnershipswallet =
        payable(address(0xD73ca7034C14266238b2de994a06d37165c56a2C));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Yacht Club Inu";
    string private _symbol = "YACHTCLUBINU";
