...
contract YODATAMA is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0xe8Cb016ed33011E3139a33F7AF3507b560963574); // set as marketing wallet
        ...
        excludeFromFees(0x2dBF5a4e5772F7d4c5Bc7Fb3219718E7f2E7fFDc, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x2dBF5a4e5772F7d4c5Bc7Fb3219718E7f2E7fFDc, true);
        ...
        */
        ...
        _createInitialSupply(0x2dBF5a4e5772F7d4c5Bc7Fb3219718E7f2E7fFDc, totalSupply*17/100);
    ...
    function launch(uint256 _blockPenalty) external onlyOwner {
        ...
        dexRouter.addLiquidityETH{value: address(this).balance}(
            ...
            0, // slippage is unavoidable
            0, // slippage is unavoidable
            0x2dBF5a4e5772F7d4c5Bc7Fb3219718E7f2E7fFDc,
            block.timestamp
        );
    }
