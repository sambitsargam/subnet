...
contract VNS6 is ERC20 {
    ...
    VNS6DividendTracker public dividendTracker;

    address public liquidityWallet;
    address payable public marketingWallet = 0x31b7EFac2D8BD38697eFE8e7AacEDFc3575de906;
    uint256 public swapTokensAtAmount = 1000000 * (10**18); 
    uint256 public maxWalletToken = 10000000000000 * (10**18); 
    ...
    constructor() public ERC20("VENUSIAN 6th", "VNS6") {
        uint256 _ETHRewardsFee = 4;
        uint256 _liquidityFee = 2;
        uint256 _MarketingWalletFee = 4;
    	...
    	dividendTracker = new VNS6DividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        VNS6DividendTracker newDividendTracker = VNS6DividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "The new dividend tracker must be owned by the VNS6 token contract");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "VNS6: Account is already the value of 'excluded'");
    ...
    function updateLiquidityWallet(address newLiquidityWallet) public onlyOwner {
        require(newLiquidityWallet != liquidityWallet, "VNS6: The liquidity wallet is already this address");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue != gasForProcessing, "VNS6: Cannot update gasForProcessing to same value");
...
contract VNS6DividendTracker is DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("VNS6_Dividend_Tracker", "VNS6_Dividend_Tracker") {
    	claimWait = 3600;
    ...
    function _transfer(address, address, uint256) internal override {
        require(false, "VNS6_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "VNS6_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main VNS6 contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "VNS6_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "VNS6_Dividend_Tracker: Cannot update claimWait to same value");
