...
contract Demeuro is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x954D5FbF4a71f2E14D52A98923E166D440341Bab));
    address payable public _devwallet =
        payable(address(0xe922c94161D45bdD31433B3c7B912aD214D399Ce));
    address public _exchangewallet =
        payable(address(0xf6d8e88B3682Ef1fEf838841b55F1e8B9E7cEE7A));
    address _partnershipswallet =
        payable(address(0x711AC4D63246cb106104b73fd9cF82c59f4F4d9a));
    address private _donationAddress =
        0x000000000000000000000000000000000000dEaD;

    string private _name = "Demeuro";
    string private _symbol = "DEMEURO";
    ...
    uint256 public _maxWalletSize = 10000000 * 10**3 * 10**9;
