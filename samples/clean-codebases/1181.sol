...
/*
       ...
       - Contract will be renounced 15mins after launch
       - Liquidity locked for 3 Months before launch
       -  Supply: 1 billion
...
contract ElonsNewYear is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x9A7fc32c85a9d1b9B58706fAC99A48B965961e61);    
    address payable public teamAddress = payable(0x9A7fc32c85a9d1b9B58706fAC99A48B965961e61);   
    address payable private ownerAddress = payable(0x9A7fc32c85a9d1b9B58706fAC99A48B965961e61);    
    ...
    string private constant _name = "Elons NewYear";
    string private constant _symbol = "Elon-NY";
