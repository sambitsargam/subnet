...
contract EsiFaaS is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    function add(uint256 _allocPoint, IERC20 _lpToken, uint16 _depositFeeBP, uint256 _harvestInterval, bool _withUpdate,
