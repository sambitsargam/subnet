...
contract Kyle is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000 * 10**0;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = 'Kyle Rittenhouse Coin';
    string private constant _symbol = 'Kyle';
    ...
    uint256 private _maxTxAmount = 10000000;
    uint256 private constant _numOfTokensToExchangeForTeam = 7000;
