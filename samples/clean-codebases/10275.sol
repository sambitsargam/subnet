 ...
 * Join Our Community  : https://t.me/InflationInu
...
contract INFLAT is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxLimit = 15000 * 10**9;                 
    ...
    constructor() public ERC20("Inflation Inu", "INFLAT") {
        ...
        governer = msg.sender;
        dev = payable(0xf8902860722F7c769F46401756af39Df3B129E7d);
    ...
    function setBurnFee(uint256 _burnFee) external {
        require(msg.sender == governer, "Governer only function");
        require(_burnFee <= 10, "burn fee can not be more than 10");
        burnFee = _burnFee;
    }
   ...
   function setUseBuyMap(bool _enabled) external {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee) {
            ...
            uint256 tokensForBurn = amount.mul(burnFee).div(100);
            amount = amount.sub(tokensForBurn);
            _tTotal = _tTotal - tokensForBurn;
            _burn(from, tokensForBurn);
