...
Website: https://kariocatoken.com/
Twitter: https://twitter.com/KariocaToken
...
contract KariocaToken is Context, IERC20, Ownable {
    ...
    address payable private _marketingAddress = payable(0x73458B551276dC2B41F157f4a0352A1f681c4A7F);
    address payable private _devwallet = payable(0x4f6196854546f7Fe48e1F2116B745Ca8edF36F02);
    address payable private _exchangewallet = payable(0xa6E3cb454E1bE49544AB40c85cd25490059e3A42);
    address payable private _partnershipswallet = payable(0x8317E7c43F292C637bdC29C21Eaa1cF7164C8Aec);
    address payable private _donationAddress = payable(0x0dd46752e2EC7aa94394f620aadFDE22D687d73C);

    string private _name = "KariocaToken";
    string private _symbol = "KARIOCA";
