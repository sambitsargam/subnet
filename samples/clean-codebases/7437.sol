...
contract Illusory is ERC20, Ownable {
    ...
    constructor() ERC20("Illusory", "Illusory") {
        ...
        marketingWallet = address(0x641C42D00eFcbA0ef551C105EF305b7B766654A2); // set as marketing wallet
        devWallet = address(0x641C42D00eFcbA0ef551C105EF305b7B766654A2); // set as dev wallet
