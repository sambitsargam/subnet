...
Whitepaper: https://covir.io/v2/documents/covir_v2-2.pdf
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xcdE20C1261DA72244Fc0022f93d70A115669D954), 6000);
        m_DidDeploy = true;
    }
...
contract Covir is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 8000000 * 10**9;
    string private m_Name = "Covir";
    string private m_Symbol = "CVR";
