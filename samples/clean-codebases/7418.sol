...
contract SmallAsianCock is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Small Asian Cock", "SAC") {
        ...
        maxWallet = totalSupply * 24 / 1000; // 2.4% maxWallet
    ...
    function addBlacklistAccounts (address account, bool isBlacklisted) public onlyOwner {
