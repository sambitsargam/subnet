...
/**
 __       __  ______   ______    ______    ______    ______   _______  
/  \     /  |/      | /      \  /      \  /      \  /      \ /       \ 
$$  \   /$$ |$$$$$$/ /$$$$$$  |/$$$$$$  |/$$$$$$  |/$$$$$$  |$$$$$$$  |
$$$  \ /$$$ |  $$ |  $$ \__$$/ $$ \__$$/ $$ |  $$ |$$ |  $$ |$$ |__$$ |
$$$$  /$$$$ |  $$ |  $$      \ $$      \ $$ |  $$ |$$ |  $$ |$$    $$< 
...
contract MISSOOR is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Missoor", "$MISSOOR") {
    ...
    ; uint256 totalSupply = 1 * 1e12 * 1e18;
        ...
        maxTransactionAmount = totalSupply * 10 / 1000; // % maxTransactionAmountTxn
