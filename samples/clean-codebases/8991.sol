...
// File: original_contracts/lib/balancer/IBalancerProxy.sol
...
// File: original_contracts/lib/balancer/IBalancerRegistry.sol
...
contract Balancer is IExchange, TokenFetcher {
    ...
    */
        ...
        returns (uint256)
    {
        ...
        uint256 receivedAmount = IBalancerProxy(exchangeProxy).multihopBatchSwapExactIn{value: msg.value}(
            data.swaps,
            fromToken,
            toToken,
            fromAmount,
        ...
        returns (uint256)
    {
        ...
        IBalancerProxy(exchangeProxy).multihopBatchSwapExactOut{value: msg.value}(
            data.swaps,
            fromToken,
            toToken,
            fromAmount
    ...
    function onChainSwap(
        ...
        returns (uint256)
    {
        address pool = IBalancerRegistry(balancerRegistry).getPool(
