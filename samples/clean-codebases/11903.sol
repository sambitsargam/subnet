...
contract VOLTBANK is IERC20, Ownable {
    ...
    string private constant TOKEN_NAME = "VOLT BANK";
    string private constant TOKEN_SYMBOL = "$VOLTBANK";
    uint256 private constant TOTAL_SUPPLY = 100_000_000 * 10**TOKEN_DECIMALS;       
    uint8 private constant TOKEN_DECIMALS = 18;
    uint8 public constant MAX_TAX = 15;      //Dev can never set tax higher than this value
    ...
    TaxWallets public _taxWallet = TaxWallets ({
        dev: 0x70b78Efd2aAbDD9cD55ae3227A75dfC968C23aEc,
        marketing: 0x70b78Efd2aAbDD9cD55ae3227A75dfC968C23aEc
    });
    ...
    address public rewardToken = 0x7db5af2B9624e1b3B4Bb69D6DeBd9aD1016A58Ac;
