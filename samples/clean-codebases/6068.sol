...
contract RUNWAY51 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xff268F6d2291BB6aD89A91e29ec8872FE38d8aAe); // Marketing Wallet
    address payable private ecosystemWallet = payable(0x6ce2F89232f0019EEDFD23e5EE51A04cde8B7467); // Ecosystem Wallet
    address payable private devWallet = payable (0x5843424cCB5e8772E303C834debF29745d3A15Ad); // dev Wallet
    ...
    string private _name = "Runway 51";
    string private _symbol = "RUNWAY51";
    

    uint256 public _maxWalletToken = _tTotal.div(100).mul(2);
    uint256 public _maxSellLimit = _tTotal.div(1000).mul(8); //0.2%

    uint256 public _buyLiquidityFee = 10; //2%
    ...
    uint256 public _sellMarketingFee = 80;  //8%
    uint256 public _sellDevFee = 20;   //2%
    uint256 public _sellReflectionFee = 0;
    
    uint256 private ecosystemFee = 20;   //2%
