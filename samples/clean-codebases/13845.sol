...
contract ERC20Infinity is Context, ERC20 {
    constructor(
...
contract InfinityTKN is ERC20Infinity {
    constructor() ERC20Infinity("Infinity TKN", "INFINITY", false, true, 1000, 30, msg.sender, 5000000000 * 10 ** 18, msg.sender, 7) {
    }
}