...
contract SuperheroInu is Context, IERC20, Ownable {
	...
	uint256 private _tTotal = 88000000 * 10**18;
	uint256 private _maxWallet= 88000000 * 10**18;
	...
	string private constant _name = "Superhero Inu";
	...
	function raiseBuyLimit(uint256 amount) public onlyTaxCollector{
		_maxTxAmount=amount;
	}
