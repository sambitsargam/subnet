...
contract FuckRuss is Context, IERC20, Ownable {
    ...
    string private _name = 'Fuck Russ';
    string private _symbol = 'FUCKRUSS';
    ...
    function _getTValues(uint256 tAmount) private pure returns (uint256, uint256, uint256,uint256,uint256) {
        ...
        _localVal[2]/**tholder*/ = tAmount.div(100).mul(6);
        _localVal[3]/**tLiquidity*/ = tAmount.div(100).mul(5);
