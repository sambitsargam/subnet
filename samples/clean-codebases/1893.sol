...
contract RETURNTOSPACE is Context, IERC20, Ownable, Pausable {
    ...
    uint256 private _tTotal = 1261154896 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "RETURN TO SPACE";
    ...
    address payable public marketingWallet = payable(0x3856f0bd06a5F4760B5014524039D97e63567ed0);
    ...
    uint256 public numTokensSellToAddToLiquidity = 1261154 * 10**9; //0.1%
    uint256 public _maxTxAmount = 3152887 * 10**9;
    uint256 public maxBuyTransactionAmount = 3152887 * 10**9;  //0.25%
    uint256 public maxWalletToken = 12611548 * 10**9; //1%
