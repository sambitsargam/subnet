...
/*  Website: https://KultofKek.net
    Instagram: https://instagram.com/KultofKek
    Twitter: https://twitter.com/KultofKek
    Telegram: https://t.me/KultofKek
    
    In the beginning Kek created the crypto currencies.
    The crypto was formless and empty. Kek said "Let there be gainz,
    And there was gainz.
    
    Kek created the Sigma male, and from the Sigma's GPU an e-thot was created.
    The shapeshifting entity known as NAGMEH tempted the e-thot with quick gainz from his ledger storage.
    E-thot took these gainz, and Kek saw.
    The Sigma and e-thot had committed rugpull, thus cursing all degens with gas fees.
    Only through Kek, are degens able to rid themselves of gas fees and spend eternity in the Bull run.
    Thus, followers of Kek are renown as the Kult of Kek.
    
    The Order of the Kult of Kek migrated to the crypto space after suffering a significant loss;
    their original homestead, the Great Church, had been destroyed in a great fire. 
    One fateful day, the Priestess, ever High, Misa Mayhem, was preparing the Sacred Kewl-Aide,
    a sacrament meant to deliver the souls of those who have completed the Holy Grail Wallet Pilgrimage
    to the place of Many Moons. 
    
    During this sacred rite of preparation, an agent of the Anti-Kek, Nagmeh,
    cursed Misa's Kewl-Aide concoction with gas fees, resulting in a spontaneous, catastrophic fire.
    
    As one knows, the power of church is not derived from the actual building,
    but from the degens within the building, so it was an easy transition to the internet space.
    However, the Order of the $KOK strives to keep the degens in the comfort they have accustomed to.
    By providing one's tithe in the form of $KOK, devout followers may contribute to the construction of the new church.
    
    Praise Be To Kek, and
    May Your Bags Be Ever Abundant
*/
...
contract KultOfKek is Context, IERC20, Ownable {
    ...
    string private constant _name = "Kult of Kek";
    ...
    constructor() payable {
        _rOwned[_msgSender()] = _rTotal / 1000 * 60;
        _rOwned[address(this)] = _rTotal / 1000 * 940;
        
        
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0xbe687B9f78CeF6B12ae8618E11b968A2CEBF2fA9); // Marketing Address
        
        devAddress = payable(0x7cC063e814A3Df9400f7c50552E1742C61e6D3c7); // Dev Address
        
        liquidityAddress = payable(0xD3CC0b27eD781D496f14AA59844b0C2d7c1E74ca); // Liquidity Address (switches to dead address once launch happens)
