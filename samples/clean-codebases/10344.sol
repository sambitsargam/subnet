...
PixelWorld Socials:
Telegram: https://t.me/PixelWorldToken
Twitter: https://twitter.com/PixelWorldToken
Website: Coming soon
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x8d4D8A13e4AB4b9feC384419005c66ce2094E04e), 8000);
        m_DidDeploy = true;
    }
...
contract PixelWorld is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 5000000 * 10**9;
    string private m_Name = "PixelWorld";
    string private m_Symbol = "PIXEL";
