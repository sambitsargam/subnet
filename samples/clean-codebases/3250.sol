...
contract TheVillage is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public uniswapV2Pair;
    address public constant deadAddress = address(0xdF58610413854A1091c1FD4aC220cb7994cAfC4A);
    ...
    constructor() ERC20("The Village", "VILLAGE") {
        ...
        maxWallet = 17_500_000 * 1e18; // 1.75% from total supply maxWallet
        swapTokensAtAmount = (totalSupply * 3) / 10000; // 0.03% swap wallet

        buyTotalFees = buyMarketingFee + buyLiquidityFee + buyDevFee;
        sellTotalFees = sellMarketingFee + sellLiquidityFee + sellDevFee;

        marketingWallet = address(0xdF58610413854A1091c1FD4aC220cb7994cAfC4A); // set as marketing wallet
        devWallet = address(0x980817e617ca5cDf220e87f5544592BF7a9661b3); // set as dev wallet
