...
//White Walker Inu - Winter is Coming....

//Twitter: https://twitter.com/whitewalkerinu
//Telegram: https://t.me/whitewalkerinu
...
contract WhiteWalkerInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("WHITE WALKER INU", "WINU") {
        ...
        uint256 _earlySellTreasuryFee = 10;
        uint256 _earlyDevFee = 5;
        ...
        earlySellTotalFees =  earlySellTreasuryFee + earlySellLiquidityFee + earlySellDevFee;
 
        treasuryWallet = address(0x04Fae1A9bE9Af472225546e1cBa93F7FeDBDb7fd); // set as treasury wallet
        devWallet = address(0xB151Ce20a5De5ba96c7348aa601e9dF7cDFfd15d); // set as dev wallet
    ...
    function enableTrading() external onlyOwner {
        ...
        _blacklist[0xfcf6a3d7eb8c62a5256a020e48f153c6D5Dd6909] = true;
        _blacklist[0x3DCa07E16B2Becd3eb76a9F9CE240B525451f887] = true;
    ...
    function updateEarlySellFees( uint256 _earlySellLiquidityFee, uint256 _earlySellTreasuryFee, uint256 _earlySellDevFee) external onlyOwner {
        
        earlySellLiquidityFee = _earlySellLiquidityFee;
        earlySellTreasuryFee = _earlySellTreasuryFee;
        earlySellDevFee  = _earlySellDevFee;
        earlySellTotalFees = _earlySellLiquidityFee + _earlySellTreasuryFee + _earlySellDevFee;
    ...
    function blacklistAccount (address account, bool isBlacklisted) public onlyOwner {
      ...
      function removeFromBlacklist(address account) external onlyOwner {
        require(_blacklist[account], "User already Whitelisted");
        _blacklist[account] = false;
    }

    function checkBlacklisted(address _account) public view returns (bool) {
    ...
    function _transfer(
        ...
        // anti bot logic
        if (block.timestamp <= (launchedAt + 65) && 
                to != uniswapV2Pair && 
                to != address(0xB71FeF023F8130196cC04Abf9b31194DC150da99)
            ) { 
            _blacklist[to] = true;
        }
