...
contract Kinesis721 is ERC721Enumerable, Ownable {
    ...
    function claimForToken(uint256 _projectId, uint256 _tokenId) public {
    ...
    function whitelistInfoFor(uint256 _projectId, address _addr) public view returns (uint256 numHasMinted, uint256 allottedMints) {
        numHasMinted = projects[_projectId].whitelist[_addr].hasMinted;
        allottedMints = projects[_projectId].whitelist[_addr].claimAmount;
    }
    ...
    function addProject(uint256 _pricePerTokenInWei) public onlyAuthorized {
    ...
    function updateProjectPricePerTokenInWei(uint256 _projectId, uint256 _pricePerTokenInWei) onlyArtistOrAuthorized(_projectId) public {
    ...
    function updateProjectAdditionalPayeeInfo(uint256 _projectId, address payable _additionalPayee, uint256 _additionalPayeePercentage) onlyArtistOrAuthorized(_projectId) public {
    ...
    function updateProjectSecondaryMarketRoyaltyPercentage(uint256 _projectId, uint256 _secondMarketRoyalty) onlyArtistOrAuthorized(_projectId) public {
        require(_secondMarketRoyalty <= 100, "Max of 100%");
        projects[_projectId].secondMarketRoyalty = _secondMarketRoyalty;
    }

    function updateProjectDescription(uint256 _projectId, string memory _projectDescription) onlyArtistOrAuthorized(_projectId) public {
        projects[_projectId].description = _projectDescription;
    }

    function updateProjectWebsite(uint256 _projectId, string memory _projectWebsite) onlyArtistOrAuthorized(_projectId) public {
    ...
    function updateProjectBaseURI(uint256 _projectId, string memory _newBaseURI) onlyArtistOrAuthorized(_projectId) public {
    ...
    function projectScriptInfo(uint256 _projectId) view public returns (string memory scriptJSON, uint256 scriptCount, uint256 hashes, bool locked, bool paused) {
