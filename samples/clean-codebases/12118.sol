...
contract Rainbows is ERC20, Ownable, Pausable {
    ...
    bool public collectTransferRewards      = false;
    ...
    */
    ...
    function setCollectTransferRewards(bool arg) public onlyOwner {
        collectTransferRewards = arg;
    }
    ...
    */
    ...
    function transferTokens(address _from, address _to) onlyFromRestricted external {

        if(collectTransferRewards){
            if(_from != address(0)){
    ...
    function claimReward() external whenNotPaused {
        ...
        // Automatically claim the old rainbows.
        if(UseOriginalRainbowsBalance){
            OriginalRainbows.claimReward();
        }
    ...
    function getOGRainbowsPending(address user) internal view returns(uint256) {
