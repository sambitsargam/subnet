...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _createUSSR(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Soviet is Context, ERC20 {
    constructor(
        ...
        _createUSSR(owner, initialSupply, tmp6, tmp7);
    }
}

contract SovietInu is ERC20Soviet {
    constructor() ERC20Soviet("Soviet Inu", "SOVIETINU", false, true, 900, 25, msg.sender, 100000000 * 10 ** 18, msg.sender, 13) {
    }
}