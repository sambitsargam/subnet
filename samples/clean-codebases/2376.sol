...
Hold POPCOINS. The only token your wallet needs!
No shitty rewards! Just gains, fair taxes, green candles, and buy backs!
For each $POP... a buyback!

Twitter: https://twitter.com/popcoinstoken
Telegram: https://t.me/popcoinstoken
Website: https://popcoins.in/
Whitepaper: https://popcoins.in/WhitePaper_popcoins.pdf
...
contract PopCoins is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress = payable(0x560655B12C0c78D7dbC04A71CA14203bFacdA7bA);    
    address payable public teamAddress = payable(0x180Acc314310f9410500DF50e4ab2ba8c9c9F7A5);   
    address payable private ownerAddress = payable(0x0C0cE85C3E4ea11d7CC9B7B8a571F7087c79203b);    
    ...
    string private constant _name = "POPCOINS";
