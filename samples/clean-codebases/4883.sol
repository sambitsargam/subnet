...
contract BUTTERface is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 1_000_000_000_000_000 * 10**9;
    uint256 public maxBuyLimit = 10_000_000_000_000_000 * 10**9;
    uint256 public maxSellLimit = 10_000_000_000_000_000 * 10**9;
    uint256 public maxWalletLimit = 20_000_000_000_000_000 * 10**9;
    
    uint256 public genesis_block;
    
    address public Marketing = 0xcb01c5FB4A779FBe22fDCE7ab6c1B97fC4e6fFAE;
    address public DaoWallet = 0x71388B028d0d622805098514A72D8B86c0308781;
    address public Chart = 0x2A393447E656c7BbBAFA1e2Aa71899B2A66B2229;
    ...
    Taxes public taxes = Taxes(0, 3, 4, 4, 0);
    Taxes public sellTaxes = Taxes(0, 13, 1, 4, 0);
    ...
    constructor (address routerAddress) {
        ...
        allowedTransfer[DaoWallet] = true;
    ...
    function swapAndLiquify(uint256 contractBalance, Taxes memory temp) private lockTheSwap{
        ...
        if(devAmt > 0){
            payable(DaoWallet).sendValue(devAmt);
        }
