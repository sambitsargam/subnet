...
contract CrazyRaccoonFam is ERC721, Ownable {
    ...
    uint256 public raccPrice = 20000000000000000;
    ...
    constructor() ERC721("CrazyRaccoonFam","CRF") {
    	setBaseURI(baseURI);
  	}

    function mintRacsTo(address _to, uint numberOfTokens) public payable {
        require(saleIsActive, "Wait for sales to start!");
        require(numberOfTokens <= MAX_PURCHASE, "Too much Raccoons to mint!");
        require(_currentTokenId.add(numberOfTokens) <= TOTAL_SUPPLY, "No Raccoons left!");
