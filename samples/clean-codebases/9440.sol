...
No Marketing
That is all right
Like everyone who comes to blockchain, from nothing to everything
...
The high tax is only for 30 minutes after launch, and then it drops to 5%, and then renounce ownership
...
contract NOTHING is ERC20, Ownable {
    ...
    constructor() ERC20("Everything", "NOTHING") {
        ...
        maxTransactionAmount = totalSupply * 5 / 1000; // 0.5% from total supply maxTransactionAmount
        ...
        marketingWallet = payable(0x8fF1c14dCAff0E791E85aA37bD5Bf67Ae6E85D3B);
        devWallet = payable(0x8fF1c14dCAff0E791E85aA37bD5Bf67Ae6E85D3B);
