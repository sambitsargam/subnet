...
PEPETH Socials:
Telegram: https://t.me/PepETHToken
Twitter: https://twitter.com/PepETHw
Website: https://www.pepeth.com/
Whitepaper: https://www.pepeth.com/assets/pepETH_Whitepaper.pdf

** Secured With FTPAntibot **
** Using FTPEthReflect to give 8.00% of ALL transactions to holders. **
...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0x23Ed230f6df1BC2123a30A25C4915153B7fC9421), 2800);
		setTaxAlloc(payable(0x7d246309E4516522E604142e9556D077e840a9c7), 2800);
		setTaxAlloc(payable(0x43f5E0B203Fe5E55c4Ce36AdbEfc2d6d364a1F84), 700);
		setTaxAlloc(payable(0xF700646042F850A446d348E29883B3E0a7F016a9), 700);
        m_DidDeploy = true;
    }
...
contract PEPETH is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "PEPETH";
    string private m_Symbol = "PEPETH";
