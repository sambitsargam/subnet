...
contract FUTR is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public buyTxFee = 11;
    uint256 public sellTxFee = 16;
    ...
    uint256 public maxTxLimit = _tTotal.mul(50).div(10000);         // 0.75% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(100).div(10000);    // 1.50% of total supply
    ...
    constructor(address _dev) public ERC20("FUTR Finance", "FUTR") {
