...
contract BabyVLaunch is Context, IERC20, Ownable {
    ...
    address private _devAddress = 0xF4406d6b765743C497fa8a73b9C87D2f5b89AF9A;
    ...
    uint256 public _maxTxAmount = _tTotal.div(50).mul(1);
    uint256 public _maxWalletToken = _tTotal.div(20).mul(1);
