...
contract NERD is Context, IERC20, Ownable, Pausable {
    ...
    address payable public marketingWallet = payable(0xBf45D91301E897131DE6a6386CBAf1025f5F2ca4);
    ...
    uint256 public maxWalletToken = 7500000 * 10**9; //.25%
