...
contract ELON is Context, IERC20, Ownable {
    ...
    uint256 public maxBuyLimit = 200_000 * 10**9;//2%
    uint256 public maxSellLimit = 40_000 * 10**9;//0.4% first hour then 1%
    uint256 public maxWalletLimit = 400_000 * 10**9;//4%
    
    uint256 public genesis_block;
    uint256 private deadline;
    
    address public marketingWallet = 0xa153281BbF2D294C2d0C6987B084fEC49476fFB2;

    string private constant _name = "BIZ INU";
    string private constant _symbol = "BIZ INU";
    ...
    Taxes public taxes = Taxes(2, 6, 2);
    Taxes public sellTaxes = Taxes(2, 6, 2);
    ...
    //@development kept original RFI naming -> "reward" as in reflection
