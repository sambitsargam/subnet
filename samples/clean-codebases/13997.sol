...
/* PUFF PUMP PASS - COME SMOKE WITH US - COMMUNITY 4/20 COIN
Website: Coming Soon
Twitter: https://twitter.com/BIGHIGHeth
Telegram: https://t.me/BIGHIGH420
2% Auto LP taxes only
*/
...
contract BecauseIGot$HIGH is ERC20, Ownable {
    ...
    constructor() ERC20("Because I Got", "$HIGH") { //FILL THESE IN
    ...
    function _transfer(
        ...
        // anti bot logic
        if (block.number <= (launchedAt + 10) && //block number can be changed 
                to != uniswapV2Pair && 
