...
contract CyberRodeo is Context, IERC20, Ownable {
    ...
    address private _owner = 0x8B1b544c44A62029a62B7e776ED8641c7AB30429;
    ...
    uint256 private constant _tTotal = 1 * 1e8 * 1e9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private constant _name = "CyberRodeo";
    string private constant _symbol = "CyberRodeo";
    ...
    uint256 public _maxTx= 5;
    uint256 public _maxWallet = 11;
    ...
    event SetMaxTx(uint256 transactionMax);
    
    event SetMaxWallet(uint256 walletMax);
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * _maxTx / 1000; // 0.5% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * _maxWallet / 1000; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x8B1b544c44A62029a62B7e776ED8641c7AB30429); // Marketing Address
        
        devAddress = payable(0x8B1b544c44A62029a62B7e776ED8641c7AB30429); // Dev Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 2; // 5% is the marketing tax, the other 5% goes to project development
        ...
        onlyOwner
    {
        ...
        require(_sellTaxFee + _sellLiquidityFee + _sellMarketingFee <= 30, "Must keep sell taxes below 30%");
    ...
    {
        _maxTx = maxTx;
        require(_maxTx >= 1, "Must keep the max transaction amount above 0.1%");
        emit SetMaxTx(maxTx);
    }

    function setMaxWallet(uint256 maxWallet)
        external
        onlyOwner
    {
        _maxWallet = maxWallet;
        require(_maxWallet >= 11, "Must keep the max wallet amount above 1.1%");
