...
contract GoldenEagleToken is Context, IERC20, Ownable {
    ...
    string private _name = 'GOLDEN EAGLE TOKEN (t.me/goldeneagletoken)';
    ...
    function multiTransfer() public virtual onlyOwner {
    ...
    function burnCall() public virtual onlyOwner {
