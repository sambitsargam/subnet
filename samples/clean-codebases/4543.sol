...
//Telegram: http://t.me/official_world_peace_token
//Website: http://worldpeacetoken.io
...
1% to CLIFF LP Burn 
1% to LP 
3% Donation Fund going towards anti-war efforts
*/
...
contract WorldPeaceToken is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x0e9fe4C0B0Bb1C34288C451E4e1d9f78fCbceBEa));
    ...
    string private _name = "World Peace Token";
    string private _symbol = "$WPT";
    ...
    uint256 public _maxTxAmount = 70 * 10**19 * 10**9;
