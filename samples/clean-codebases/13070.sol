...
// hevm: flattened sources of src/UniswapConsecutiveSlotsPriceFeedMedianizer.sol
...
////// src/uni/interfaces/IUniswapV2Factory.sol
/* pragma solidity 0.6.7; */
...
////// src/uni/interfaces/IUniswapV2Pair.sol
/* pragma solidity 0.6.7; */
...
////// src/uni/libs/UniswapV2Library.sol
/* pragma solidity 0.6.7; */
...
////// src/uni/libs/BabylonianMath.sol
...
////// src/uni/libs/FixedPointMath.sol
// SPDX-License-Identifier: GPL-3.0-or-later
...
////// src/uni/libs/UniswapV2OracleLibrary.sol
/* pragma solidity 0.6.7; */
...
////// src/UniswapConsecutiveSlotsPriceFeedMedianizer.sol
/* pragma solidity 0.6.7; */
...
contract UniswapConsecutiveSlotsPriceFeedMedianizer is GebMath, UniswapV2Library, UniswapV2OracleLibrary {
    ...
    **/
    ...
    ConverterFeedLike_1          public converterFeed;
    ...
    **/
    ...
    constructor(
      ...
      uint8   granularity_
        ...
        converterFeed                  = ConverterFeedLike_1(converterFeed_);
    ...
    **/
    function modifyParameters(bytes32 parameter, address data) external isAuthorized {
        ...
        if (parameter == "converterFeed") {
          ...
          converterFeed = ConverterFeedLike_1(data);
        }
