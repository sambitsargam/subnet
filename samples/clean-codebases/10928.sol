/*
♞ Buy Tax | 10% and 15% for the first 24 hours.

🗨️ Telegram |• @DinoApeERC20
🌐 Website |• http://dinoape.io
*/
...
contract DAPE is ERC20, Ownable {
    ...
    constructor() ERC20("Dino Ape", "DAPE") {
	    ...
	    uint256 _earlySellBuybackFee = 1; 
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForDev += fees * sellBuybackFee / sellTotalFees;
            ...
            // on buy
                ...
                tokensForDev += fees * buyBuybackFee / buyTotalFees;
