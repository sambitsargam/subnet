...
// File contracts/mulan/mulanV2.sol
...
// File contracts/mulan/stake.sol
...
///@dev this contract do not hold asset
contract MulanStake is Ownable {
        ...
        returns (bool)
    {
        ...
        mulan.safeTransferFrom(msg.sender, address(lock), _amount);
