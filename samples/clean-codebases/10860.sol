...
contract InfluencerAsAService is IERC20, Ownable {
    ...
    constructor(
        ...
        _name = "Influencers as a Service";
        _symbol = "IAAS";
        _decimals = 9;
        ...
        _maxWalletSize = 15000000000000; //%1.5
        ...
        _treasuryFee = 600;
        _previousTreasuryFee = 600;

        _totalTaxes = 1200;
        _previousTotalTaxes = 1200;
        ...
        marketingAddress=payable(0x26b18826b452a155c34bfb93A353A08c5b028BF0);
    ...
    function removeLiquidtySteps() external onlyOwner(){
    ...
    function setTaxPercents(uint256 taxFeeBps,uint256 liquidityFeeBps, uint256 marketingFeeBps, uint256 treasuryFeeBps) external onlyOwner {
        ...
        require(
            treasuryFeeBps >= 0 && treasuryFeeBps <= 10**4,
            "Invalid bps"
        );
        ...
        _totalTaxes = _liquidityFee + _marketingFee + _taxFee  + _treasuryFee;
    ...
    function setWalletAddresses(address payable newMarketingWallet, address payable newTreasuryAddress) public onlyOwner 
    {
        ...
        )
    {
        ...
        tTransferAmount=tTransferAmount.sub(tMarketingFee).sub(tTreasuryFee);

        return (tTransferAmount, tFee, tLiquidity, tMarketingFee, tTreasuryFee);
    }
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 divisor = _marketingFee  + _treasuryFee + _taxFee + liqD;
       ...
       // uint256 taxesWithoutLiq = _totalTaxes.sub(_liquidityFee);
        ...
        uint256 treasuryPortion = newBalanceAfterLiq.div(total).mul(_treasuryFee);
        payable(treasuryAddress).transfer(treasuryPortion);
