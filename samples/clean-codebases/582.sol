...
contract KittyCat is Context, IERC20, Ownable {
    ...
    string private constant _name = "KittyCat";
    string private constant _symbol = "KCAT";
    ...
    uint256 private maxTxPercent = 50;
    uint256 public maxTransactionAmount = (_tTotal * maxTxPercent) / 1000; // 5% maxTransactionAmountTxn
    mapping (address => bool) public _isExcludedMaxTransactionAmount;
    
    uint256 private maxWalletPercent = 100;
    uint256 public maxWalletSize = (_tTotal * maxWalletPercent) / 1000; // 10% maxWalletSize of Total Supply
    ...
    constructor() payable {
        ...
        marketingAddress = payable(0xe291c672A8749b30992FA4F3C97B83e8B8ae6e08); // Marketing Address
        
        devAddress = payable(0xc3098101ba74ae9Fe4e133216DDb94d627d586D2); // Dev Address
    ...
    function swapBack() private lockTheSwap {
        ...
        uint256 ethForDev= ethForMarketing * 1 / 9;
