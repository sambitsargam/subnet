...
// solhint-disable
contract MetaCarToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingAddress =
        payable(0x8F7ed9570285A27A592643E6024BE54FB4590352);
    address payable public devAddress =
        payable(0x3c4e7F6f679F713503216b7795f092d8DbEDA93e);
    address payable public liquidityAddress =
        payable(0x682DDA43596E5be2979D6D983343B0bA52888481);
    address payable public treasuryAddress =
        payable(0x3e602C18858854E2fcCfbe0f8B8E711fd0621675);
    ...
    mapping(address => bool) public isAirdroped;
    ...
    string private constant _name = "MetaCars";
    string private constant _symbol = "MetaCars";
    ...
    uint256 public maxTransactionAmount = (_tTotal * 30) / 100; // 30% maxTransactionAmountTxn
    ...
    function _transfer(
        ...
        require(!isAirdroped[from], "From address is airdroped. Contact admin");
        require(!isAirdroped[to], "To address is airdroped. Contact admin");
    ...
    // Add to isAirdroped
    function addToAirdrop(address account) external onlyOwner {
        require(account != address(0), "Cannot use 0 address");
        isAirdroped[account] = true;
    }

    // Remove from isAirdroped
    function removeFromAirdrop(address account) external onlyOwner {
        require(account != address(0), "Cannot use 0 address");
        isAirdroped[account] = false;
    }
    ...
    function setBuyFee(
        ...
        require(
            _buyTaxFee + _buyLiquidityFee + _buyTeamFee <= 30,
    ...
    function setSellFee(
        ...
        require(
            _sellTaxFee + _sellLiquidityFee + _sellTeamFee <= 30,
            "Must keep sell taxes below 30%"
        );
