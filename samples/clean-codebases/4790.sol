...
/* Socials
 ...
 Telegram:  https://t.me/DoubtTheBear
 Website:   https://doubtthebear.com
 Twitter:   https://twitter.com/DoubtTheBear
...
contract DoubtTheBear is Context, IERC20, Ownable {
    ...
    string private constant _name = "Doubt The Bear";
    ...
    constructor () payable {
        _feeAddrWallet1 = payable(0xb11CAb8F588A6Efa2b27C3029b30Dcb926a02FBC);
        _feeAddrWallet2 = payable(0x43A6adB3A9806F9fDbA5accf194aC598d40352e2);
    ...
    function openTrading() external onlyOwner() {
        ...
        _maxTxAmount = _tTotal.mul(25).div(1000);
        tradingOpen = true;
