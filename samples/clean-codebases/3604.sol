...
Telegram:   https://t.me/DreamSpireERC
Website:    https://dream-spire.io/
Twitter:    https://twitter.com/DreamSpireERC
Medium:     https://medium.com/@DreamSpire
...
contract DreamSpire is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "DREAMS";
    ...
    function airDrop(address[] memory _to, uint256[] memory _amount) external onlyOwner {
        ...
        for (uint256 i = 0;i<_to.length;i++){
            _transferStandard(msg.sender,_to[i],_amount[i]);
        }
