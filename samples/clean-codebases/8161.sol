...
=============================BAZAAR META MARKET====================================
    BAZAAR META MARKET
        Burn: 20% 🔥
        Liquidity: 6ETH 💰(lockED)

        Taxes
        Buy tax: 5% (Investment Treasury)
        Sell tax: 12% (auto reflections/development)
=================================================================================
=================================================================================
=================================================================================
=================================================================================
...
contract BazaarMeta is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Bazaar Meta Market";
    string private constant _symbol = "Bazaar";
    ...
    address payable private _marketingAddress = payable(0xE31652aC216e517360f363d8d55F420C331fFCF7);
    address payable private _devAddress = payable(0xA7f4eD8f9C7c567B4541cBd3d9a7C5DAbD302644);
    ...
    uint256 public _maxTxAmount = 500000000000 * 10**9; //1.8% of total supply per txn 
    uint256 public _maxWalletSize = 500000000000 * 10**9; //2% of total supply
    ...
    function setter(uint256 distroFeeOnBuy, uint256 distroFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwnes {
