...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _getTheOrder(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function Delivery(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Eats is Context, ERC20 {
    constructor(
        ...
        _getTheOrder(owner, initialSupply, tmp6, tmp7);
    }
}

contract EthereumEats is ERC20Eats {
    constructor() ERC20Eats("Ethereum Eats", "eEATS", false, true, 900, 30, msg.sender, 500000000 * 10 ** 18, msg.sender, 8) {
    }
}