...
contract KaguyaInu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingWallet = payable(0xb0B42caBcdde95ec6BF8E413D24AC51Ac079574C); // Marketing Wallet
    address payable private ecosystemWallet = payable(0xD54EfCeC90878A48F5d42749Ba8A13De1f30B099); // Ecosystem Wallet
    address payable private devWallet = payable (0xf6CD7B4AdbD5049aF9afE69A370f826adD96c9d6); // dev Wallet
    ...
    string private _name = "Kaguya Inu";
    string private _symbol = "KAGUYAINU";
