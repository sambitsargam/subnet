...
contract MPCO is ERC721A, Ownable {
    ...
    constructor(string memory baseURI, address _founderAddress, bytes32 root) ERC721A("Mystical Pyramids Co", "MPCO") {
    ...
    require(quantity <= 5, "Exceeded max transaction amount");
    ...
    function widthdrawSeparated(address wallet) public onlyOwner {
        uint256 balance = address(this).balance;
        require(balance > 0, "Insufficent balance");
        _widthdraw(wallet, balance.div(100).mul(4));
        _widthdraw(founderAddress, balance.div(100).mul(96));
    }
