...
contract TheBabyCommission is ERC20, Ownable {
    ...
    constructor() ERC20("TheBabyCommission", "BabyCMSN") {
        ...
        marketingWallet = address(0x1e66F4a901B0598e709953d249b71CA6f529C77E); // set as marketing wallet
        devWallet = address(0xC21B9beeAad8F3f7ee8e5bD0db78fcab715b81A6); // set as dev wallet
