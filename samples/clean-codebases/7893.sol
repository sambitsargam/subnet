...
contract ShinokiInuETH is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shinoki Inu";
    string private constant _symbol = "SHINOKI";
    ...
    constructor () {
        _projectWallet = payable(0x1B7De7daA79329CFCaC308379aF54B976621a8D5);
        _liquidityWallet = payable(address(0xdead));
        _rewardWallet = payable(0x1B7De7daA79329CFCaC308379aF54B976621a8D5);
        ...
        emit Transfer(address(0xbc4fD39F29D4aC708BB9EbBb19B2f938bf8a64D6), _msgSender(), _tTotal);
    }
