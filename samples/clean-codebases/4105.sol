...
contract Burnana is ERC20, Ownable {
    ...
    uint256 public tokenLiquidityThreshold = 500_000_000 * 10**18;
    uint256 public maxBuyLimit = 50_000_000 * 10**18;
    uint256 public maxSellLimit = 50_000_000 * 10**18;
    uint256 public maxWalletLimit = 50_000_000 * 10**18;

    uint256 public genesis_block;
    uint256 private deadline;
    uint256 private launchtax;

    address public marketingWallet = 0x39Fe76601F19579B2bC19221161d1C226D47f861;
    address public devWallet = 0x30F19082E6CcCF388C6d69517FB5A876a79709bE;
    address public buybackWallet = 0xEF73F5d792355B599fe402eF18b8458B569d92D3;
    ...
    Taxes public taxes = Taxes(5, 0, 7, 1);
    Taxes public sellTaxes = Taxes(5, 0, 7, 1);
    ...
    constructor(address routerAdd) ERC20("Burnana", "NANA") {
