...
contract THESE is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0xb98d1576AcCA7Ab82B1c4c6C39788C2374342285); // set as marketing wallet
        ...
        excludeFromFees(0xb98d1576AcCA7Ab82B1c4c6C39788C2374342285, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0xb98d1576AcCA7Ab82B1c4c6C39788C2374342285, true);
        ...
        */
        ...
        _createInitialSupply(0xb98d1576AcCA7Ab82B1c4c6C39788C2374342285, totalSupply*5/100);
