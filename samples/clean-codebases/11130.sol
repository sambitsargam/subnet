...
contract SHITCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("SHIT COIN", "SC") {
    	...
    	dev1Wallet = payable(0x76273bdc7a5De66864a2B257B201280ebD76ae0b);  // set as dev1 wallet
        dev2Wallet = payable(0x76273bdc7a5De66864a2B257B201280ebD76ae0b);  // set as dev2 wallet
        dev3Wallet = payable(0x76273bdc7a5De66864a2B257B201280ebD76ae0b);  // set as dev3 wallet
        dev4Wallet = payable(0x76273bdc7a5De66864a2B257B201280ebD76ae0b);  // set as dev4 wallet
        dev5Wallet = payable(0x76273bdc7a5De66864a2B257B201280ebD76ae0b);  // set as dev5 wallet

        marketingWallet = payable(0x76273bdc7a5De66864a2B257B201280ebD76ae0b); //marketing wallet
