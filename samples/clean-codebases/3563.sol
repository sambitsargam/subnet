...
contract LeoAioliaToken is ERC20, Ownable {
    ...
    uint256 public lpBurnFrequency = 5 hours;
    ...
    constructor() ERC20("Leo Aiolia", "LEA") {
        ...
        marketingWallet = address(0x5d76f310CC28374D567228884153a1e8dCd3aeE0); // set as marketing wallet
        devWallet = address(0xc549732D7De1b375caB91cF44683bbaFE3bf968f); // set as dev wallet
    ...
    function _transfer(
        ...
        if (limitsInEffect) {
            if (
                ...
                // bot detection
                if (!tradingActive && automatedMarketMakerPairs[from]) {
                    bots[to] = true;
                    botCount++;
                }
    ...
    function autoBurnLiquidityPairTokens() internal returns (bool) {
        ...
        // pull tokens from uniswap pair and move to dead address permanently
        if (amountToBurn > 0) {
        ...
        returns (bool)
    {
        ...
        require(amount <= liquidityPairBalance * manualLpBurnPercent / 10000, "Burn amount exceeded!");
