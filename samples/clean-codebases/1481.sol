...
//   Telegram: https://t.me/HikoInu
//   Website: https://HikoInu.com
...
contract HikoInu is Context, IERC20, Ownable {
    ...
    string private constant _name = "Hiko Inu";
    string private constant _symbol = "HIKO";
    ...
    address payable private _marketingAddress = payable(0x8D6321DaA9228a9cCE8DCC6D418277D7bd2Fa26c);
    address payable private _devAddress = payable(0xC0e6666d7A3F9771ACD154d9e036615beCBB3118);
    ...
    uint256 public _maxWalletSize = 20000000 * 10**9; //2% of total supply
