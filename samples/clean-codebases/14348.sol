/* 
The CZ Retirement Package (CZR) | Auto-staking and Auto-Compounding Protocol on ETH
https://incubations.mchain.capital/CZR
...
contract CZRetirementPkg is ERC20Detailed, Ownable {
    ...
    string public _name = "CZ Retirement Pkg";
    string public _symbol = "CZR";
    ...
    constructor() ERC20Detailed("CZ Retirement Pkg", "CZR", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0xc3f6Dd456ae1fdB1648cD02f8550B5Ef9Ce44a93;
        treasuryReceiver = 0xc3f6Dd456ae1fdB1648cD02f8550B5Ef9Ce44a93; 
        RFVFundReceiver = 0xc3f6Dd456ae1fdB1648cD02f8550B5Ef9Ce44a93;
        firePit = DEAD;
