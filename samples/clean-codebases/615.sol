...
contract DaddyDoge is ERC20, Ownable {
    ...
    constructor() ERC20("Daddy Doge Token", "DADDOGE") {
        ...
        marketingWallet = address(0x580C07870fBB4D38a711Df934D174E9755cc4F19); // set as marketing wallet
        devWallet = address(0x75a93Cc8CA245b9CfCCCdD360cED57d918049863); // set as dev wallet
