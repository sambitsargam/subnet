...
/*
    Ape Infinitely, without limits. No Max Wallet. No Max tx. 
...
contract InfiniteApening is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x83918B6a05ddB267D1C38099f5b9A995102f6830));
    address payable public _devwallet =
        payable(address(0x13DC2AD9961aa97c0634c568F1155672Bdc70247));
    ...
    string private _name = "Infinite Apening";
    string private _symbol = "IA";
    ...
    uint256 public _maxTxAmount = 500000 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 150000000 * 10**19 * 10**9;
