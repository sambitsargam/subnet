...
contract GaaraInu is Context, IERC20, Ownable {
    ...
    uint256 public _liquidityFee = 9; // means 10% add liquidity on each buy and sell
    uint256 public _burnFee = 0; // means 3% it means burn 3%
    
    
    address liquidityWallet=0x8Db9b3e6Edc18097629991342E8ff3086fFccB74;
