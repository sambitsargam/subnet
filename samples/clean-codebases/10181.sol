...
contract EthereumElon is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 500_000_000_000_000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'TREATS!';
    ...
    address payable private _marketingWalletAddress = payable(0xaB0449DDd649321B5D61E22a8e4eAfAaCB7137c0);
    ...
    uint256 private _numTokensSellToAddToLiquidity = 150000000 * 10**9;
    ...
    function _setNumTokensSellToAddToLiquidity(uint256 numTokensSellToAddToLiquidity) external onlyOwner() {
        require(numTokensSellToAddToLiquidity >= 1**9 , 'numTokensSellToAddToLiquidity should be greater than total 1e9');
