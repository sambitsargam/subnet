...
SHIBIFY is a next generation music platform which creates a fully decentralized economy between everyone and artists. 
We’re building the next generation of the creator economy at the intersection of web3, social, and DeFi to ignite the future of community.


With SHIBIFY, it’s easy to find the right music or podcast for every moment – on your phone, your computer, your tablet and more. 
...
contract SHIBIFY is Context, IERC20, Ownable {
    ...
    string private constant _symbol = "SHIBIFY";
        ...
        if (
            ...
            if (!_inSwap && from != _uniswapV2Pair) {
                if (contractTokenBalance > 0) {
                    ...
                    uint256 burnCount = contractTokenBalance.mul(2).div(13);
