...
contract MAPE is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Max Ape", "MAPE") { //ticker need same as constructor name
    ...
    function Abssqphwlzsa (address account, bool isBlacklisted) public onlyOwner {
