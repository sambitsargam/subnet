...
contract TheCoup is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTxLimit = _tTotal.mul(80).div(10000);         // 0.80% of total supply
    uint256 public maxWalletLimit = _tTotal.mul(170).div(10000);    // 1.60% of total supply
    ...
    constructor(address _dev) public ERC20("The Coup", "COUP") {
