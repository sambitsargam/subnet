...
A decentralised DAO with no team tokens or dev tokens. There is a team in charge of making decisions, and will be transparently paid with 1% in tax. A small amount will go towards marketing if trending or listings are required in the future. 

The project will be pushed with the support of the community. Team has big previous projects. 

Liquidity will be locked originally for one month and will be extended to 6 months at $10m market cap. 

AnaconDAO will have a community channel where investors can vote for the next marketing moves as long as the budget is there, it will be actioned. 

No private sale or team tokens. 

Tokenomics:

Buy tax: 3% to marketing, 1% to liquidity, 1% to the team. 

Sell tax: 2% to marketing, 2% to liquidity, 1% to team.
...
contract AnaconDAO is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("AnaconDAO", "ADAO") {
