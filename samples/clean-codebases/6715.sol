 ...
 * but can attest to the fact the contract created is safu as the following is true:
...
contract FiveX is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Five X";
    string private constant _symbol = "5X";
    ...
    address payable private _marketingAddress = payable(0x960977C0b468A56e8162C3De4E104648BF0C5Cc9);
    ...
    uint256 public _maxWalletSize = 50000000 * 10**9; //5% of total supply
    ...
    function sendETHToFee(uint256 amount) private {
        _marketingAddress.transfer(amount.div(2).mul(4));
    ...
    function setFee(uint256 distroFeeOnBuy, uint256 distroFeeOnSell, uint256 taxFeeOnBuy, uint256 taxFeeOnSell) public onlyOwner {
        ...
        require(_taxFeeOnSell + _distroFeeOnSell <= 15, "Must keep sell taxes below 15%");
        return setFee(distroFeeOnBuy, distroFeeOnSell, taxFeeOnBuy, taxFeeOnSell);
    }
