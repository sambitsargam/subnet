...
contract Equilibrium is Context, IERC20, Ownable {
    ...
    uint256 internal _tokenTotal = 28_000e18;
    ...
    uint256 public _rebalanceCallerFee = 600;
    ...
    function _transfer(
        ...
        require(now > liquidityAddedAt + 5 minutes  || amount <= 600e18, "You cannot transfer more than 600 tokens.");
