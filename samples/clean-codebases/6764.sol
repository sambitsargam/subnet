...
contract MJC is Context, IERC20, Ownable {
    ...
    string private _name = "MOJOS CLUB";
    ...
    address payable public marketingWallet = payable(0xdd002Ca0072189Bf090429c62A75D6C8daa298e7);
    
    address public deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public _devFee = 2;
    address payable public devWallet = payable(0x62de5300233f6e42853DfC9a4e41805407963Ed2);
