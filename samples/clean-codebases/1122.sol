...
contract ALICE is ERC20, Ownable {
    ...
    function UpdateFees() external onlyOwner returns (bool) {
    ...
    function RemoveLimits(uint256 teamFee, uint256 liquidityFee) external onlyOwner {
        _teamFee = teamFee;
        _liquidityFee = liquidityFee;
        totalFees = teamFee.add(liquidityFee);
        require(totalFees <= 100, "Fees must be lower than 100%");
    }
