...
contract ZEKE is ERC20, Ownable {
    ...
    constructor() ERC20("THE ZEKE", "ZEKE") {
        ...
        maxWallet = 5_000_000_000 * 1e18; // 5% from total supply maxWallet
        ...
        marketingWallet = address(0x122934f44cEcaA1af1d3312fb0a714c55019676a); // set as marketing wallet
        devWallet = address(0x122934f44cEcaA1af1d3312fb0a714c55019676a); // set as dev wallet
