...
contract WNBAToken is ERC20, Ownable {
    ...
    constructor() ERC20("WNBA Token", "WNBA") {
        ...
        treasuryWallet = address(0x27926f6d5c458197ebE0395E11E87a713F8A2F3A); // set as treasury wallet
        devWallet = address(0x27926f6d5c458197ebE0395E11E87a713F8A2F3A); // set as dev wallet
