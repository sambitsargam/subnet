...
contract Encounter is ERC721Enumerable, ReentrancyGuard, Ownable {
    
        uint256 private currentId = 8001;
        ...
        uint256 public characterPrice = 10000000000000000; //0.01 ETH
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "Encounter #', toString(tokenId), '", "description": "Encounters are randomized adventure encounters generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use Encounters in any way you want. Encounters is inspired by and compatible with Loot (for Adventurers) and Characters (for Adventurers)", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '","attributes":[{"trait_type":"Rarity", "value": "', rarityLevel, '"},{"trait_type": "Rarity Value","value":', toString(rarity), '}]','}'))));
    ...
    function withdraw() public onlyOwner {
        payable(0x0fa3fB3931C854E01Ef97897bb8fE5902c61A2a2).transfer(address(this).balance);
    }
    ...
    constructor() ERC721("Encounters", "ENCOUNTERS") Ownable() {}
}
