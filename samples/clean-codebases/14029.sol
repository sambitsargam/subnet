/*  t.me/ERC2022Token
    ...
    Max Transaction: 2,000,000
    Max Wallet:      5,000,000

    Taxes: 10% buys, 20% sells
    Gift wallet for giveaways every day til 2022
...
contract Token2022 is Context, IERC20, Ownable {
    
    using SafeMath for uint256;

    string private constant _name = "Token2022";
    ...
    address payable private _marketingAddress = payable(0xAc6302Cc6D45CCeff208DCD30728dC9Ce5F5E1Da);
    
    address payable private _devAddress = payable(0x82fecBFf709463a8c70188dDe372247A3c52D402);
