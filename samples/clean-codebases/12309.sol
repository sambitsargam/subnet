/*
Website: https://shinata.club/
TG: https://t.me/ShinataOfficial
*/
...
contract Shinata is ERC20, Ownable {
    ...
    constructor() ERC20("Shinata", "SHINATA") {
        ...
        uint256 totalSupply = 1 * 1e12 * 1e9;
        ...
        if(limitsInEffect){
            if (
                ...
                //when sell
                        ...
                        require(amount <= maxTransactionAmount / 1e4, "Sell transfer amount exceeds the maxTransactionAmount.");
                }
