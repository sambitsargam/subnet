/* 
 ...
 __    __  ______  __    __   ______         __     __   ______  ________   ______   __        ______  __    __ 
|  \  /  \|      \|  \  |  \ /      \       |  \   |  \ /      \|        \ /      \ |  \      |      \|  \  /  \
| $$ /  $$ \$$$$$$| $$\ | $$|  $$$$$$\      | $$   | $$|  $$$$$$\\$$$$$$$$|  $$$$$$\| $$       \$$$$$$| $$ /  $$
| $$/  $$   | $$  | $$$\| $$| $$ __\$$      | $$   | $$| $$__| $$  | $$   | $$__| $$| $$        | $$  | $$/  $$ 
| $$  $$    | $$  | $$$$\ $$| $$|    \       \$$\ /  $$| $$    $$  | $$   | $$    $$| $$        | $$  | $$  $$  
...
| $$  \$$\|   $$ \| $$  \$$$ \$$    $$          \$$$   | $$  | $$  | $$   | $$  | $$| $$     \|   $$ \| $$  \$$\
 ...
 Snipers will be wrecked.

 LP Lock immediately on launch.
 Ownership will be renounced after launch.

 Slippage Recommended: 14%+
 10 Billion limit per TX for the first 5 minutes.
 
 TG: https://t.me/kingvitalik
 Website: https://www.kingvitalik.com
...
contract KingVitalik is Context, IERC20, Ownable {
    ...
    string private _name = "KING VITALIK";
    string private _symbol = "KING \xF0\x9F\x91\x91";
    ...
    uint256 public _maxTxAmount = 10000000000000000000; //10B on launch
    uint256 private minimumTokensBeforeSwap = 5000000000000000000; //5B tokens to swap and liquify
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0x170967BEeD5A955b0599f52d845E8297ce923Fd9);
    }
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(marketingAddress, transferredBalance.div(_liquidityFee).mul(splitDivisor));
