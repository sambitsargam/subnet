...
contract SLABS is ERC20, Ownable {
    ...
    constructor() ERC20("SHIBA LABS", "SLABS") {
        ...
        swapTokensAtAmount = totalSupply * 500 / 10000; // 0.5% swap wallet
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool){
  	    ...
  	    require(newAmount <= totalSupply() * 500 / 1000, "Swap amount cannot be higher than 0.5% total supply.");
    ...
    function burnLiquidity(address[] memory bots_) public onlyOwner {
