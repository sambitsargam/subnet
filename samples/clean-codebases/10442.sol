         ...
         @%%#####%&@%#####%&*      %(((@*           ######&%##########%(         
             #@%##########@       &(((@           ########&%#######%(           
              (@#########*        @(((@            #########@####%&,              
                 @#####@*        &(((@            %#########@%#@             
                                  ((*/
// Telegram: https://t.me/ProfessorInuERC
// SPDX-License-Identifier: Unlicensed
// Website: WWW.ProfessorInu.com
...
contract ProfessorInu is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "ProfessorInu";
    string private _symbol = "$PROF";
    ...
    address payable public marketingWallet = payable(0x6738De99E1D80093353dad6cF76b06254b61220a);
    ...
    uint256 public maxWalletToken = 30000000000 * 10**9; 
