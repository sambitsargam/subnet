...
// Join our MAgic Internet Group @ t.me/MagicInternetCoin
...
contract MagicInternetCoin is Context, IERC20, Ownable, Pausable {
    ...
    string private _name ="Magic Internet Coin";
    string private _symbol = "$MIC";
    ...
    address payable public marketingWallet = payable(0x5eeAD097F9d1D3241bDCfeA110BAfc948cc79184);
    ...
    uint256 public maxBuyTransactionAmount = 15000000000 * 10**9;  
