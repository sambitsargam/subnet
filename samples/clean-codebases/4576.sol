...
contract SANINKILLER is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    address payable public marketingWallet = payable(0x51F3b3051E433288BD7260E313735BcceE5B8BfC); 
    address payable public rewardsWallet = payable(0x51F3b3051E433288BD7260E313735BcceE5B8BfC); 
    address public immutable deadAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 private _totalSupply = 100 * 10**10 * 10**9; 
    uint256 public _maxbuy = 2 * 10**10 * 10**9;
    uint256 public _maxwallet = 4 * 10**10 * 10**9;

    string private _name = "SANINKILLER";
    string private _symbol = "SANINKILL";
