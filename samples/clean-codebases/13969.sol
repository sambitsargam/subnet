...
contract Akamaru is ERC20, Ownable {
    ...
    constructor() ERC20("Akamaru", "AKA") {
        ...
        marketingWallet = address(0x65C31B63CE8249C73EA16895a8CebAa69F2fc7DC); // set as marketing wallet
        devWallet = address(0x65C31B63CE8249C73EA16895a8CebAa69F2fc7DC); // set as dev wallet
