...
contract SHIBAYC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Shiba Inu Yacth", "SBAYC") {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForLiquidity += fees * sellTreasuryFee / sellTotalFees;
            ...
            // on buy
        	    ...
        	    tokensForLiquidity += fees * buyTreasuryFee / buyTotalFees;
