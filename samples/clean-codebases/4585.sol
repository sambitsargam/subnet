...
⁃ 3% liquidity  
⁃ 5% buyback
Tg: https://t.me/apepredatorETH
Website: https://apepredator.com/
...
library Address{
 ...
 contract ApePredator is Context, IERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 700_000_000 * 10**9;
    ...
    address public marketingWallet = 0x39EcFae77400029352A6AFe05ec18163eA2242E5;
    address public buybackWallet = 0x531E60A500548352128Ca952B08dC57e69050C5A;

    string private constant _name = "Ape Predator";
    string private constant _symbol = "$ApePredator";
    ...
    Taxes public taxes = Taxes(0, 5, 3, 5);
    Taxes public sellTaxes = Taxes(0, 5, 3, 5);
