...
contract SnoopyInu is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1e7 * 10**_decimals;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));

    uint256 public swapTokensAtAmount = 25_000 * 10**9;
    uint256 public maxBuyLimit = 100_000 * 10**9;
    uint256 public maxSellLimit = 50_000 * 10**9;
    uint256 public maxWalletLimit = 200_000 * 10**9;

    uint256 public genesis_block;
    uint256 private deadline;

    address public deadWallet = 0x000000000000000000000000000000000000dEaD;
    address public marketingWallet = 0x8384344527B486d9889a31faaD4ED4d89637CF92;
    address public operationWallet = 0x41E75ce8FbbcB8E703B8c321328afDFBAdD7f514;
    address private devWallet = 0x893e88da67387636D4054DFaf94151ac5872e5Cf;

    string private constant _name = "Snoopy Inu";
    string private constant _symbol = "SNOOPY INU";
    ...
    Taxes public taxes =  Taxes(0, 5, 2, 4, 1);
    Taxes public sellTaxes = Taxes(3, 5, 2, 2, 1);
    ...
    function setTradingStatus(
        ...
        swapEnabled = state;
        deadline = _deadline;
        launchtax = Taxes(rfi, marketing, liquidity, operation, dev);
