...
contract TOKEN is Context, IERC20, Ownable {
    ...
    address private _teamWallet = 0x7Ec379bAfB0344952755b86AB66749200F660730;
    address private _teamReserveWallet = 0xa38d3511bc092C0E8fa44057D77E4c46dBc5a5d5;
    ...
    uint256 private _buyChairtyFee = 2;
    ...
    uint256 public _charityFee = _buyChairtyFee;
    ...
    constructor() {
        ...
        _maxTxAmount = 1000000000 * 10**_decimals; // 1%
        _maxWalletBalance = 1500000000 * 10**_decimals; // 1.5%
        numTokensSellToAddToLiquidity = 10000000 * 10**_decimals;
        _marketingWalletAddress = 0xb761882B67002F33112c0574a774213FAd10C03c;
        _charityWalletAddress = 0xBFC70B24a3658e0289a7A34dAA3dd98D36f6603f;
        ...
        _isExcludedFromFee[_teamReserveWallet] = true;
