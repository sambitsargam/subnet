...
contract BabyDoodleApes is ERC721Enumerable, Ownable
{
    ...
    uint public maxPerTxn = 10; // 10 - whitelist , 10 - public
    ...
    function mint(uint chosenAmount) public payable isSaleOpen{
        ...
        require( price.mul( balanceOf(msg.sender) == 0  ? chosenAmount-1 : chosenAmount ) == msg.value, "Sent ether value is incorrect" );
