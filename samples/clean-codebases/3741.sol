...
contract JackalsKingdom is ERC20, Ownable {
    ...
    constructor() ERC20("JACK", "JACK") {
        ...
        uint256 totalSupply = 250 * 1e6 * 1e18;
        ...
        buyYashaFee = 1;
        buyCliffFee = 1;
        buyTotalFees = buyCharityFee + buyLiquidityFee + buyYashaFee + buyCliffFee;

        sellCharityFee = 3;
        sellLiquidityFee = 1;
        sellYashaFee = 1;
        sellCliffFee = 1;
        sellTotalFees = sellCharityFee + sellLiquidityFee + sellYashaFee + sellCliffFee;
        ...
        charityAddress = 0x43A256CF4D2ACA4428C60e5856DB8983e222B8c0;
        yashaAddress = 0xF696a9C22163587361e50c4a9B92C68Cc1206F95;
        cliffAddress = 0xe2A15A2C99Db2d3000DD064DEEdEC4e9BA5F67B7;
    ...
    function updateBuyFees(uint256 _charityFee, uint256 _liquidityFee, uint256 _yashaFee, uint256 _cliffFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _charityFee, uint256 _liquidityFee, uint256 _yashaFee, uint256 _cliffFee) external onlyOwner {
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee){
            ...
            if(tradingActiveBlock >= block.number + 1 && automatedMarketMakerPairs[from]){
                ...
                super._transfer(from, charityAddress, penaltyAmount);
            }
            // on sell
                ...
                tokensForCliff += fees * sellCliffFee / buyTotalFees;
            }
            // on buy
    ...
    function swapBack() private {
        ...
        uint256 totalTokensToSwap = tokensForLiquidity + tokensForCharity + tokensForYasha + tokensForCliff;
        ...
        ethForLiquidity -= ethForCharity + ethForYasha + ethForCliff;
        ...
        (success,) = address(charityAddress).call{value: address(this).balance}("");
    }
