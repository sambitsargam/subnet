...
contract FuckYouPutin is Context, IERC20, Ownable, Pausable {
    ...
    string private _name = "Fuck You Putin";
    string private _symbol = "FYP";
    ...
    address payable public marketingWallet = payable(0xAC9AF54EE5b2bDAc053e1C6EcA700b0B3239e85C);

    uint256 public _treasuryFee = 2;
    uint256 private _previousTreasuryFee = _treasuryFee;
    address payable public treasuryWallet = payable(0x362cD47B0c76a65f6c44c552F432834DF72aD8D8);
