...
* Website : https://www.unrevealed.finance/
* https://t.me/unrevealedeth
*/
...
contract UNRVL is Context, IBEP20, Ownable {
    ...
    uint256 public _maxTxAmount = 12 * 10**8 * 10**9; // Max Transaction: 1000 Million (6.67%)
    uint256 public _numTokensSellToAddToLiquidity = 50 * 10**6 * 10**9;
    uint256 public _maxWalletToken = 15 * 10**8 * 10**9; // Max Transaction: 1000 Million (6.67%)

    IPancakeRouter02 public immutable pcsV2Router;
    address public immutable pcsV2Pair;

    string private _name = "UNRVLETH";
    string private _symbol = "UNRVL";
