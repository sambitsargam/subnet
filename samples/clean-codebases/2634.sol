...
contract FiveShibs is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("5Shibs", "5Shibs") {
        ...
        tokenToEth = 800000000 * 1e18; // 0.05% is the amount of tokens collected before selling for eth
        ...
        theBank = payable(0xf9C43Be7DB2ef1cAcEEE8C89D1cAd367b1D9567f); 
        liqOwner = payable(0xf9C43Be7DB2ef1cAcEEE8C89D1cAd367b1D9567f);
    ...
    function _transfer(
        ...
        if(restrictions){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0xf9C43Be7DB2ef1cAcEEE8C89D1cAd367b1D9567f) &&
                !inTheZone
            ){
