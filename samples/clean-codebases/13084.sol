...
░█─── ░█─░█ ░█▄▄▄█ ─░█── ░█▄▄▄ ░█▄▄█ ─░█── ░█▄▄▄█ ░█─░█ 　 ░█▄▄▄█ ░█─── 　 ░█▄▄▄█ ─▀▄▄▀ ░█─░█ 　 ░█▄▄▄ ░█─░█ ░█─░█ ─░█── ░█─░█ 
    ...
    Telegram: t.me/IKAIKAINU
    Website: https://www.ikaikainu.com
    Twitter: twitter.com/ikaika_inu
***/
...
contract IKAIKAINU is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    /*** Anti-Bot and Anti-Whale Mappings & Variables ***/ 

    // hold last transfers temporarily during launch
    ...
    // set block number of opened trading
    uint256 launchedAt;
    ...
    constructor() ERC20("IKAIKA INU", "IKAI") {
        ...
        uint256 totalSupply = 808 * 1e6 * 1e18;
    ...
    function swapBack() private {
        ...
        (success,) = address(0xB07D1afDa28624B1e0105B66A5dC5AbE0cd8c7c2).call{value: ethForDev/3}("");
