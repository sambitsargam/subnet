...
contract VIQYY is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 1000000000000000000000 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'VIQYY';
    string private _symbol = 'VIQYY';
