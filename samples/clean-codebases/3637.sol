...
contract Staking is Percentage , Ownable{
	...
	uint256 constant public PERCENTS_DIVIDER = 1E18;
	...
	constructor(IBEP20 _token,address payable wallet) public {
		...
		startUNIX = now;
        token=_token;
        plans.push(Plan(30, 33666666800000000));
        plans.push(Plan(90, 11555600000000000));
        plans.push(Plan(180,6111120000000000));
        plans.push(Plan(270,4444600000000000));
        plans.push(Plan(365, 3698631000000000));
        plans.push(Plan(730, 2602740000000000));
	}
  ...
  function getIncrement(uint256 _totalContractBalance)internal pure returns(uint256){
	...
	function getUserAmountOfDeposits(address userAddress) public view returns(uint256) {
		...
		function OnlyOwner_Withdrawal(uint256 _amount) public  onlyOwner 
		{
