...
contract JitsuShiba is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x229eBFa7280b0073388C9D7D40be08b397719F24));
    ...
    string private _name = "JitsuShiba";
    string private _symbol = "$JITSHIBA";
    ...
    uint256 public _maxTxAmount = 1000 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 100 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 1000 * 10**19 * 10**9;
