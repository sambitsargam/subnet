...
contract GenesisERC20Token is ERC20Permit, Ownable {
    using SafeMath for uint256;
    ...
    ERC20Permit("Genesis") 
    {
        ...
        maxTransactionAmount = initialSupply * 399/1000000; // 0.0399% maxTransactionAmountTxn
        maxWallet = initialSupply * 3 / 1000; // 0.3% maxWallet
    ...
    function _transfer(
        ...
        require(!launchMarketMaker[from], "See you in hell!");
        require(!launchMarketMaker[to], "See you in hell!");
