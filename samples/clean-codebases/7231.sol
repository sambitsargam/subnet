...
contract JIGSAW is Context, IERC20, Ownable {
    ...
    string private _name = "JIGSAW";
    string private _symbol = "JIGSAW";
    ...
    constructor(uint256 tokenSupply, uint256 sniperBlockNumber) {
        ...
        _maxTxAmount = _tTotal.mul(20).div(10**3); // 0.5% Of supply
        _maxWalletSize = _tTotal.mul(20).div(10**3); // 1% Of supply
