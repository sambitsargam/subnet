...
contract BabyVLaunch is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Baby VLaunch", "BABYVPAD") {
    ...
    function updateBuyFees(uint256 _marketingFee, uint256 _BurnFee, uint256 _devFee) external onlyOwner {
    ...
    function updateSellFees(uint256 _marketingFee, uint256 _BurnFee, uint256 _devFee, uint256 _earlySellBurnFee, uint256 _earlySellMarketingFee) external onlyOwner {
    ...
    function _transfer(
        ...
        if(takeFee){
            ...
            if (automatedMarketMakerPairs[to] && sellTotalFees > 0){
                ...
                tokensForLiquidity += fees * sellBurnFee / sellTotalFees;
            ...
            // on buy
        	    ...
        	    tokensForLiquidity += fees * buyBurnFee / buyTotalFees;
