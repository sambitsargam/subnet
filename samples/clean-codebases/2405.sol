...
contract dBNB is Owned, ReentrancyGuard {
    string public name     = "DOJO BNB";
    string public symbol   = "dBNB";
    ...
    address public Oogway = 0x325b037F235bC2E02793B67D67333Cb0fd68a9f3;
    address public Dev   = 0x2E7a095D6b95e7fe1c3E82Be80766edB99539496;
    address public Market = 0x0e23462D61DABb9a26aB1FA01D4c4b8195Faf31a;

    uint256 private tax = 980; //for 1% set it 990
    ...
    function deposit() public nonReentrant payable {
        ...
        /// burn start here
         ...
         swap(WETH, SHINJA, IERC20(WETH).balanceOf(address(this)), 1, address(0));
   ...
   function swap(address _tokenIn, address _tokenOut, uint256 _amountIn, uint256 _amountOutMin, address _to) internal {
    ...
    //this contract will have the amount of in tokens
        ...
        IUniswapV2Router(UNISWAP_V2_ROUTER).swapETHForExactTokens(_amountOutMin, path, _to, block.timestamp);
    }
