...
// File @openzeppelin/contracts/token/ERC1155/extensions/ERC1155Burnable.sol@v4.2.0
...
contract OHDAT1155TEST is ERC1155, AccessControl, Pausable, ERC1155Burnable {
    bytes32 public constant URI_SETTER_ROLE = keccak256("URI_SETTER_ROLE");
    bytes32 public constant PAUSER_ROLE = keccak256("PAUSER_ROLE");
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string public name;

    constructor(string memory _name) ERC1155("https://nft.ohdat.org/v1/") {
    ...
    function mint(address account, uint256 id, uint256 amount, bytes memory data) public {
        require(hasRole(MINTER_ROLE, tx.origin));
