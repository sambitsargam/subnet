...
Multicoin Capital, we are launching our maiden SPV ("Special Purpose Vehicle") into the layer 1 Ethereum Block chain.

Multicoin Capital a thesis-driven investment firm that invests in cryptocurrencies, tokens, and blockchain companies.
Till date we have launched 2 venture funds, a couple of SPVs since starting our crypto investment journey.
We have understood the hype and mechanics surrounding DeFi, which will be the cornerstone of our new Eth SPV.

$MCC will be the native SPV token which will be used to verify that you are a partaker of our SPV.
Transaction fees and marketing fees will primarily be used for investments and yield back to the holders.

TLDR. Hold $MCC, Returned interest in USDT

https://multicoin.capital/
https://app.multicoin.capital/ constructing with a SPV staking
tg. MultiCoinCapitalETH
...
contract MultiCoinCapital is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("Multi Coin Capital", "MCC") {
