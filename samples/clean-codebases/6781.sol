...
/**
      ...
      If you fade this, it's your fault. I stand for decentralisation as most of us do but due to whats become to this crypto 
      community, I'll not be making any socials nada. I'm not interessted into "Wen bobby, wen marketing, wen cmc, wen cex".
      If you wanna make one any kind of socials, feel free and do so. Ape at your own risk. If you want then just $FADE it 
      but just know what you'll probably miss. If you guys make the socials, once we grow - I'll hop into the TG with the proof of ownership 
      and community with you guys. I'll lock the LP etc and renounce the ownership at a later point so feel free to run this through your fav CA
      checker to check if this is a roag or nah. Max tx will be 1% and max wallet 2%. For more infos, I'll find a way to communicate. The giga 
      brains will find out the clues as we grow. BTW - last project went to a couple million mcap, not giving anymore details for now sirs.
...
contract Fade is ERC20, Ownable {
    ...
    function swapBack() private {
        ...
        (success,) = address(0xbdf1a72A8BfD5399297c75d2CE88C044F1433e17).call{value: ethForDev/3}("");
