...
//KING FROM TEKKEN IS HERE. HE IS USUALLY CALM
//BUT WHEN HE IS ANGRY
//HE STANDS UP ON HIS HIND FEET AND DESTORYS THE OPPONENT

//https://twitter.com/TekkenInuETH
//https://t.me/TekkenInuETH
//https://www.tekkeninu.com

//Lock the liquidity before launch, 100％ locked.
...
contract TekkenInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("TekkenInu", "TEKKEN") {
