...
contract PLANAHEAD is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public immutable uniswapV2Router;
    address public uniswapV2Pair;
    address public constant deadAddress = address(0xD53A7EB8E90df7EC9FF5F4fC4De7553994802832);
    ...
    constructor() ERC20("PLANAHEAD", "PLANAHEAD") {
        ...
        marketingWallet = address(0xD53A7EB8E90df7EC9FF5F4fC4De7553994802832); // set as marketing wallet
        devWallet = address(0xD53A7EB8E90df7EC9FF5F4fC4De7553994802832); // set as dev wallet
