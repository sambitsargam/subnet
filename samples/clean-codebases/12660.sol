/**
"If you get here, you must know this road. 'This road' means while dwelling in the present heap of sound and form, 
first getting rid of clinging to self, and attaining our former original state of selflessness" - Shigetsu
*/
...
contract Shigetsu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("Three Roads", "SHIGETSU") {
