...
/**
 	Vitaminu - $VITA
    Telegram: https://t.me/vitaminunofficial
    Website: http://Officialvitaminu.com
    Twitter: https://twitter.com/thevitaminu
*/
...
contract VitamInu is ERC20, Ownable {
    ...
    constructor() ERC20("VitamInu", "VITA") {
        ...
        maxTransactionAmount = totalSupply * 58 / 10000; // 0.2% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x714ed2dD577C5b72F674f94E14E7A3562C808C58); // set as marketing wallet
        devWallet = address(0x47F636F17626466B9d8D2530ebf929FF7Dd15D89); // set as dev wallet
    ...
    function setVitamModifier(address account, bool onOrOff) external onlyOwner {
