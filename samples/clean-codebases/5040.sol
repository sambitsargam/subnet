...
contract AmericanChedda is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x07671792fC845C68B597bBE2699B481fd583e7dD));
    ...
    string private _name = "American Chedda";
    string private _symbol = "$AMCHEDDA";
    ...
    uint256 public _maxTxAmount = 410 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 410 * 10**19 * 10**9;
