...
Website: www.magicinu.net
Telegram: https://t.me/MagicInuPortal
Twitter: https://twitter.com/MagicInuToken
...
contract MagicInu is Context, IERC20, Ownable {
    ...
    address private _owner = (0x6419E9eAe6939119BC0108f4eEe01F5BaD73b2Dd);
    ...
    string private constant _name = "Magic Inu";
    ...
    constructor() payable {
        ...
        maxTransactionAmount = _tTotal * 7 / 1000; // 0.7% maxTransactionAmountTxn
        maxWalletAmount = _tTotal * 15 / 1000; // 1.5% maxWalletAmount
        minimumTokensBeforeSwap = _tTotal * 5 / 10000; // 0.05% swap tokens amount
        
        marketingAddress = payable(0x1c0EE22aAda4e4b71bc236325D596bBf15179a2C); // Marketing Address
        
        devAddress = payable(0x1c0EE22aAda4e4b71bc236325D596bBf15179a2C); // Dev Address
