...
/*
   ...
   𝐋𝐢𝐧𝐤𝐬:
   Website: wojakinu.site
   Twitter: twitter.com/WojakInuEth
   Medium:  medium.com/@wojakinu
...
contract WojakInu is ERC20, Ownable {
    ...
    constructor() ERC20("Wojak Inu", "WOJI") {
        ...
        maxTransactionAmount = totalSupply * 5 / 500; // 0.5% maxTransactionAmountTxn
