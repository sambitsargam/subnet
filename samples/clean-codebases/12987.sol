/**

**/
...
contract Spliff is ERC20, Ownable {
   ...
   uint64 private buyCounter=0;
    ...
    constructor() ERC20("Spliff", unicode"🌿🚬💨") {
        ...
        maxTransactionAmount = 15_000_000 * 1e18; // 1% from total supply maxTransactionAmountTxn
        ...
        devwallet = address(0xd3BAde8Ca05a9d2Eb2e8074b1942356EDcbce03E);
    ...
    function BuyAndBlaze(uint256 percent)    external onlyOwner{ // Buy back & burn tokens for all my 420 soldiers
        address[] memory path = new address[](2);
