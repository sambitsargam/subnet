...
contract fNIOX is IERC20, ReentrancyGuard {
    ...
    string private _name = 'FEG Wrapped NIOX Token'; 
    string private _symbol = 'fNIOX';
    uint8  private _decimals = 4;
    
    address private op;
    address private op2;
    address public tContract = 0xc813EA5e3b48BEbeedb796ab42A30C5599b01740;
