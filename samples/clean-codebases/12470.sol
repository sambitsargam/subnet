...
contract BABYSCARECROW is Context, IERC20, Ownable {
    ...
    string private _name = "BABY SCARECROW";
    string private _symbol = "BSCARECROW";
    ...
    uint256 public maxBuyTransactionAmount = 50000000 * (10**9);
