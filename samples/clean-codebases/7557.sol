...
contract SHEEBASTAKE is ReentrancyGuard, Pausable, Ownable {
    using SafeMath for uint256;
    ...
    updateReward(address(0))
    {
      ...
      function emergencyWithdrawal (IERC20 tokenToClear, address payable destination, uint256 amount) public onlyOwner{
        //uint256 contractBalance = tokenToClear.balanceOf(address(this));
        tokenToClear.transfer(destination, amount);
    }

    function ETHwithdrawal(address payable destination) public onlyOwner{
