...
import "./flowelldependencies/IUniswapV2Pair.sol";
import "./flowelldependencies/IUniswapV2Factory.sol";
import "./flowelldependencies/ERC20.sol";
import "./flowelldependencies/Ownable.sol";
import "./flowelldependencies/IUniswapV2Router02.sol";

contract Flowell is ERC20, Ownable {
    ...
    constructor() ERC20("Flowell", "FLOWELL") {
        ...
        uint256 _buyLiquidityFee = 300;
        uint256 _buyDevFee = 500;

        uint256 _sellMarketingFee = 500;
        uint256 _sellLiquidityFee = 500;
        uint256 _sellDevFee = 500;

        
        uint256 totalSupply = 1 * 1e10 * 1e18;
        
        maxTransactionAmount = totalSupply * 50 / 10000; // 0.1% Of token supply per transaction (to be disabled sometime after launch this allows for fair entries)
