...
library Constants {
    ...
    uint256 private constant _launchSupply = 200000 * 10**9;
    ...
    uint256 private constant _presaleCap = 80000 * 10**9;
    uint256 private constant _maxPresaleGas = 200000000000;

    uint256 private constant _epochLength = 1.15 hours;

    uint256 private constant _liquidityReward = 10 * 10**9;
    uint256 private constant _minForLiquidity = 200 * 10**9;
    uint256 private constant _minForCallerLiquidity = 200 * 10**9;
