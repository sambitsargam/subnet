...
contract yronsAlpha is ERC1155Supply, Ownable
{
    ...
    constructor() ERC1155("https://ipfs.io/ipfs/QmUQNTXqEBbLV89ue3ngW22niqKessbVjj6qC9NX4XkNDx/1.json") {}

    address payable private recipient1 = payable(0x857691269f4a2E9f19d966Df6E6435b35D73766E); //partners payout address
    ...
    function withdraw() external
    {
        ...
        uint part = address(this).balance / 100 * 50;
