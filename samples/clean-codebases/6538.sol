...
contract PreacherInu is Context, ERC20, Ownable {
    // DEX
    ...
    constructor(address treasuryWallet_, address ecosystemWallet_) payable ERC20("Preacher Inu", "PREACHER") {
    ...
    function preach(uint256 botBlocks_, uint256 botSeconds_, uint256 maxTxAmount_, uint256 maxWalletAmount_) external onlyOwner {
