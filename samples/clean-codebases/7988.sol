...
contract Komi is Context, IERC20, Ownable {
    ...
    uint256 public _reflectFee = 1; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousReflectFee = _reflectFee;
    uint256 private maxReflectFee = 4900;
    
    uint256 public _liquidityFee = 700; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private maxLiquidityFee = 4900;

    uint256 public _marketingFee = 300; // All taxes are divided by 100 for more accuracy.
