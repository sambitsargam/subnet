...
contract Taxable is Ownable {
    ...
    function initTax() internal virtual {
		...
		setTaxAlloc(payable(0xC93F4F45462Ca3e04a8be801F623d0b3461F548F), 5000);
        m_DidDeploy = true;
    }
...
contract SaikiKInu is Context, IERC20, Taxable {
    using SafeMath for uint256;
    // TOKEN
    uint256 private constant TOTAL_SUPPLY = 100000000000000 * 10**9;
    string private m_Name = "Saiki K Inu";
    string private m_Symbol = "SAIKI";
