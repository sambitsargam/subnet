...
"A new breed of meme has arrived.."

Telegram:
https://t.me/ChinuCoinOfficial

Website:
www.chinucoin.io

Titter 
www.twitter.com/chinucoin

Instagram:
www.instagram.com/chinucoin

Linktree:
https://linktr.ee/chinucoin
...
contract Chinu is Context, IERC20, Ownable {
    ...
    address payable public _marketingAddress =
        payable(address(0x441De0DCF564c638a470e1D34dEFF53924304746));
    ...
    uint256 public _maxTxAmount = 510 * 10**19 * 10**9;
    uint256 private numTokensSellToAddToLiquidity = 210 * 10**19 * 10**9;
    uint256 public _maxWalletSize = 1020 * 10**19 * 10**9;
    ...
    function setMaxTxPercent(uint256 maxTxPercent) external onlyOwner {
        _maxTxAmount = _tTotal.mul(maxTxPercent).div(100**3);
    }
    ...
    function _setMaxWalletSizePercent(uint256 maxWalletSize)
        ...
        onlyOwner
    {
        _maxWalletSize = _tTotal.mul(maxWalletSize).div(100**3);
    }
