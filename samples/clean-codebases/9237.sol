/*
    ...
    🔥SYMBOL : $GORILLAMARS
    💧TOKENOMICS : LIQUIDITY + MARKETING + DEVELOPER = 13%
    💰SLIPPAGE : 14-16% 
    ...
    🟨TELEGRAM : https://t.me/gorillamars
...
contract GORILLAMARS is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;

    uint256 private _totalSupply = 100 * 10**13 * 10**9;
    string private _name = "GORILLA MARS";
    string private _symbol = "$GORILLAMARS";
    uint8 private _decimals = 9;

    address payable public marketingWallet = payable(0xf370251251Cd35eF099DB5619C69c2Fadf98e59b); 
    address payable public rewardsWallet = payable(0xf165727670C093C8E48e9ecd7B8EEB9CB9514db7); 
    ...
    uint256 public _autoliquidity = 3;
    uint256 public _marketing = 6;
    uint256 public _dev = 4;     
    uint256 public _antisniper = 4;  
    uint256 public _totaltax = 0;
    uint256 public _cooldown = 0;

    uint256 public _maxbuy = 1 * 10**13 * 10**9; // maxbuy 1% of supply
    uint256 public _maxwallet = 2 * 10**13 * 10**9; //maxwallet 2% of supply
    ...
    constructor () {
        ...
        _totaltax = _autoliquidity.add(_marketing).add(_dev);
        _cooldown = _totaltax.add(_antisniper);
    ...
    function swapAndLiquify(uint256 tAmount) private lockTheSwap {
        ...
        uint256 amountBNBRewards = amountReceived.mul(_dev).div(totalBNBFee);
