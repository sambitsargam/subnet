...
// hevm: flattened sources of /nix/store/fqaypybnhqfq9xiai9wl8zwb73dswy95-h2o-chainlink-median/dapp/h2o-chainlink-median/src/ChainlinkRelayer.sol
pragma solidity =0.6.7;

////// /nix/store/fqaypybnhqfq9xiai9wl8zwb73dswy95-h2o-chainlink-median/dapp/h2o-chainlink-median/src/link/AggregatorInterface.sol
/* pragma solidity 0.6.7; */
...
////// /nix/store/fqaypybnhqfq9xiai9wl8zwb73dswy95-h2o-chainlink-median/dapp/h2o-chainlink-median/src/ChainlinkRelayer.sol
/* pragma solidity 0.6.7; */
...
contract ChainlinkRelayer is GebMath {
    ...
    **/
    function read() external view returns (uint256) {
        ...
        (
            ...
            int256 latestAnswer,
            ,
            uint256 aggregatorTimestamp,
            uint80 answeredInRound
        ) = chainlinkAggregator.latestRoundData();
        uint256 medianPrice         = multiply(uint(latestAnswer), 10 ** uint(multiplier));

        require(both(both(medianPrice > 0, subtract(now, aggregatorTimestamp) <= staleThreshold), answeredInRound >= roundId), "ChainlinkRelayer/invalid-price-feed");
        return medianPrice;
    }
    /**
    ...
    **/
    function getResultWithValidity() external view returns (uint256, bool) {
        ...
        return (medianPrice, both(both(medianPrice > 0, subtract(now, aggregatorTimestamp) <= staleThreshold), answeredInRound >= roundId));
    }
