...
Agent Zero Goose, the stealthiest Goose to hit the ETH space through P2E mystery game elements

Solve the first mystery on twitter to access the telegram hideout.

Agents good luck and we welcome you into the underground.

https://twitter.com/AgentZeroGoose
...
contract AgentZeroGoose is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor(uint256 liqFee, uint256 marketFee, uint256 supply, uint256 maxBuyPercent, uint256 maxSellPercent, uint256 maxWalletPercent, address marketingWallet, address liqudityWallet, address uniswapV2RouterAddress) ERC20("Agent Zero Goose", "AZG") {
